...
/** Event "Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit". */
public final class Event_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit() {
        super("Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit", 688, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup38".
        proceed = Aut_sup38.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting".
        proceed = Aut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus.lp_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_Evacuatie.lp_Tunnel_Verkeersbuis1_Evacuatie == 0)) || ((state.s_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus.lp_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingUit_Waarnemer.lp_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingUit_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting_c_uit needs Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus.auto and Tunnel_Verkeersbuis1_Evacuatie.uit or Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus.hand and Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingUit_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

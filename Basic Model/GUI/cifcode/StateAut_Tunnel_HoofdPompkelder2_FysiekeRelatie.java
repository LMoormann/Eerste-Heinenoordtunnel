...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_FysiekeRelatie". */
public final class StateAut_Tunnel_HoofdPompkelder2_FysiekeRelatie {
    public int lp_Tunnel_HoofdPompkelder2_FysiekeRelatie;

    public StateAut_Tunnel_HoofdPompkelder2_FysiekeRelatie copy() {
        StateAut_Tunnel_HoofdPompkelder2_FysiekeRelatie rslt = new StateAut_Tunnel_HoofdPompkelder2_FysiekeRelatie();
        rslt.lp_Tunnel_HoofdPompkelder2_FysiekeRelatie = lp_Tunnel_HoofdPompkelder2_FysiekeRelatie;
        return rslt;
    }
}

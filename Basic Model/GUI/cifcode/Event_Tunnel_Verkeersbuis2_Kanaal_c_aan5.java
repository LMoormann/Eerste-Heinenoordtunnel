...
/** Event "Tunnel_Verkeersbuis2_Kanaal_c_aan5". */
public final class Event_Tunnel_Verkeersbuis2_Kanaal_c_aan5 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Kanaal_c_aan5() {
        super("Tunnel_Verkeersbuis2_Kanaal_c_aan5", 790, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup4.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan5(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan5(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Kanaal_c_aan5 needs Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

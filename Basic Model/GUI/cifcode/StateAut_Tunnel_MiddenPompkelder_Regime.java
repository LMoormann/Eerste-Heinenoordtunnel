...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_Regime". */
public final class StateAut_Tunnel_MiddenPompkelder_Regime {
    public int lp_Tunnel_MiddenPompkelder_Regime;

    public StateAut_Tunnel_MiddenPompkelder_Regime copy() {
        StateAut_Tunnel_MiddenPompkelder_Regime rslt = new StateAut_Tunnel_MiddenPompkelder_Regime();
        rslt.lp_Tunnel_MiddenPompkelder_Regime = lp_Tunnel_MiddenPompkelder_Regime;
        return rslt;
    }
}

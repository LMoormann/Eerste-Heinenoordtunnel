...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer = lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper", 645, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht2_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if ((state.s_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand == 3) && (!(((state.s_Tunnel_Verkeersbuis1_Afsluitboom1_SensorOpen.lp_Tunnel_Verkeersbuis1_Afsluitboom1_SensorOpen == 1) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.rood and not(Tunnel_Verkeersbuis1_Afsluitboom1_SensorOpen.aan and Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp.uit and Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer.uit) disables Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_knipper\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_StandVerkeersbuis". */
public final class StateAut_Tunnel_Verkeersbuis2_StandVerkeersbuis {
    public int lp_Tunnel_Verkeersbuis2_StandVerkeersbuis;

    public StateAut_Tunnel_Verkeersbuis2_StandVerkeersbuis copy() {
        StateAut_Tunnel_Verkeersbuis2_StandVerkeersbuis rslt = new StateAut_Tunnel_Verkeersbuis2_StandVerkeersbuis();
        rslt.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis = lp_Tunnel_Verkeersbuis2_StandVerkeersbuis;
        return rslt;
    }
}

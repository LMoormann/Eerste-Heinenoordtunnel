...
/** Event "Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar", 693, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup38".
        proceed = Aut_sup38.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer_c_klaar(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_vloeistofafvoer". */
public final class StateAut_lb_overzicht_systemen_en_detecties_vloeistofafvoer {
    public int lp_lb_overzicht_systemen_en_detecties_vloeistofafvoer;

    public StateAut_lb_overzicht_systemen_en_detecties_vloeistofafvoer copy() {
        StateAut_lb_overzicht_systemen_en_detecties_vloeistofafvoer rslt = new StateAut_lb_overzicht_systemen_en_detecties_vloeistofafvoer();
        rslt.lp_lb_overzicht_systemen_en_detecties_vloeistofafvoer = lp_lb_overzicht_systemen_en_detecties_vloeistofafvoer;
        return rslt;
    }
}

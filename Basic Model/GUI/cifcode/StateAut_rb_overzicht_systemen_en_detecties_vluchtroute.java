...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_vluchtroute". */
public final class StateAut_rb_overzicht_systemen_en_detecties_vluchtroute {
    public int lp_rb_overzicht_systemen_en_detecties_vluchtroute;

    public StateAut_rb_overzicht_systemen_en_detecties_vluchtroute copy() {
        StateAut_rb_overzicht_systemen_en_detecties_vluchtroute rslt = new StateAut_rb_overzicht_systemen_en_detecties_vluchtroute();
        rslt.lp_rb_overzicht_systemen_en_detecties_vluchtroute = lp_rb_overzicht_systemen_en_detecties_vluchtroute;
        return rslt;
    }
}

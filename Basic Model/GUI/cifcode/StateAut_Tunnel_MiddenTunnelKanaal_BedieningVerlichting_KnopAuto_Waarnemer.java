...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer;
        return rslt;
    }
}

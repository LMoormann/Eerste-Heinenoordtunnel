...
/** Event "Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan". */
public final class Event_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan() {
        super("Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan", 771, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon".
        proceed = Aut_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer;
        return rslt;
    }
}

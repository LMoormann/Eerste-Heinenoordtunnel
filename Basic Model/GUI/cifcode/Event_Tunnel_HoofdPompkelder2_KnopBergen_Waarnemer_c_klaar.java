...
/** Event "Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar". */
public final class Event_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar() {
        super("Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar", 223, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup93".
        proceed = Aut_sup93.fillSyncData_evt_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup95".
        proceed = Aut_sup95.fillSyncData_evt_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer".
        proceed = Aut_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer.fillSyncData_evt_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer_c_klaar(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal". */
public final class StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal {
    public int lp_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal;

    public StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal copy() {
        StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal rslt = new StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal();
        rslt.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal = lp_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal;
        return rslt;
    }
}

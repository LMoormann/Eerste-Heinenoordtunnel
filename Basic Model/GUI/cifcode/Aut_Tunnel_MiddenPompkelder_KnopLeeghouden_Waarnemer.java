...
/** Automaton "Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer". */
public final class Aut_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(259).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer_c_klaar(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(260).get(3);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer_c_onderbroken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(261).get(3);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_MiddenPompkelder_Bediening_Modus.lp_Tunnel_MiddenPompkelder_Bediening_Modus == 1;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenPompkelder_Bediening_Modus.hand\" of an edge of location \"los\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            ...
            target.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer = source.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.copy();
            target.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer = 1;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"los\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"not Tunnel_MiddenPompkelder_Bediening_Modus.hand\" of an edge of location \"los\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync1_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_MiddenPompkelder_Regime.lp_Tunnel_MiddenPompkelder_Regime == 0;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenPompkelder_Regime.leeghouden\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            boolean b; // temp var for pred eval rslts
            target.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer = source.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.copy();
            target.s_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer = 0;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync1_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_MiddenPompkelder_Bediening_Modus.lp_Tunnel_MiddenPompkelder_Bediening_Modus == 0;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenPompkelder_Bediening_Modus.auto\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

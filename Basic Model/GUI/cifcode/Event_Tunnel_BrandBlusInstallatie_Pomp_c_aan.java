...
/** Event "Tunnel_BrandBlusInstallatie_Pomp_c_aan". */
public final class Event_Tunnel_BrandBlusInstallatie_Pomp_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_Pomp_c_aan() {
        super("Tunnel_BrandBlusInstallatie_Pomp_c_aan", 172, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup44.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Pomp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_Pomp".
        proceed = Aut_Tunnel_BrandBlusInstallatie_Pomp.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Pomp_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_BrandBlusInstallatie_SensorHoog.lp_Tunnel_BrandBlusInstallatie_SensorHoog == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_BrandBlusInstallatie_Pomp_c_aan needs Tunnel_BrandBlusInstallatie_SensorHoog.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!((state.s_Tunnel_BrandBlusInstallatie_Regime.lp_Tunnel_BrandBlusInstallatie_Regime == 1) || ((state.s_Tunnel_BrandBlusInstallatie_Regime.lp_Tunnel_BrandBlusInstallatie_Regime == 0) && (state.s_Tunnel_BrandBlusInstallatie_SensorLaag.lp_Tunnel_BrandBlusInstallatie_SensorLaag == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_BrandBlusInstallatie_Pomp_c_aan needs Tunnel_BrandBlusInstallatie_Regime.blussen or Tunnel_BrandBlusInstallatie_Regime.bewaken and Tunnel_BrandBlusInstallatie_SensorLaag.uit\" of the top level scope of the specification failed.", e, state);
        }

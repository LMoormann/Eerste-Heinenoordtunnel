...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_hulppost". */
public final class StateAut_rb_overzicht_systemen_en_detecties_hulppost {
    public int lp_rb_overzicht_systemen_en_detecties_hulppost;

    public StateAut_rb_overzicht_systemen_en_detecties_hulppost copy() {
        StateAut_rb_overzicht_systemen_en_detecties_hulppost rslt = new StateAut_rb_overzicht_systemen_en_detecties_hulppost();
        rslt.lp_rb_overzicht_systemen_en_detecties_hulppost = lp_rb_overzicht_systemen_en_detecties_hulppost;
        return rslt;
    }
}

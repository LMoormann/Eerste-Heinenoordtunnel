...
/** Event "Tunnel_Verkeersbuis2_Recorder_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_Recorder_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Recorder_c_aan() {
        super("Tunnel_Verkeersbuis2_Recorder_c_aan", 954, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_Recorder_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Recorder".
        proceed = Aut_Tunnel_Verkeersbuis2_Recorder.fillSyncData_evt_Tunnel_Verkeersbuis2_Recorder_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 1) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Recorder_c_aan needs Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit or Tunnel_Verkeersbuis2_StandVerkeersbuis.ondersteunend\" of the top level scope of the specification failed.", e, state);
        }

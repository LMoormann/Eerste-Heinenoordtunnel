...
/** Event "Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken". */
public final class Event_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken() {
        super("Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken", 166, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_BrandBlusInstallatie_knop_bewaken_Knop".
        proceed = Aut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop.fillSyncData_evt_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer".
        proceed = Aut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer.fillSyncData_evt_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop_u_indrukken(state);
        if (!proceed) return false;

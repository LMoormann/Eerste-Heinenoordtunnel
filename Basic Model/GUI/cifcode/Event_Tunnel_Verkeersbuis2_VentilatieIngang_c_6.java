...
/** Event "Tunnel_Verkeersbuis2_VentilatieIngang_c_6". */
public final class Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_6 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_6() {
        super("Tunnel_Verkeersbuis2_VentilatieIngang_c_6", 988, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_6(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_6(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis2_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_6(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_SensorHoog". */
public final class StateAut_Tunnel_BrandBlusInstallatie_SensorHoog {
    public int lp_Tunnel_BrandBlusInstallatie_SensorHoog;

    public StateAut_Tunnel_BrandBlusInstallatie_SensorHoog copy() {
        StateAut_Tunnel_BrandBlusInstallatie_SensorHoog rslt = new StateAut_Tunnel_BrandBlusInstallatie_SensorHoog();
        rslt.lp_Tunnel_BrandBlusInstallatie_SensorHoog = lp_Tunnel_BrandBlusInstallatie_SensorHoog;
        return rslt;
    }
}

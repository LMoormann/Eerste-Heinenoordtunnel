...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_SensorMaxstartwater". */
public final class StateAut_Tunnel_HoofdPompkelder2_SensorMaxstartwater {
    public int lp_Tunnel_HoofdPompkelder2_SensorMaxstartwater;

    public StateAut_Tunnel_HoofdPompkelder2_SensorMaxstartwater copy() {
        StateAut_Tunnel_HoofdPompkelder2_SensorMaxstartwater rslt = new StateAut_Tunnel_HoofdPompkelder2_SensorMaxstartwater();
        rslt.lp_Tunnel_HoofdPompkelder2_SensorMaxstartwater = lp_Tunnel_HoofdPompkelder2_SensorMaxstartwater;
        return rslt;
    }
}

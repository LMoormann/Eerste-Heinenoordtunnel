...
/** Event "Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar", 922, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup75".
        proceed = Aut_sup75.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer_c_klaar(state);
        if (!proceed) return false;

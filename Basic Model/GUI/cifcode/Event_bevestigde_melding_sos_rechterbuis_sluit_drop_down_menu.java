...
/** Event "bevestigde_melding_sos_rechterbuis.sluit_drop_down_menu". */
public final class Event_bevestigde_melding_sos_rechterbuis_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_bevestigde_melding_sos_rechterbuis_sluit_drop_down_menu() {
        super("bevestigde_melding_sos_rechterbuis.sluit_drop_down_menu", 10, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_bevestigde_melding_sos_rechterbuis.fillSyncData_evt_bevestigde_melding_sos_rechterbuis_sluit_drop_down_menu(state);

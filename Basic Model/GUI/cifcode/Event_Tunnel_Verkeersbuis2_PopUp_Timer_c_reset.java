...
/** Event "Tunnel_Verkeersbuis2_PopUp_Timer_c_reset". */
public final class Event_Tunnel_Verkeersbuis2_PopUp_Timer_c_reset extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_PopUp_Timer_c_reset() {
        super("Tunnel_Verkeersbuis2_PopUp_Timer_c_reset", 950, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Timer_c_reset(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_PopUp_Timer".
        proceed = Aut_Tunnel_Verkeersbuis2_PopUp_Timer.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Timer_c_reset(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_PopUp_Timer_c_reset needs Tunnel_Verkeersbuis2_PopUp_Venster.uit\" of the top level scope of the specification failed.", e, state);
        }

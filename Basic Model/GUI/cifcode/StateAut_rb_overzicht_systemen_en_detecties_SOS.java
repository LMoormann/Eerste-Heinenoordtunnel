...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_SOS". */
public final class StateAut_rb_overzicht_systemen_en_detecties_SOS {
    public int lp_rb_overzicht_systemen_en_detecties_SOS;

    public StateAut_rb_overzicht_systemen_en_detecties_SOS copy() {
        StateAut_rb_overzicht_systemen_en_detecties_SOS rslt = new StateAut_rb_overzicht_systemen_en_detecties_SOS();
        rslt.lp_rb_overzicht_systemen_en_detecties_SOS = lp_rb_overzicht_systemen_en_detecties_SOS;
        return rslt;
    }
}

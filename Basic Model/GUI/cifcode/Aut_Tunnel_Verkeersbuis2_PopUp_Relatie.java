...
/** Automaton "Tunnel_Verkeersbuis2_PopUp_Relatie". */
public final class Aut_Tunnel_Verkeersbuis2_PopUp_Relatie extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_PopUp_Relatie";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_PopUp_Relatie.lp_Tunnel_Verkeersbuis2_PopUp_Relatie);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(943).get(3);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(946).get(3);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster == 1;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis2_PopUp_Venster.aan\" of an edge of the location of automaton \"Tunnel_Verkeersbuis2_PopUp_Relatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

...
/** Runtime sub-state for automaton "openen_en_sluiten_bevestigde_meldingen". */
public final class StateAut_openen_en_sluiten_bevestigde_meldingen {
    public int lp_openen_en_sluiten_bevestigde_meldingen;

    public StateAut_openen_en_sluiten_bevestigde_meldingen copy() {
        StateAut_openen_en_sluiten_bevestigde_meldingen rslt = new StateAut_openen_en_sluiten_bevestigde_meldingen();
        rslt.lp_openen_en_sluiten_bevestigde_meldingen = lp_openen_en_sluiten_bevestigde_meldingen;
        return rslt;
    }
}

...
/** Event "Tunnel_BrandBlusInstallatie_SensorHoog_u_uit". */
public final class Event_Tunnel_BrandBlusInstallatie_SensorHoog_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_SensorHoog_u_uit() {
        super("Tunnel_BrandBlusInstallatie_SensorHoog_u_uit", 177, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorHoog_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_SensorHoog".
        proceed = Aut_Tunnel_BrandBlusInstallatie_SensorHoog.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorHoog_u_uit(state);
        if (!proceed) return false;

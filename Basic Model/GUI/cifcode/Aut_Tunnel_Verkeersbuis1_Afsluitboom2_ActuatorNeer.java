...
/** Automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer". */
public final class Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(363).get(4);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(236);
        fillSyncData(aut, 363, rslt, state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(364).get(4);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(236);
        fillSyncData(aut, 364, rslt, state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(365).get(4);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(236);
        fillSyncData(aut, 365, rslt, state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer = target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.copy();
        target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer = value;
    }
}

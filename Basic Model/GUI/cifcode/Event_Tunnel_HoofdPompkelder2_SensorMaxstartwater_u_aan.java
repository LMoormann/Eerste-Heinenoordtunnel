...
/** Event "Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan". */
public final class Event_Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan() {
        super("Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan", 244, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_FysiekeRelatie".
        proceed = Aut_Tunnel_HoofdPompkelder2_FysiekeRelatie.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_SensorMaxstartwater".
        proceed = Aut_Tunnel_HoofdPompkelder2_SensorMaxstartwater.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorMaxstartwater_u_aan(state);
        if (!proceed) return false;

...
/** Event "overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton.open_drop_down_menu". */
public final class Event_overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton_open_drop_down_menu() {
        super("overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton.open_drop_down_menu", 89, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton.fillSyncData_evt_overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton_open_drop_down_menu(state);

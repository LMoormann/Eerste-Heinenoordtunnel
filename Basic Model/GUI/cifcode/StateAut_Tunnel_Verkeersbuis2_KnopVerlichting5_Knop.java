...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopVerlichting5_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop = lp_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_SensorHooghoogwater". */
public final class StateAut_Tunnel_MiddenPompkelder_SensorHooghoogwater {
    public int lp_Tunnel_MiddenPompkelder_SensorHooghoogwater;

    public StateAut_Tunnel_MiddenPompkelder_SensorHooghoogwater copy() {
        StateAut_Tunnel_MiddenPompkelder_SensorHooghoogwater rslt = new StateAut_Tunnel_MiddenPompkelder_SensorHooghoogwater();
        rslt.lp_Tunnel_MiddenPompkelder_SensorHooghoogwater = lp_Tunnel_MiddenPompkelder_SensorHooghoogwater;
        return rslt;
    }
}

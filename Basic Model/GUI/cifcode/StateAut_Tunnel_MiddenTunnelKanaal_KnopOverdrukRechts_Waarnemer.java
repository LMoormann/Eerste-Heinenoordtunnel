...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer;
        return rslt;
    }
}

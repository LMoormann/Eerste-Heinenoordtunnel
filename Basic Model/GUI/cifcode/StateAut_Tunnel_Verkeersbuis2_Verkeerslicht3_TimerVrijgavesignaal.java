...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal = lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal;
        return rslt;
    }
}

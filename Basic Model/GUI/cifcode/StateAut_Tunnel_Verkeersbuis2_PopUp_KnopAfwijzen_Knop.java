...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop {
    public int lp_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop;

    public StateAut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop = lp_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop;
        return rslt;
    }
}

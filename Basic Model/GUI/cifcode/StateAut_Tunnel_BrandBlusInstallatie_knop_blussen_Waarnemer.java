...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer". */
public final class StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer {
    public int lp_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer;

    public StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer copy() {
        StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer rslt = new StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer();
        rslt.lp_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer = lp_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer;
        return rslt;
    }
}

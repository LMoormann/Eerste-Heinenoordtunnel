...
/** Event "Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken", 562, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup34".
        proceed = Aut_sup34.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

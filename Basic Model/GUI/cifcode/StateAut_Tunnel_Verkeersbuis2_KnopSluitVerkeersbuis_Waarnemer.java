...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer;
        return rslt;
    }
}

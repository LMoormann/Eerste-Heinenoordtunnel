...
/** Event "Tunnel_Verkeersbuis1_PopUp_Timer_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_PopUp_Timer_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_PopUp_Timer_c_aan() {
        super("Tunnel_Verkeersbuis1_PopUp_Timer_c_aan", 591, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Timer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_PopUp_Timer".
        proceed = Aut_Tunnel_Verkeersbuis1_PopUp_Timer.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Timer_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_PopUp_Venster.lp_Tunnel_Verkeersbuis1_PopUp_Venster == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_PopUp_Timer_c_aan needs Tunnel_Verkeersbuis1_PopUp_Venster.aan\" of the top level scope of the specification failed.", e, state);
        }

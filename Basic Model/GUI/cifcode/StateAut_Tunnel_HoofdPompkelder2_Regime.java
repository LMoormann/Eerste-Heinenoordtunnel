...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_Regime". */
public final class StateAut_Tunnel_HoofdPompkelder2_Regime {
    public int lp_Tunnel_HoofdPompkelder2_Regime;

    public StateAut_Tunnel_HoofdPompkelder2_Regime copy() {
        StateAut_Tunnel_HoofdPompkelder2_Regime rslt = new StateAut_Tunnel_HoofdPompkelder2_Regime();
        rslt.lp_Tunnel_HoofdPompkelder2_Regime = lp_Tunnel_HoofdPompkelder2_Regime;
        return rslt;
    }
}

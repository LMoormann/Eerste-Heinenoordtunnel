...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie". */
public final class StateAut_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie {
    public int lp_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie;

    public StateAut_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie copy() {
        StateAut_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie rslt = new StateAut_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie();
        rslt.lp_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie = lp_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie;
        return rslt;
    }
}

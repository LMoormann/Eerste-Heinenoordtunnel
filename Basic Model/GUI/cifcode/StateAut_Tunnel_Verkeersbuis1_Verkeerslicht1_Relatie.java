...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie {
    public int lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie;

    public StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie rslt = new StateAut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie();
        rslt.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie = lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie;
        return rslt;
    }
}

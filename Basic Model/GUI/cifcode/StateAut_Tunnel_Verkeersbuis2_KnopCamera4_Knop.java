...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCamera4_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopCamera4_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCamera4_Knop = lp_Tunnel_Verkeersbuis2_KnopCamera4_Knop;
        return rslt;
    }
}

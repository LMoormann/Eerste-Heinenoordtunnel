...
/** Event "Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2". */
public final class Event_Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2 extends RuntimeEvent<State> {
    public Event_Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2() {
        super("Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2", 270, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenPompkelder_PompRichting".
        proceed = Aut_Tunnel_MiddenPompkelder_PompRichting.fillSyncData_evt_Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_HoofdPompkelder1_SensorHooghoogwater.lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_MiddenPompkelder_PompRichting_c_hoofdPompkelder2 needs Tunnel_HoofdPompkelder1_SensorHooghoogwater.aan\" of the top level scope of the specification failed.", e, state);
        }

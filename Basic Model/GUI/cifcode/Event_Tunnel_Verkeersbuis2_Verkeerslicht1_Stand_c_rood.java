...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood", 995, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_rood(state);
        if (!proceed) return false;

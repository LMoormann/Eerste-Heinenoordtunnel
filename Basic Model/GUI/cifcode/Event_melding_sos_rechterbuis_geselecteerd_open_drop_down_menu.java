...
/** Event "melding_sos_rechterbuis_geselecteerd.open_drop_down_menu". */
public final class Event_melding_sos_rechterbuis_geselecteerd_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_melding_sos_rechterbuis_geselecteerd_open_drop_down_menu() {
        super("melding_sos_rechterbuis_geselecteerd.open_drop_down_menu", 81, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_melding_sos_rechterbuis_geselecteerd.fillSyncData_evt_melding_sos_rechterbuis_geselecteerd_open_drop_down_menu(state);

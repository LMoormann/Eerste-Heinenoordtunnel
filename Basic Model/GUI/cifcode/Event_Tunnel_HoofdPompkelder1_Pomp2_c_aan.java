...
/** Event "Tunnel_HoofdPompkelder1_Pomp2_c_aan". */
public final class Event_Tunnel_HoofdPompkelder1_Pomp2_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_Pomp2_c_aan() {
        super("Tunnel_HoofdPompkelder1_Pomp2_c_aan", 199, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp2_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_Pomp2".
        proceed = Aut_Tunnel_HoofdPompkelder1_Pomp2.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp2_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 1) && (state.s_Tunnel_HoofdPompkelder1_SensorHooghoogwater.lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater == 1)) || ((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 0) && (state.s_Tunnel_HoofdPompkelder1_SensorMaxstartwater.lp_Tunnel_HoofdPompkelder1_SensorMaxstartwater == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_HoofdPompkelder1_Pomp2_c_aan needs Tunnel_HoofdPompkelder1_Regime.bergen and Tunnel_HoofdPompkelder1_SensorHooghoogwater.aan or Tunnel_HoofdPompkelder1_Regime.leeghouden and Tunnel_HoofdPompkelder1_SensorMaxstartwater.aan\" of the top level scope of the specification failed.", e, state);
        }

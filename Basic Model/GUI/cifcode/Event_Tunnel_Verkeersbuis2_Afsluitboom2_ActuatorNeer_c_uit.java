...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit() {
        super("Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit", 722, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uit needs Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.aan\" of the top level scope of the specification failed.", e, state);
        }

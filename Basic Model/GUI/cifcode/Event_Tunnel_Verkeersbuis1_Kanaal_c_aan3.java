...
/** Event "Tunnel_Verkeersbuis1_Kanaal_c_aan3". */
public final class Event_Tunnel_Verkeersbuis1_Kanaal_c_aan3 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Kanaal_c_aan3() {
        super("Tunnel_Verkeersbuis1_Kanaal_c_aan3", 430, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup2.fillSyncData_evt_Tunnel_Verkeersbuis1_Kanaal_c_aan3(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis1_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis1_Kanaal_c_aan3(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Kanaal_c_aan3 needs Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

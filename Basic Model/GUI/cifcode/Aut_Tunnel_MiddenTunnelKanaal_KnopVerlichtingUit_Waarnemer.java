...
/** Automaton "Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer". */
public final class Aut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(338).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer_c_klaar(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(339).get(2);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer_c_onderbroken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(340).get(2);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenTunnelKanaal_BedieningVerlichting_Modus.hand\" of an edge of location \"los\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            ...
            target.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer = source.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.copy();
            target.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer = 1;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"los\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"not Tunnel_MiddenTunnelKanaal_BedieningVerlichting_Modus.hand\" of an edge of location \"los\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync1_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_MiddenTunnelKanaal_Verlichting.lp_Tunnel_MiddenTunnelKanaal_Verlichting == 0;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenTunnelKanaal_Verlichting.uit\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            boolean b; // temp var for pred eval rslts
            target.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer = source.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.copy();
            target.s_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer = 0;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync1_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_MiddenTunnelKanaal_BedieningVerlichting_Modus.auto\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

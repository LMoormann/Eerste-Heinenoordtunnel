...
/** Event "Tunnel_Verkeersbuis1_Rookdetectie_u_2". */
public final class Event_Tunnel_Verkeersbuis1_Rookdetectie_u_2 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Rookdetectie_u_2() {
        super("Tunnel_Verkeersbuis1_Rookdetectie_u_2", 600, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_Rookdetectie_u_2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Rookdetectie".
        proceed = Aut_Tunnel_Verkeersbuis1_Rookdetectie.fillSyncData_evt_Tunnel_Verkeersbuis1_Rookdetectie_u_2(state);
        if (!proceed) return false;

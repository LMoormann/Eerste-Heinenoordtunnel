...
/** Automaton "Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon". */
public final class Aut_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(771).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(447);
        fillSyncData(aut, 771, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(772).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(447);
        fillSyncData(aut, 772, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon = target.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.copy();
        target.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon = value;
    }
}

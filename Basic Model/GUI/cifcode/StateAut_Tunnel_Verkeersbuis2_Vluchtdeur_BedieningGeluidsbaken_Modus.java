...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus = lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus;
        return rslt;
    }
}

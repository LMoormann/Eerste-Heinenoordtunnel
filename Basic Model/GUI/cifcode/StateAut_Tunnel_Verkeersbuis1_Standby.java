...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Standby". */
public final class StateAut_Tunnel_Verkeersbuis1_Standby {
    public int lp_Tunnel_Verkeersbuis1_Standby;

    public StateAut_Tunnel_Verkeersbuis1_Standby copy() {
        StateAut_Tunnel_Verkeersbuis1_Standby rslt = new StateAut_Tunnel_Verkeersbuis1_Standby();
        rslt.lp_Tunnel_Verkeersbuis1_Standby = lp_Tunnel_Verkeersbuis1_Standby;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_Pomp2". */
public final class StateAut_Tunnel_MiddenPompkelder_Pomp2 {
    public int lp_Tunnel_MiddenPompkelder_Pomp2;

    public StateAut_Tunnel_MiddenPompkelder_Pomp2 copy() {
        StateAut_Tunnel_MiddenPompkelder_Pomp2 rslt = new StateAut_Tunnel_MiddenPompkelder_Pomp2();
        rslt.lp_Tunnel_MiddenPompkelder_Pomp2 = lp_Tunnel_MiddenPompkelder_Pomp2;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar", 444, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup2.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_klaar(state);
        if (!proceed) return false;

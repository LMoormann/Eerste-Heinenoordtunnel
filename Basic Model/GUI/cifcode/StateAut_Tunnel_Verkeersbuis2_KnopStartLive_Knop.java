...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopStartLive_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopStartLive_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopStartLive_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopStartLive_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopStartLive_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopStartLive_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopStartLive_Knop = lp_Tunnel_Verkeersbuis2_KnopStartLive_Knop;
        return rslt;
    }
}

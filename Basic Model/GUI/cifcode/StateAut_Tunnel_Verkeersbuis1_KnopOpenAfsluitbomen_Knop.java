...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop = lp_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop;
        return rslt;
    }
}

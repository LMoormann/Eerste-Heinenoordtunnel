...
/** Event "Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar", 403, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup34".
        proceed = Aut_sup34.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer_c_klaar(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer = lp_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer;
        return rslt;
    }
}

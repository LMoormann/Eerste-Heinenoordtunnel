...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan() {
        super("Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan", 363, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(((state.s_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht == 1) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan needs not(Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht.aan and Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.uit and Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.uit)\" of the top level scope of the specification failed.", e, state);
        }
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal.aan or Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.aan or Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.auto and not Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

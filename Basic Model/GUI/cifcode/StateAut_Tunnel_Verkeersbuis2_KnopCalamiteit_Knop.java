...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCalamiteit_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop = lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_buis". */
public final class StateAut_lb_overzicht_systemen_en_detecties_buis {
    public int lp_lb_overzicht_systemen_en_detecties_buis;

    public StateAut_lb_overzicht_systemen_en_detecties_buis copy() {
        StateAut_lb_overzicht_systemen_en_detecties_buis rslt = new StateAut_lb_overzicht_systemen_en_detecties_buis();
        rslt.lp_lb_overzicht_systemen_en_detecties_buis = lp_lb_overzicht_systemen_en_detecties_buis;
        return rslt;
    }
}

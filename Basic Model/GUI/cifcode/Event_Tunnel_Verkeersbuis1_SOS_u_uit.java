...
/** Event "Tunnel_Verkeersbuis1_SOS_u_uit". */
public final class Event_Tunnel_Verkeersbuis1_SOS_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_SOS_u_uit() {
        super("Tunnel_Verkeersbuis1_SOS_u_uit", 608, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_Tunnel_Verkeersbuis1_SOS.fillSyncData_evt_Tunnel_Verkeersbuis1_SOS_u_uit(state);

...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_Pomp". */
public final class StateAut_Tunnel_BrandBlusInstallatie_Pomp {
    public int lp_Tunnel_BrandBlusInstallatie_Pomp;

    public StateAut_Tunnel_BrandBlusInstallatie_Pomp copy() {
        StateAut_Tunnel_BrandBlusInstallatie_Pomp rslt = new StateAut_Tunnel_BrandBlusInstallatie_Pomp();
        rslt.lp_Tunnel_BrandBlusInstallatie_Pomp = lp_Tunnel_BrandBlusInstallatie_Pomp;
        return rslt;
    }
}

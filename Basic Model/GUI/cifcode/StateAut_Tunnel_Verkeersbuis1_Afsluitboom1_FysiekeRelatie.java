...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie {
    public int lp_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie;

    public StateAut_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie rslt = new StateAut_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie();
        rslt.lp_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie = lp_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie;
        return rslt;
    }
}

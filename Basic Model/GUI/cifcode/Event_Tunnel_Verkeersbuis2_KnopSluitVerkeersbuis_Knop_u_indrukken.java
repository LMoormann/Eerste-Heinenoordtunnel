...
/** Event "Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken". */
public final class Event_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken() {
        super("Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken", 849, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop_u_indrukken(state);
        if (!proceed) return false;

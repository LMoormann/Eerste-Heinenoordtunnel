...
/** Event "Tunnel_Verkeersbuis2_SOS_u_aan". */
public final class Event_Tunnel_Verkeersbuis2_SOS_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_SOS_u_aan() {
        super("Tunnel_Verkeersbuis2_SOS_u_aan", 965, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_Tunnel_Verkeersbuis2_SOS.fillSyncData_evt_Tunnel_Verkeersbuis2_SOS_u_aan(state);

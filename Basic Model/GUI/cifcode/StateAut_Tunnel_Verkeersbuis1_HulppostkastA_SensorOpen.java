...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen". */
public final class StateAut_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen {
    public int lp_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen;

    public StateAut_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen copy() {
        StateAut_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen rslt = new StateAut_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen();
        rslt.lp_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen = lp_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen;
        return rslt;
    }
}

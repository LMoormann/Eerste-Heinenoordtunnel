...
/** Runtime sub-state for automaton "event_disabler". */
public final class StateAut_event_disabler {
    public int lp_event_disabler;

    public StateAut_event_disabler copy() {
        StateAut_event_disabler rslt = new StateAut_event_disabler();
        rslt.lp_event_disabler = lp_event_disabler;
        return rslt;
    }
}

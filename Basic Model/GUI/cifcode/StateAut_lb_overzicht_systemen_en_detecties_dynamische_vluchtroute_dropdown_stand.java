...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand". */
public final class StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand {
    public int lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand;

    public StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand copy() {
        StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand rslt = new StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand();
        rslt.lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand = lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand;
        return rslt;
    }
}

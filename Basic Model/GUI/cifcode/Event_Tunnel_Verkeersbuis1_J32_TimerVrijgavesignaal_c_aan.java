...
/** Event "Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan() {
        super("Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan", 425, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup15.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_J32_Stand.lp_Tunnel_Verkeersbuis1_J32_Stand == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan needs Tunnel_Verkeersbuis1_J32_Stand.aan\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_KnopUit_Waarnemer". */
public final class StateAut_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer {
    public int lp_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer;

    public StateAut_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer copy() {
        StateAut_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer rslt = new StateAut_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer();
        rslt.lp_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer = lp_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer;
        return rslt;
    }
}

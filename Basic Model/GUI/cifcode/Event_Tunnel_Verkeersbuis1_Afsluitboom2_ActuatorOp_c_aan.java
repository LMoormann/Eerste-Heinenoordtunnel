...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan() {
        super("Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan", 366, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan needs Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(((state.s_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen.lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen == 1) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan needs not(Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen.aan and Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.uit and Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.uit)\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(((((state.s_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer == 1))) || (state.s_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp_c_aan needs Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.auto and Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

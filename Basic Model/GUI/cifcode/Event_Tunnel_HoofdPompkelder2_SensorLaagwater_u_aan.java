...
/** Event "Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan". */
public final class Event_Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan() {
        super("Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan", 242, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_SensorLaagwater".
        proceed = Aut_Tunnel_HoofdPompkelder2_SensorLaagwater.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan(state);
        if (!proceed) return false;

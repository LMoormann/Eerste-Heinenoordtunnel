...
/** Event "Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken() {
        super("Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken", 264, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup86".
        proceed = Aut_sup86.fillSyncData_evt_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup88".
        proceed = Aut_sup88.fillSyncData_evt_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenPompkelder_KnopUit_Waarnemer".
        proceed = Aut_Tunnel_MiddenPompkelder_KnopUit_Waarnemer.fillSyncData_evt_Tunnel_MiddenPompkelder_KnopUit_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

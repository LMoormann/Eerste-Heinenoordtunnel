...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer;
        return rslt;
    }
}

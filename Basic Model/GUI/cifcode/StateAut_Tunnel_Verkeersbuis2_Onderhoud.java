...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Onderhoud". */
public final class StateAut_Tunnel_Verkeersbuis2_Onderhoud {
    public int lp_Tunnel_Verkeersbuis2_Onderhoud;

    public StateAut_Tunnel_Verkeersbuis2_Onderhoud copy() {
        StateAut_Tunnel_Verkeersbuis2_Onderhoud rslt = new StateAut_Tunnel_Verkeersbuis2_Onderhoud();
        rslt.lp_Tunnel_Verkeersbuis2_Onderhoud = lp_Tunnel_Verkeersbuis2_Onderhoud;
        return rslt;
    }
}

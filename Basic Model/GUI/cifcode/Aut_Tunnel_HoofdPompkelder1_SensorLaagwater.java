...
/** Automaton "Tunnel_HoofdPompkelder1_SensorLaagwater". */
public final class Aut_Tunnel_HoofdPompkelder1_SensorLaagwater extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_HoofdPompkelder1_SensorLaagwater() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_HoofdPompkelder1_SensorLaagwater", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_HoofdPompkelder1_SensorLaagwater";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_HoofdPompkelder1_SensorLaagwater.lp_Tunnel_HoofdPompkelder1_SensorLaagwater);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(208).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(147);
        fillSyncData(aut, 208, rslt, state.s_Tunnel_HoofdPompkelder1_SensorLaagwater.lp_Tunnel_HoofdPompkelder1_SensorLaagwater);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorLaagwater_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(209).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(147);
        fillSyncData(aut, 209, rslt, state.s_Tunnel_HoofdPompkelder1_SensorLaagwater.lp_Tunnel_HoofdPompkelder1_SensorLaagwater);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_HoofdPompkelder1_SensorLaagwater = target.s_Tunnel_HoofdPompkelder1_SensorLaagwater.copy();
        target.s_Tunnel_HoofdPompkelder1_SensorLaagwater.lp_Tunnel_HoofdPompkelder1_SensorLaagwater = value;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Rookdetectie". */
public final class StateAut_Tunnel_Verkeersbuis1_Rookdetectie {
    public int lp_Tunnel_Verkeersbuis1_Rookdetectie;
    public int v_stand;

    public StateAut_Tunnel_Verkeersbuis1_Rookdetectie copy() {
        StateAut_Tunnel_Verkeersbuis1_Rookdetectie rslt = new StateAut_Tunnel_Verkeersbuis1_Rookdetectie();
        rslt.lp_Tunnel_Verkeersbuis1_Rookdetectie = lp_Tunnel_Verkeersbuis1_Rookdetectie;
        rslt.v_stand = v_stand;
        return rslt;
    }
}

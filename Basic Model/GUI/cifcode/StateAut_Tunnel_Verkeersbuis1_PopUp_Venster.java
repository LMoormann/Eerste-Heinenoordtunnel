...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_PopUp_Venster". */
public final class StateAut_Tunnel_Verkeersbuis1_PopUp_Venster {
    public int lp_Tunnel_Verkeersbuis1_PopUp_Venster;

    public StateAut_Tunnel_Verkeersbuis1_PopUp_Venster copy() {
        StateAut_Tunnel_Verkeersbuis1_PopUp_Venster rslt = new StateAut_Tunnel_Verkeersbuis1_PopUp_Venster();
        rslt.lp_Tunnel_Verkeersbuis1_PopUp_Venster = lp_Tunnel_Verkeersbuis1_PopUp_Venster;
        return rslt;
    }
}

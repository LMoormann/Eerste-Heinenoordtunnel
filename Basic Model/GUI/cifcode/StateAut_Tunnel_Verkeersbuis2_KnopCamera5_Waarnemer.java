...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer;
        return rslt;
    }
}

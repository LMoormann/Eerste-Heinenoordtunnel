...
/** Event "rb_overzicht_systemen_en_detecties_vluchtdeurindicatie.open_drop_down_menu". */
public final class Event_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu() {
        super("rb_overzicht_systemen_en_detecties_vluchtdeurindicatie.open_drop_down_menu", 147, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie.fillSyncData_evt_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu(state);

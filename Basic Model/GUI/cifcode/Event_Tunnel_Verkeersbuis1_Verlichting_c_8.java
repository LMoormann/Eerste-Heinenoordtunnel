...
/** Event "Tunnel_Verkeersbuis1_Verlichting_c_8". */
public final class Event_Tunnel_Verkeersbuis1_Verlichting_c_8 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verlichting_c_8() {
        super("Tunnel_Verkeersbuis1_Verlichting_c_8", 670, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_8(state);
        if (!proceed) return false;

        // Check automaton "sup34".
        proceed = Aut_sup34.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_8(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verlichting".
        proceed = Aut_Tunnel_Verkeersbuis1_Verlichting.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_8(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus == 0) && (((((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0) || (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 2)) || (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 3)) && (equal(state.s_Tunnel_Verkeersbuis1_Lichtsensor.v_stand2, 8))) || (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 1))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopVerlichting8_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopVerlichting8_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Verlichting_c_8 needs Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.auto and ((Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_StandVerkeersbuis.herstel or Tunnel_Verkeersbuis1_StandVerkeersbuis.ondersteunend) and Tunnel_Verkeersbuis1_Lichtsensor.stand = 8 or Tunnel_Verkeersbuis1_StandVerkeersbuis.calamiteit) or Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.hand and Tunnel_Verkeersbuis1_KnopVerlichting8_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_VentilatieRichting". */
public final class StateAut_Tunnel_Verkeersbuis2_VentilatieRichting {
    public int lp_Tunnel_Verkeersbuis2_VentilatieRichting;

    public StateAut_Tunnel_Verkeersbuis2_VentilatieRichting copy() {
        StateAut_Tunnel_Verkeersbuis2_VentilatieRichting rslt = new StateAut_Tunnel_Verkeersbuis2_VentilatieRichting();
        rslt.lp_Tunnel_Verkeersbuis2_VentilatieRichting = lp_Tunnel_Verkeersbuis2_VentilatieRichting;
        return rslt;
    }
}

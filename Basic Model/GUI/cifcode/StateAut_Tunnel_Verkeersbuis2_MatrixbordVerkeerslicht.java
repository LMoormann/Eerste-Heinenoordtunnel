...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht". */
public final class StateAut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht {
    public int lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht;

    public StateAut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht copy() {
        StateAut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht rslt = new StateAut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht();
        rslt.lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht = lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht;
        return rslt;
    }
}

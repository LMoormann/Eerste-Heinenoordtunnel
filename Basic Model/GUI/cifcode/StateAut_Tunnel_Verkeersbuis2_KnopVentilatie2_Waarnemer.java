...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer;
        return rslt;
    }
}

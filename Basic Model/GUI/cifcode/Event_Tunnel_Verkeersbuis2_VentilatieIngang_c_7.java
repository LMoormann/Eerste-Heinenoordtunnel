...
/** Event "Tunnel_Verkeersbuis2_VentilatieIngang_c_7". */
public final class Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_7 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_7() {
        super("Tunnel_Verkeersbuis2_VentilatieIngang_c_7", 989, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_7(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_7(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis2_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_7(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_VentilatieIngang_c_7 needs Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.auto and (Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_StandVerkeersbuis.herstel) and Tunnel_Verkeersbuis2_Rookdetectie.stand = 7 or Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.hand and Tunnel_Verkeersbuis2_KnopVentilatie7_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_BedieningVentilatie_Modus". */
public final class StateAut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus {
    public int lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus;

    public StateAut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus copy() {
        StateAut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus rslt = new StateAut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus();
        rslt.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus = lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus;
        return rslt;
    }
}

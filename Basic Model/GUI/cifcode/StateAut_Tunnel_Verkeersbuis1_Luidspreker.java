...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Luidspreker". */
public final class StateAut_Tunnel_Verkeersbuis1_Luidspreker {
    public int lp_Tunnel_Verkeersbuis1_Luidspreker;

    public StateAut_Tunnel_Verkeersbuis1_Luidspreker copy() {
        StateAut_Tunnel_Verkeersbuis1_Luidspreker rslt = new StateAut_Tunnel_Verkeersbuis1_Luidspreker();
        rslt.lp_Tunnel_Verkeersbuis1_Luidspreker = lp_Tunnel_Verkeersbuis1_Luidspreker;
        return rslt;
    }
}

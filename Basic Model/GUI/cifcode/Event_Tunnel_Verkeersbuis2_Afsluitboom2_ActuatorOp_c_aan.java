...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan() {
        super("Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan", 724, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan needs Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(((state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen == 1) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp_c_aan needs not(Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen.aan and Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.uit and Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.uit)\" of the top level scope of the specification failed.", e, state);
        }

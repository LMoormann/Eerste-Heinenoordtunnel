...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCamera3_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCamera3_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopCamera3_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopCamera3_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCamera3_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCamera3_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCamera3_Knop = lp_Tunnel_Verkeersbuis2_KnopCamera3_Knop;
        return rslt;
    }
}

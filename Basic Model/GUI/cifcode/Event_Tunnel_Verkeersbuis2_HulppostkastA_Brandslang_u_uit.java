...
/** Event "Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit". */
public final class Event_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit() {
        super("Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit", 768, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_HulppostkastA_Brandslang".
        proceed = Aut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang_u_uit(state);
        if (!proceed) return false;

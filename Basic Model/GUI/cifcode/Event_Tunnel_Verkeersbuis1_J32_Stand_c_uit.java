...
/** Event "Tunnel_Verkeersbuis1_J32_Stand_c_uit". */
public final class Event_Tunnel_Verkeersbuis1_J32_Stand_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_J32_Stand_c_uit() {
        super("Tunnel_Verkeersbuis1_J32_Stand_c_uit", 424, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "sup15".
        proceed = Aut_sup15.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_J32_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_J32_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_Stand_c_uit needs Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_Stand_c_uit needs Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_Stand_c_uit needs Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(((((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopUitVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopUitVerkeerslichten_Waarnemer == 1))) || (state.s_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_Stand_c_uit needs Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.auto and Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.hand and Tunnel_Verkeersbuis1_KnopUitVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

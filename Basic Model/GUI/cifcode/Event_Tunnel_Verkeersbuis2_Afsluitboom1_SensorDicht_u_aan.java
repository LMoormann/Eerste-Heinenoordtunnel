...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan() {
        super("Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan", 717, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom1_FysiekeRelatie".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom1_FysiekeRelatie.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan(state);
        if (!proceed) return false;

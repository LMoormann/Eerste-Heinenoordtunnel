...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel", 993, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

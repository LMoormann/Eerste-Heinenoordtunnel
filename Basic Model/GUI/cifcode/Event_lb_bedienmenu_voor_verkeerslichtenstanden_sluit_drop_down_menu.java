...
/** Event "lb_bedienmenu_voor_verkeerslichtenstanden.sluit_drop_down_menu". */
public final class Event_lb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu() {
        super("lb_bedienmenu_voor_verkeerslichtenstanden.sluit_drop_down_menu", 16, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_bedienmenu_voor_verkeerslichtenstanden.fillSyncData_evt_lb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu(state);

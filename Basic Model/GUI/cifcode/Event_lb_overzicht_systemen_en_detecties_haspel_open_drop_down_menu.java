...
/** Event "lb_overzicht_systemen_en_detecties_haspel.open_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_haspel_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_haspel_open_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_haspel.open_drop_down_menu", 37, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_haspel.fillSyncData_evt_lb_overzicht_systemen_en_detecties_haspel_open_drop_down_menu(state);

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen". */
public final class StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen {
    public int lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen;

    public StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen copy() {
        StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen rslt = new StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen();
        rslt.lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen = lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen;
        return rslt;
    }
}

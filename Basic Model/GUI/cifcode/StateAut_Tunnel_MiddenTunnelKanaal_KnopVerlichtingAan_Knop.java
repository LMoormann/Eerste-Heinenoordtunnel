...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop;
        return rslt;
    }
}

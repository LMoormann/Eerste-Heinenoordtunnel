...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer;
        return rslt;
    }
}

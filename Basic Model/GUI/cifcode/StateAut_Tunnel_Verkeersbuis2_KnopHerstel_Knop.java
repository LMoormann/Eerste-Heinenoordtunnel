...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopHerstel_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopHerstel_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopHerstel_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopHerstel_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopHerstel_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopHerstel_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopHerstel_Knop = lp_Tunnel_Verkeersbuis2_KnopHerstel_Knop;
        return rslt;
    }
}

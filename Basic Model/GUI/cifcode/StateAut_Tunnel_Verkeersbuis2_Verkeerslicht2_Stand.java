...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht2_Stand". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand = lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand;
        return rslt;
    }
}

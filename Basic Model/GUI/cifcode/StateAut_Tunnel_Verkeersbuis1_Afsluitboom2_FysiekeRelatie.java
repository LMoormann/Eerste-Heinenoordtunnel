...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie {
    public int lp_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie;

    public StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie rslt = new StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie();
        rslt.lp_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie = lp_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_deur". */
public final class StateAut_lb_overzicht_systemen_en_detecties_deur {
    public int lp_lb_overzicht_systemen_en_detecties_deur;

    public StateAut_lb_overzicht_systemen_en_detecties_deur copy() {
        StateAut_lb_overzicht_systemen_en_detecties_deur rslt = new StateAut_lb_overzicht_systemen_en_detecties_deur();
        rslt.lp_lb_overzicht_systemen_en_detecties_deur = lp_lb_overzicht_systemen_en_detecties_deur;
        return rslt;
    }
}

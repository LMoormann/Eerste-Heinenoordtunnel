...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel", 653, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 0) && (!(state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer == 1))) || (state.s_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Verkeerslicht3_Stand_c_geel needs Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.hand and Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

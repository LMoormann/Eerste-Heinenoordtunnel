...
/** Event "Tunnel_BrandBlusInstallatie_Regime_c_bewaken". */
public final class Event_Tunnel_BrandBlusInstallatie_Regime_c_bewaken extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_Regime_c_bewaken() {
        super("Tunnel_BrandBlusInstallatie_Regime_c_bewaken", 174, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "sup44".
        proceed = Aut_sup44.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Regime_c_bewaken(state);
        if (!proceed) return false;

        // Check automaton "sup47".
        proceed = Aut_sup47.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Regime_c_bewaken(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Regime_c_bewaken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_Regime".
        proceed = Aut_Tunnel_BrandBlusInstallatie_Regime.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Regime_c_bewaken(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((((state.s_Tunnel_BrandBlusInstallatie_Bediening_Modus.lp_Tunnel_BrandBlusInstallatie_Bediening_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang == 0)) && (state.s_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang == 0)) && (!(state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 1))) && (!(state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 1))) || ((state.s_Tunnel_BrandBlusInstallatie_Bediening_Modus.lp_Tunnel_BrandBlusInstallatie_Bediening_Modus == 1) && (state.s_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer.lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_BrandBlusInstallatie_Regime_c_bewaken needs Tunnel_BrandBlusInstallatie_Bediening_Modus.auto and Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.uit and Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.uit and not Tunnel_Verkeersbuis1_StandVerkeersbuis.calamiteit and not Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit or Tunnel_BrandBlusInstallatie_Bediening_Modus.hand and Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

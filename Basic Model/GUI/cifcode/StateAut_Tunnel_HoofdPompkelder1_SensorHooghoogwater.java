...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_SensorHooghoogwater". */
public final class StateAut_Tunnel_HoofdPompkelder1_SensorHooghoogwater {
    public int lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater;

    public StateAut_Tunnel_HoofdPompkelder1_SensorHooghoogwater copy() {
        StateAut_Tunnel_HoofdPompkelder1_SensorHooghoogwater rslt = new StateAut_Tunnel_HoofdPompkelder1_SensorHooghoogwater();
        rslt.lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater = lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater;
        return rslt;
    }
}

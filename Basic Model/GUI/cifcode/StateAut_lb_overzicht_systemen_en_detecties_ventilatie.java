...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_ventilatie". */
public final class StateAut_lb_overzicht_systemen_en_detecties_ventilatie {
    public int lp_lb_overzicht_systemen_en_detecties_ventilatie;

    public StateAut_lb_overzicht_systemen_en_detecties_ventilatie copy() {
        StateAut_lb_overzicht_systemen_en_detecties_ventilatie rslt = new StateAut_lb_overzicht_systemen_en_detecties_ventilatie();
        rslt.lp_lb_overzicht_systemen_en_detecties_ventilatie = lp_lb_overzicht_systemen_en_detecties_ventilatie;
        return rslt;
    }
}

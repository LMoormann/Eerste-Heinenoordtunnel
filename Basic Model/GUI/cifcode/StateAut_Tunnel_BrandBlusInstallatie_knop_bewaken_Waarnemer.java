...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer". */
public final class StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer {
    public int lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer;

    public StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer copy() {
        StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer rslt = new StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer();
        rslt.lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer = lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer;
        return rslt;
    }
}

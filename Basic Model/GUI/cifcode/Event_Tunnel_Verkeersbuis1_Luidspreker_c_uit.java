...
/** Event "Tunnel_Verkeersbuis1_Luidspreker_c_uit". */
public final class Event_Tunnel_Verkeersbuis1_Luidspreker_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Luidspreker_c_uit() {
        super("Tunnel_Verkeersbuis1_Luidspreker_c_uit", 578, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis1_Luidspreker_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup82".
        proceed = Aut_sup82.fillSyncData_evt_Tunnel_Verkeersbuis1_Luidspreker_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup83".
        proceed = Aut_sup83.fillSyncData_evt_Tunnel_Verkeersbuis1_Luidspreker_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Luidspreker".
        proceed = Aut_Tunnel_Verkeersbuis1_Luidspreker.fillSyncData_evt_Tunnel_Verkeersbuis1_Luidspreker_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis1_Luidspreker.lp_Tunnel_Verkeersbuis1_Luidspreker == 1) && (state.s_Tunnel_Verkeersbuis1_KnopStopBoodschap_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopStopBoodschap_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis1_Luidspreker.lp_Tunnel_Verkeersbuis1_Luidspreker == 2) && (state.s_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer == 1))) || (state.s_Tunnel_Verkeersbuis1_WisselTimerAudio.lp_Tunnel_Verkeersbuis1_WisselTimerAudio == 0))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Luidspreker_c_uit needs Tunnel_Verkeersbuis1_Luidspreker.boodschap and Tunnel_Verkeersbuis1_KnopStopBoodschap_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_Luidspreker.live and Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_WisselTimerAudio.uit\" of the top level scope of the specification failed.", e, state);
        }

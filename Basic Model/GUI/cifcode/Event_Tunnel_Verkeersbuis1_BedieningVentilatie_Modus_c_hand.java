...
/** Event "Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand". */
public final class Event_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand() {
        super("Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand", 390, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_BedieningVentilatie_Modus".
        proceed = Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopHand_Waarnemer.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopHand_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_BedieningVentilatie_Modus_c_hand needs Tunnel_Verkeersbuis1_BedieningVentilatie_KnopHand_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

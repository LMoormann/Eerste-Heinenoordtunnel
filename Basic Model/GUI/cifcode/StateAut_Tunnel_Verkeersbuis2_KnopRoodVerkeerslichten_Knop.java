...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop = lp_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop;
        return rslt;
    }
}

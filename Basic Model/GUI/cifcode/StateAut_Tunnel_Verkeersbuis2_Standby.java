...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Standby". */
public final class StateAut_Tunnel_Verkeersbuis2_Standby {
    public int lp_Tunnel_Verkeersbuis2_Standby;

    public StateAut_Tunnel_Verkeersbuis2_Standby copy() {
        StateAut_Tunnel_Verkeersbuis2_Standby rslt = new StateAut_Tunnel_Verkeersbuis2_Standby();
        rslt.lp_Tunnel_Verkeersbuis2_Standby = lp_Tunnel_Verkeersbuis2_Standby;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "bevestigde_melding_sos_rechterbuis". */
public final class StateAut_bevestigde_melding_sos_rechterbuis {
    public int lp_bevestigde_melding_sos_rechterbuis;

    public StateAut_bevestigde_melding_sos_rechterbuis copy() {
        StateAut_bevestigde_melding_sos_rechterbuis rslt = new StateAut_bevestigde_melding_sos_rechterbuis();
        rslt.lp_bevestigde_melding_sos_rechterbuis = lp_bevestigde_melding_sos_rechterbuis;
        return rslt;
    }
}

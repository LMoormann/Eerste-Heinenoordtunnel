...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_haspel". */
public final class StateAut_lb_overzicht_systemen_en_detecties_haspel {
    public int lp_lb_overzicht_systemen_en_detecties_haspel;

    public StateAut_lb_overzicht_systemen_en_detecties_haspel copy() {
        StateAut_lb_overzicht_systemen_en_detecties_haspel rslt = new StateAut_lb_overzicht_systemen_en_detecties_haspel();
        rslt.lp_lb_overzicht_systemen_en_detecties_haspel = lp_lb_overzicht_systemen_en_detecties_haspel;
        return rslt;
    }
}

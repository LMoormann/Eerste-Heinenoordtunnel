...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_verkeer". */
public final class StateAut_rb_overzicht_systemen_en_detecties_verkeer {
    public int lp_rb_overzicht_systemen_en_detecties_verkeer;

    public StateAut_rb_overzicht_systemen_en_detecties_verkeer copy() {
        StateAut_rb_overzicht_systemen_en_detecties_verkeer rslt = new StateAut_rb_overzicht_systemen_en_detecties_verkeer();
        rslt.lp_rb_overzicht_systemen_en_detecties_verkeer = lp_rb_overzicht_systemen_en_detecties_verkeer;
        return rslt;
    }
}

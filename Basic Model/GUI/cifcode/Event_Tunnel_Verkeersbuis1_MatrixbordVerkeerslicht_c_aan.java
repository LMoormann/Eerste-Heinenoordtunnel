...
/** Event "Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan() {
        super("Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan", 581, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht".
        proceed = Aut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 0) && (!(state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus == 1) && ((state.s_Tunnel_Verkeersbuis1_KnopKnipperVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopKnipperVerkeerslichten_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer == 1)))) || (state.s_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan needs Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.hand and (Tunnel_Verkeersbuis1_KnopKnipperVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

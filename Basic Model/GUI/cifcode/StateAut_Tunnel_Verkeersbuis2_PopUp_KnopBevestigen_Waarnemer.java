...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer = lp_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Standby_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_Standby_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Standby_c_aan() {
        super("Tunnel_Verkeersbuis1_Standby_c_aan", 609, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup35".
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup39".
        proceed = Aut_sup39.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Standby".
        proceed = Aut_Tunnel_Verkeersbuis1_Standby.fillSyncData_evt_Tunnel_Verkeersbuis1_Standby_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 1) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit disables Tunnel_Verkeersbuis1_Standby_c_aan\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Standby_c_aan needs Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(((((state.s_Tunnel_Verkeersbuis1_Rookdetectie.v_stand) > (3)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastA_Handblusser == 1)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang == 1)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Standby_c_aan needs Tunnel_Verkeersbuis1_Rookdetectie.stand > 3 or Tunnel_Verkeersbuis1_HulppostkastA_Handblusser.aan or Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.aan or Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.aan\" of the top level scope of the specification failed.", e, state);
        }

...
/** Event "Tunnel_Verkeersbuis2_MatrixbordLos_c_uit". */
public final class Event_Tunnel_Verkeersbuis2_MatrixbordLos_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_MatrixbordLos_c_uit() {
        super("Tunnel_Verkeersbuis2_MatrixbordLos_c_uit", 938, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordLos_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_MatrixbordLos".
        proceed = Aut_Tunnel_Verkeersbuis2_MatrixbordLos.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordLos_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordLos_c_uit needs Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

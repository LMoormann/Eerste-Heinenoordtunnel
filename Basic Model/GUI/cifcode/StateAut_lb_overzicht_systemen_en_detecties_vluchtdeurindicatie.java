...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_vluchtdeurindicatie". */
public final class StateAut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie {
    public int lp_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie;

    public StateAut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie copy() {
        StateAut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie rslt = new StateAut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie();
        rslt.lp_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie = lp_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie;
        return rslt;
    }
}

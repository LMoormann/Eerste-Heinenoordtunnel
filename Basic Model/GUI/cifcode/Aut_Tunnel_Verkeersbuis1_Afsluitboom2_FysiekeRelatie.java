...
/** Automaton "Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie". */
public final class Aut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(371).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(372).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(373).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(374).get(1);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp == 1) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht == 0);
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.aan and Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht.uit\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp == 1;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.aan\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync0_2_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer == 1;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.aan\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync0_3_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer == 1) && (state.s_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen.lp_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen == 0);
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.aan and Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen.uit\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen = lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen;
        return rslt;
    }
}

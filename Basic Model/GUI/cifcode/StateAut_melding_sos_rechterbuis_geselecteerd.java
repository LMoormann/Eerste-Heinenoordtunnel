...
/** Runtime sub-state for automaton "melding_sos_rechterbuis_geselecteerd". */
public final class StateAut_melding_sos_rechterbuis_geselecteerd {
    public int lp_melding_sos_rechterbuis_geselecteerd;

    public StateAut_melding_sos_rechterbuis_geselecteerd copy() {
        StateAut_melding_sos_rechterbuis_geselecteerd rslt = new StateAut_melding_sos_rechterbuis_geselecteerd();
        rslt.lp_melding_sos_rechterbuis_geselecteerd = lp_melding_sos_rechterbuis_geselecteerd;
        return rslt;
    }
}

...
/** Automaton "sup15". */
public final class Aut_sup15 extends RuntimeAutomaton<State> {
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_sup15.lp_sup15);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(423).get(0);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(424).get(0);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(425).get(0);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(426).get(0);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"true\" of an edge of the location of automaton \"sup15\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

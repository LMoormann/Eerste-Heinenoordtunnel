...
/** Event "Tunnel_Verkeersbuis2_Verlichting_c_2". */
public final class Event_Tunnel_Verkeersbuis2_Verlichting_c_2 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verlichting_c_2() {
        super("Tunnel_Verkeersbuis2_Verlichting_c_2", 1022, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_Verlichting_c_2(state);
        if (!proceed) return false;

        // Check automaton "sup75".
        proceed = Aut_sup75.fillSyncData_evt_Tunnel_Verkeersbuis2_Verlichting_c_2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verlichting".
        proceed = Aut_Tunnel_Verkeersbuis2_Verlichting.fillSyncData_evt_Tunnel_Verkeersbuis2_Verlichting_c_2(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((((state.s_Tunnel_Verkeersbuis2_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerlichting_Modus == 0) && (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis2_Onderhoud.lp_Tunnel_Verkeersbuis2_Onderhoud == 0)) && (state.s_Tunnel_Verkeersbuis2_Standby.lp_Tunnel_Verkeersbuis2_Standby == 0)) && (equal(state.s_Tunnel_Verkeersbuis2_Lichtsensor.v_stand4, 2))) || ((state.s_Tunnel_Verkeersbuis2_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerlichting_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verlichting_c_2 needs Tunnel_Verkeersbuis2_BedieningVerlichting_Modus.auto and Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_Onderhoud.uit and Tunnel_Verkeersbuis2_Standby.uit and Tunnel_Verkeersbuis2_Lichtsensor.stand = 2 or Tunnel_Verkeersbuis2_BedieningVerlichting_Modus.hand and Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Ventilatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Ventilatie {
    public int lp_Tunnel_Verkeersbuis1_Ventilatie;
    public int v_stand5;

    public StateAut_Tunnel_Verkeersbuis1_Ventilatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Ventilatie rslt = new StateAut_Tunnel_Verkeersbuis1_Ventilatie();
        rslt.lp_Tunnel_Verkeersbuis1_Ventilatie = lp_Tunnel_Verkeersbuis1_Ventilatie;
        rslt.v_stand5 = v_stand5;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_verlichting". */
public final class StateAut_lb_overzicht_systemen_en_detecties_verlichting {
    public int lp_lb_overzicht_systemen_en_detecties_verlichting;

    public StateAut_lb_overzicht_systemen_en_detecties_verlichting copy() {
        StateAut_lb_overzicht_systemen_en_detecties_verlichting rslt = new StateAut_lb_overzicht_systemen_en_detecties_verlichting();
        rslt.lp_lb_overzicht_systemen_en_detecties_verlichting = lp_lb_overzicht_systemen_en_detecties_verlichting;
        return rslt;
    }
}

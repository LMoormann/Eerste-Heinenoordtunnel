...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_overig". */
public final class StateAut_rb_overzicht_systemen_en_detecties_overig {
    public int lp_rb_overzicht_systemen_en_detecties_overig;

    public StateAut_rb_overzicht_systemen_en_detecties_overig copy() {
        StateAut_rb_overzicht_systemen_en_detecties_overig rslt = new StateAut_rb_overzicht_systemen_en_detecties_overig();
        rslt.lp_rb_overzicht_systemen_en_detecties_overig = lp_rb_overzicht_systemen_en_detecties_overig;
        return rslt;
    }
}

...
/** Event "Tunnel_HoofdPompkelder1_Pomp1_c_aan". */
public final class Event_Tunnel_HoofdPompkelder1_Pomp1_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_Pomp1_c_aan() {
        super("Tunnel_HoofdPompkelder1_Pomp1_c_aan", 197, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp1_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_Pomp1".
        proceed = Aut_Tunnel_HoofdPompkelder1_Pomp1.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp1_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 1) && (state.s_Tunnel_HoofdPompkelder1_SensorHooghoogwater.lp_Tunnel_HoofdPompkelder1_SensorHooghoogwater == 1)) || ((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 0) && (state.s_Tunnel_HoofdPompkelder1_SensorStartwater.lp_Tunnel_HoofdPompkelder1_SensorStartwater == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_HoofdPompkelder1_Pomp1_c_aan needs Tunnel_HoofdPompkelder1_Regime.bergen and Tunnel_HoofdPompkelder1_SensorHooghoogwater.aan or Tunnel_HoofdPompkelder1_Regime.leeghouden and Tunnel_HoofdPompkelder1_SensorStartwater.aan\" of the top level scope of the specification failed.", e, state);
        }

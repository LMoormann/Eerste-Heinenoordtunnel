...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand". */
public final class StateAut_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand {
    public int lp_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand;

    public StateAut_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand copy() {
        StateAut_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand rslt = new StateAut_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand();
        rslt.lp_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand = lp_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand;
        return rslt;
    }
}

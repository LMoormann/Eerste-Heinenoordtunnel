...
/** Event "Tunnel_HoofdPompkelder1_Pomp1_c_uit". */
public final class Event_Tunnel_HoofdPompkelder1_Pomp1_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_Pomp1_c_uit() {
        super("Tunnel_HoofdPompkelder1_Pomp1_c_uit", 198, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp1_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_Pomp1".
        proceed = Aut_Tunnel_HoofdPompkelder1_Pomp1.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp1_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 1) && (state.s_Tunnel_HoofdPompkelder1_SensorLaaghoogwater.lp_Tunnel_HoofdPompkelder1_SensorLaaghoogwater == 0)) || ((state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 0) && (state.s_Tunnel_HoofdPompkelder1_SensorLaagwater.lp_Tunnel_HoofdPompkelder1_SensorLaagwater == 0))) || (state.s_Tunnel_HoofdPompkelder1_Regime.lp_Tunnel_HoofdPompkelder1_Regime == 2))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_HoofdPompkelder1_Pomp1_c_uit needs Tunnel_HoofdPompkelder1_Regime.bergen and Tunnel_HoofdPompkelder1_SensorLaaghoogwater.uit or Tunnel_HoofdPompkelder1_Regime.leeghouden and Tunnel_HoofdPompkelder1_SensorLaagwater.uit or Tunnel_HoofdPompkelder1_Regime.uit\" of the top level scope of the specification failed.", e, state);
        }

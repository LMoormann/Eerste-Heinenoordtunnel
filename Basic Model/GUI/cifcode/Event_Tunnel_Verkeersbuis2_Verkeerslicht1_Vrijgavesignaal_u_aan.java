...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan", 1000, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Relatie".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Relatie.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

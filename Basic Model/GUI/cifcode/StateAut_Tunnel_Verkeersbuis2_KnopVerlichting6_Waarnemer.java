...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer;
        return rslt;
    }
}

...
/** Automaton "Tunnel_Verkeersbuis2_BedieningVentilatie_Modus". */
public final class Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_BedieningVentilatie_Modus";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(747).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(433);
        fillSyncData(aut, 747, rslt, state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_hand(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(748).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(433);
        fillSyncData(aut, 748, rslt, state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus = target.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.copy();
        target.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus = value;
    }
}

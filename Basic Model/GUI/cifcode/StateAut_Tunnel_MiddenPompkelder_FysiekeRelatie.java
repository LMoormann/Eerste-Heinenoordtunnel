...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_FysiekeRelatie". */
public final class StateAut_Tunnel_MiddenPompkelder_FysiekeRelatie {
    public int lp_Tunnel_MiddenPompkelder_FysiekeRelatie;

    public StateAut_Tunnel_MiddenPompkelder_FysiekeRelatie copy() {
        StateAut_Tunnel_MiddenPompkelder_FysiekeRelatie rslt = new StateAut_Tunnel_MiddenPompkelder_FysiekeRelatie();
        rslt.lp_Tunnel_MiddenPompkelder_FysiekeRelatie = lp_Tunnel_MiddenPompkelder_FysiekeRelatie;
        return rslt;
    }
}

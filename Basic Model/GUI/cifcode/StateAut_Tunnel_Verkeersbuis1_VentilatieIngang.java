...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_VentilatieIngang". */
public final class StateAut_Tunnel_Verkeersbuis1_VentilatieIngang {
    public int lp_Tunnel_Verkeersbuis1_VentilatieIngang;
    public int v_stand6;

    public StateAut_Tunnel_Verkeersbuis1_VentilatieIngang copy() {
        StateAut_Tunnel_Verkeersbuis1_VentilatieIngang rslt = new StateAut_Tunnel_Verkeersbuis1_VentilatieIngang();
        rslt.lp_Tunnel_Verkeersbuis1_VentilatieIngang = lp_Tunnel_Verkeersbuis1_VentilatieIngang;
        rslt.v_stand6 = v_stand6;
        return rslt;
    }
}

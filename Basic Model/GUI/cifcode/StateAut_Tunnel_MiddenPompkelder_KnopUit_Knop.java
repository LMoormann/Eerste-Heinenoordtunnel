...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_KnopUit_Knop". */
public final class StateAut_Tunnel_MiddenPompkelder_KnopUit_Knop {
    public int lp_Tunnel_MiddenPompkelder_KnopUit_Knop;

    public StateAut_Tunnel_MiddenPompkelder_KnopUit_Knop copy() {
        StateAut_Tunnel_MiddenPompkelder_KnopUit_Knop rslt = new StateAut_Tunnel_MiddenPompkelder_KnopUit_Knop();
        rslt.lp_Tunnel_MiddenPompkelder_KnopUit_Knop = lp_Tunnel_MiddenPompkelder_KnopUit_Knop;
        return rslt;
    }
}

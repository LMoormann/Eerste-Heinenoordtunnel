...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_Regime". */
public final class StateAut_Tunnel_HoofdPompkelder1_Regime {
    public int lp_Tunnel_HoofdPompkelder1_Regime;

    public StateAut_Tunnel_HoofdPompkelder1_Regime copy() {
        StateAut_Tunnel_HoofdPompkelder1_Regime rslt = new StateAut_Tunnel_HoofdPompkelder1_Regime();
        rslt.lp_Tunnel_HoofdPompkelder1_Regime = lp_Tunnel_HoofdPompkelder1_Regime;
        return rslt;
    }
}

...
/** Event "lb_drop_down_menu_buis_states.open_drop_down_menu". */
public final class Event_lb_drop_down_menu_buis_states_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_drop_down_menu_buis_states_open_drop_down_menu() {
        super("lb_drop_down_menu_buis_states.open_drop_down_menu", 17, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_drop_down_menu_buis_states.fillSyncData_evt_lb_drop_down_menu_buis_states_open_drop_down_menu(state);

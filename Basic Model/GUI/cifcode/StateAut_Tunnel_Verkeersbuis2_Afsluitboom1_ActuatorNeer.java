...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer = lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer;
        return rslt;
    }
}

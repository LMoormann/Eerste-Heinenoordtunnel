...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer = lp_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer;
        return rslt;
    }
}

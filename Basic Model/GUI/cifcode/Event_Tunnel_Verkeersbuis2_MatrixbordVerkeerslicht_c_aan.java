...
/** Event "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan() {
        super("Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan", 939, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht".
        proceed = Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan needs Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and (Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis2_Verkeerslicht2_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand == 3))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan needs not Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

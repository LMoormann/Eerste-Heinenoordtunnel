...
/** Runtime sub-state for automaton "geselecteerde_tab_tab_systemen_en_detecties". */
public final class StateAut_geselecteerde_tab_tab_systemen_en_detecties {
    public int lp_geselecteerde_tab_tab_systemen_en_detecties;

    public StateAut_geselecteerde_tab_tab_systemen_en_detecties copy() {
        StateAut_geselecteerde_tab_tab_systemen_en_detecties rslt = new StateAut_geselecteerde_tab_tab_systemen_en_detecties();
        rslt.lp_geselecteerde_tab_tab_systemen_en_detecties = lp_geselecteerde_tab_tab_systemen_en_detecties;
        return rslt;
    }
}

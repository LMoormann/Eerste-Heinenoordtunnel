...
/** Event "Tunnel_Verkeersbuis1_Verlichting_c_3". */
public final class Event_Tunnel_Verkeersbuis1_Verlichting_c_3 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verlichting_c_3() {
        super("Tunnel_Verkeersbuis1_Verlichting_c_3", 665, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_3(state);
        if (!proceed) return false;

        // Check automaton "sup34".
        proceed = Aut_sup34.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_3(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verlichting".
        proceed = Aut_Tunnel_Verkeersbuis1_Verlichting.fillSyncData_evt_Tunnel_Verkeersbuis1_Verlichting_c_3(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((((state.s_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis1_Onderhoud.lp_Tunnel_Verkeersbuis1_Onderhoud == 0)) && (state.s_Tunnel_Verkeersbuis1_Standby.lp_Tunnel_Verkeersbuis1_Standby == 0)) && (equal(state.s_Tunnel_Verkeersbuis1_Lichtsensor.v_stand2, 3))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Verlichting_c_3 needs Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.auto and Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis1_Onderhoud.uit and Tunnel_Verkeersbuis1_Standby.uit and Tunnel_Verkeersbuis1_Lichtsensor.stand = 3 or Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.hand and Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

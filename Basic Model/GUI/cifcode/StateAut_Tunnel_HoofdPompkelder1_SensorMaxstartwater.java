...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_SensorMaxstartwater". */
public final class StateAut_Tunnel_HoofdPompkelder1_SensorMaxstartwater {
    public int lp_Tunnel_HoofdPompkelder1_SensorMaxstartwater;

    public StateAut_Tunnel_HoofdPompkelder1_SensorMaxstartwater copy() {
        StateAut_Tunnel_HoofdPompkelder1_SensorMaxstartwater rslt = new StateAut_Tunnel_HoofdPompkelder1_SensorMaxstartwater();
        rslt.lp_Tunnel_HoofdPompkelder1_SensorMaxstartwater = lp_Tunnel_HoofdPompkelder1_SensorMaxstartwater;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Ventilatie_c_2". */
public final class Event_Tunnel_Verkeersbuis1_Ventilatie_c_2 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Ventilatie_c_2() {
        super("Tunnel_Verkeersbuis1_Ventilatie_c_2", 617, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_Ventilatie_c_2(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Ventilatie_c_2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Ventilatie".
        proceed = Aut_Tunnel_Verkeersbuis1_Ventilatie.fillSyncData_evt_Tunnel_Verkeersbuis1_Ventilatie_c_2(state);
        if (!proceed) return false;

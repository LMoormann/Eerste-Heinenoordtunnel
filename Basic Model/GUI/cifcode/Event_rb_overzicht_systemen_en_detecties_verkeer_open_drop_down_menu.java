...
/** Event "rb_overzicht_systemen_en_detecties_verkeer.open_drop_down_menu". */
public final class Event_rb_overzicht_systemen_en_detecties_verkeer_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_overzicht_systemen_en_detecties_verkeer_open_drop_down_menu() {
        super("rb_overzicht_systemen_en_detecties_verkeer.open_drop_down_menu", 133, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_overzicht_systemen_en_detecties_verkeer.fillSyncData_evt_rb_overzicht_systemen_en_detecties_verkeer_open_drop_down_menu(state);

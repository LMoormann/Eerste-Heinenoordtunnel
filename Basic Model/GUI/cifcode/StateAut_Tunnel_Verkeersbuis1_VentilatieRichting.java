...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_VentilatieRichting". */
public final class StateAut_Tunnel_Verkeersbuis1_VentilatieRichting {
    public int lp_Tunnel_Verkeersbuis1_VentilatieRichting;

    public StateAut_Tunnel_Verkeersbuis1_VentilatieRichting copy() {
        StateAut_Tunnel_Verkeersbuis1_VentilatieRichting rslt = new StateAut_Tunnel_Verkeersbuis1_VentilatieRichting();
        rslt.lp_Tunnel_Verkeersbuis1_VentilatieRichting = lp_Tunnel_Verkeersbuis1_VentilatieRichting;
        return rslt;
    }
}

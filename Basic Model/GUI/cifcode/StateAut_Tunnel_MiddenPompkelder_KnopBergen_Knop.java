...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_KnopBergen_Knop". */
public final class StateAut_Tunnel_MiddenPompkelder_KnopBergen_Knop {
    public int lp_Tunnel_MiddenPompkelder_KnopBergen_Knop;

    public StateAut_Tunnel_MiddenPompkelder_KnopBergen_Knop copy() {
        StateAut_Tunnel_MiddenPompkelder_KnopBergen_Knop rslt = new StateAut_Tunnel_MiddenPompkelder_KnopBergen_Knop();
        rslt.lp_Tunnel_MiddenPompkelder_KnopBergen_Knop = lp_Tunnel_MiddenPompkelder_KnopBergen_Knop;
        return rslt;
    }
}

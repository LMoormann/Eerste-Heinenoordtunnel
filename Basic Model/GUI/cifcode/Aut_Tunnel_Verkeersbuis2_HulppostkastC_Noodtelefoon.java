...
/** Automaton "Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon". */
public final class Aut_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(777).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(450);
        fillSyncData(aut, 777, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(778).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(450);
        fillSyncData(aut, 778, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon = target.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.copy();
        target.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon = value;
    }
}

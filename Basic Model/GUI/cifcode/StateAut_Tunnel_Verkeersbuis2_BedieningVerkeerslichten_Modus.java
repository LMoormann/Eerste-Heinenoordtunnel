...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus". */
public final class StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus {
    public int lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus;

    public StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus copy() {
        StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus rslt = new StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus();
        rslt.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus = lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus;
        return rslt;
    }
}

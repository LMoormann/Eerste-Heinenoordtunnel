...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop;
        return rslt;
    }
}

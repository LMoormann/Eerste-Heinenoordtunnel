...
/** Event "Tunnel_Verkeersbuis2_Rookdetectie_u_4". */
public final class Event_Tunnel_Verkeersbuis2_Rookdetectie_u_4 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Rookdetectie_u_4() {
        super("Tunnel_Verkeersbuis2_Rookdetectie_u_4", 960, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Rookdetectie_u_4(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Rookdetectie".
        proceed = Aut_Tunnel_Verkeersbuis2_Rookdetectie.fillSyncData_evt_Tunnel_Verkeersbuis2_Rookdetectie_u_4(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer;
        return rslt;
    }
}

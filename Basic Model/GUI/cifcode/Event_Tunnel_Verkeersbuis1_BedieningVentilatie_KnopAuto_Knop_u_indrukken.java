...
/** Event "Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken". */
public final class Event_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken() {
        super("Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken", 383, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop".
        proceed = Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop_u_indrukken(state);
        if (!proceed) return false;

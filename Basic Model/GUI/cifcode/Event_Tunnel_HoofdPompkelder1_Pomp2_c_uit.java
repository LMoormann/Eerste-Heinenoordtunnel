...
/** Event "Tunnel_HoofdPompkelder1_Pomp2_c_uit". */
public final class Event_Tunnel_HoofdPompkelder1_Pomp2_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_Pomp2_c_uit() {
        super("Tunnel_HoofdPompkelder1_Pomp2_c_uit", 200, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp2_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_Pomp2".
        proceed = Aut_Tunnel_HoofdPompkelder1_Pomp2.fillSyncData_evt_Tunnel_HoofdPompkelder1_Pomp2_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_HoofdPompkelder1_Pomp2_c_uit needs Tunnel_HoofdPompkelder1_Regime.bergen and Tunnel_HoofdPompkelder1_SensorLaaghoogwater.uit or Tunnel_HoofdPompkelder1_Regime.leeghouden and Tunnel_HoofdPompkelder1_SensorLaagwater.uit or Tunnel_HoofdPompkelder1_Regime.uit\" of the top level scope of the specification failed.", e, state);
        }

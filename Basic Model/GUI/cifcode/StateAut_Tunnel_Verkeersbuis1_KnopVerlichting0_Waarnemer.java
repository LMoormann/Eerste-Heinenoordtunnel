...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Lichtsensor". */
public final class StateAut_Tunnel_Verkeersbuis2_Lichtsensor {
    public int lp_Tunnel_Verkeersbuis2_Lichtsensor;
    public int v_stand4;

    public StateAut_Tunnel_Verkeersbuis2_Lichtsensor copy() {
        StateAut_Tunnel_Verkeersbuis2_Lichtsensor rslt = new StateAut_Tunnel_Verkeersbuis2_Lichtsensor();
        rslt.lp_Tunnel_Verkeersbuis2_Lichtsensor = lp_Tunnel_Verkeersbuis2_Lichtsensor;
        rslt.v_stand4 = v_stand4;
        return rslt;
    }
}

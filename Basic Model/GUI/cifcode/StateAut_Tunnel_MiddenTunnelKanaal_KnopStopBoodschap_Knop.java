...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop;
        return rslt;
    }
}

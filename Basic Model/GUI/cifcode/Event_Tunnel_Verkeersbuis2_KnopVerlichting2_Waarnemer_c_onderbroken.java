...
/** Event "Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken", 905, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup75".
        proceed = Aut_sup75.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

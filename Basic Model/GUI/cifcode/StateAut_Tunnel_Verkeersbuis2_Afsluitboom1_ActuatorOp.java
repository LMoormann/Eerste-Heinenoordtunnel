...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp = lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp;
        return rslt;
    }
}

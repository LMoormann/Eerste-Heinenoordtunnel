...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_HulppostkastC_Handblusser". */
public final class StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser {
    public int lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser;

    public StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser copy() {
        StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser rslt = new StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser();
        rslt.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser = lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser;
        return rslt;
    }
}

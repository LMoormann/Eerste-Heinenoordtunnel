...
/** Event "Tunnel_Verkeersbuis2_Kanaal_c_aan1". */
public final class Event_Tunnel_Verkeersbuis2_Kanaal_c_aan1 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Kanaal_c_aan1() {
        super("Tunnel_Verkeersbuis2_Kanaal_c_aan1", 786, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup4.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan1(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan1(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Kanaal_c_aan1 needs Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

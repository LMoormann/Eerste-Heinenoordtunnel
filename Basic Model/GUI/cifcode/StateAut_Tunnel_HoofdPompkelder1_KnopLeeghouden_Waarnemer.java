...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer". */
public final class StateAut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer {
    public int lp_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer;

    public StateAut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer copy() {
        StateAut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer rslt = new StateAut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer();
        rslt.lp_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer = lp_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer;
        return rslt;
    }
}

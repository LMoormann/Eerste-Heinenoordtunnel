...
/** Event "Tunnel_BrandBlusInstallatie_Pomp_c_uit". */
public final class Event_Tunnel_BrandBlusInstallatie_Pomp_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_Pomp_c_uit() {
        super("Tunnel_BrandBlusInstallatie_Pomp_c_uit", 173, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup44.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Pomp_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_Pomp".
        proceed = Aut_Tunnel_BrandBlusInstallatie_Pomp.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Pomp_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_BrandBlusInstallatie_SensorHoog.lp_Tunnel_BrandBlusInstallatie_SensorHoog == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_BrandBlusInstallatie_Pomp_c_uit needs Tunnel_BrandBlusInstallatie_SensorHoog.aan\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_knop_bewaken_Knop". */
public final class StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop {
    public int lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop;

    public StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop copy() {
        StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop rslt = new StateAut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop();
        rslt.lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop = lp_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop;
        return rslt;
    }
}

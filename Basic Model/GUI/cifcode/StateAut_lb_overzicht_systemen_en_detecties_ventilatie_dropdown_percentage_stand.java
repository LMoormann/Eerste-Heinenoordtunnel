...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand". */
public final class StateAut_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand {
    public int lp_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand;

    public StateAut_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand copy() {
        StateAut_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand rslt = new StateAut_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand();
        rslt.lp_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand = lp_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand;
        return rslt;
    }
}

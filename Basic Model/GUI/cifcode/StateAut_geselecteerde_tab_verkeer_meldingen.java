...
/** Runtime sub-state for automaton "geselecteerde_tab_verkeer_meldingen". */
public final class StateAut_geselecteerde_tab_verkeer_meldingen {
    public int lp_geselecteerde_tab_verkeer_meldingen;

    public StateAut_geselecteerde_tab_verkeer_meldingen copy() {
        StateAut_geselecteerde_tab_verkeer_meldingen rslt = new StateAut_geselecteerde_tab_verkeer_meldingen();
        rslt.lp_geselecteerde_tab_verkeer_meldingen = lp_geselecteerde_tab_verkeer_meldingen;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal = lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal;
        return rslt;
    }
}

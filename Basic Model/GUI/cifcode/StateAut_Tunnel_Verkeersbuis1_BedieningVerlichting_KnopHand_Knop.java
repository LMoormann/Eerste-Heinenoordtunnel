...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop {
    public int lp_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop;

    public StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop = lp_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop;
        return rslt;
    }
}

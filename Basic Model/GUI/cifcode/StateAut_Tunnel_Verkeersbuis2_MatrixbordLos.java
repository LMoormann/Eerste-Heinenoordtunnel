...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_MatrixbordLos". */
public final class StateAut_Tunnel_Verkeersbuis2_MatrixbordLos {
    public int lp_Tunnel_Verkeersbuis2_MatrixbordLos;

    public StateAut_Tunnel_Verkeersbuis2_MatrixbordLos copy() {
        StateAut_Tunnel_Verkeersbuis2_MatrixbordLos rslt = new StateAut_Tunnel_Verkeersbuis2_MatrixbordLos();
        rslt.lp_Tunnel_Verkeersbuis2_MatrixbordLos = lp_Tunnel_Verkeersbuis2_MatrixbordLos;
        return rslt;
    }
}

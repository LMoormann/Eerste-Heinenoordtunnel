...
/** Event "Tunnel_Verkeersbuis2_PopUp_Venster_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan() {
        super("Tunnel_Verkeersbuis2_PopUp_Venster_c_aan", 952, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup72".
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup76".
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup80".
        proceed = Aut_sup80.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_PopUp_Venster".
        proceed = Aut_Tunnel_Verkeersbuis2_PopUp_Venster.fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0) && (state.s_Tunnel_Verkeersbuis2_SOS.lp_Tunnel_Verkeersbuis2_SOS == 1)) && ((state.s_Tunnel_Verkeersbuis2_Rookdetectie.v_stand3) > (3))) && ((state.s_Tunnel_Verkeersbuis2_HulppostkastA_SensorOpen.lp_Tunnel_Verkeersbuis2_HulppostkastA_SensorOpen == 1) || (state.s_Tunnel_Verkeersbuis2_HulppostkastC_SensorOpen.lp_Tunnel_Verkeersbuis2_HulppostkastC_SensorOpen == 1))) && (((((state.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser == 1) || (state.s_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang == 1)) || (state.s_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon == 1)) || (state.s_Tunnel_Verkeersbuis2_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastC_Handblusser == 1)) || (state.s_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_SOS.aan and Tunnel_Verkeersbuis2_Rookdetectie.stand > 3 and (Tunnel_Verkeersbuis2_HulppostkastA_SensorOpen.aan or Tunnel_Verkeersbuis2_HulppostkastC_SensorOpen.aan) and (Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.aan or Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.aan or Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.aan or Tunnel_Verkeersbuis2_HulppostkastC_Handblusser.aan or Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.aan)\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer.lp_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Waarnemer.lp_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_noodtelefoon". */
public final class StateAut_rb_overzicht_systemen_en_detecties_noodtelefoon {
    public int lp_rb_overzicht_systemen_en_detecties_noodtelefoon;

    public StateAut_rb_overzicht_systemen_en_detecties_noodtelefoon copy() {
        StateAut_rb_overzicht_systemen_en_detecties_noodtelefoon rslt = new StateAut_rb_overzicht_systemen_en_detecties_noodtelefoon();
        rslt.lp_rb_overzicht_systemen_en_detecties_noodtelefoon = lp_rb_overzicht_systemen_en_detecties_noodtelefoon;
        return rslt;
    }
}

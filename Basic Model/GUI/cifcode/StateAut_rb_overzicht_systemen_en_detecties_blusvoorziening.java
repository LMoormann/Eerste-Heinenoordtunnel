...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_blusvoorziening". */
public final class StateAut_rb_overzicht_systemen_en_detecties_blusvoorziening {
    public int lp_rb_overzicht_systemen_en_detecties_blusvoorziening;

    public StateAut_rb_overzicht_systemen_en_detecties_blusvoorziening copy() {
        StateAut_rb_overzicht_systemen_en_detecties_blusvoorziening rslt = new StateAut_rb_overzicht_systemen_en_detecties_blusvoorziening();
        rslt.lp_rb_overzicht_systemen_en_detecties_blusvoorziening = lp_rb_overzicht_systemen_en_detecties_blusvoorziening;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen = lp_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen;
        return rslt;
    }
}

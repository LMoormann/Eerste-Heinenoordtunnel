...
/** Automaton "Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon". */
public final class Aut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(419).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(268);
        fillSyncData(aut, 419, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(420).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(268);
        fillSyncData(aut, 420, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon = target.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.copy();
        target.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon = value;
    }
}

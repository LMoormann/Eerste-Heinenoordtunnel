...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer;
        return rslt;
    }
}

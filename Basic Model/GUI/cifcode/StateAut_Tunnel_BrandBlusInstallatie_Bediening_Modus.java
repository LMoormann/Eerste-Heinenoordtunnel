...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_Bediening_Modus". */
public final class StateAut_Tunnel_BrandBlusInstallatie_Bediening_Modus {
    public int lp_Tunnel_BrandBlusInstallatie_Bediening_Modus;

    public StateAut_Tunnel_BrandBlusInstallatie_Bediening_Modus copy() {
        StateAut_Tunnel_BrandBlusInstallatie_Bediening_Modus rslt = new StateAut_Tunnel_BrandBlusInstallatie_Bediening_Modus();
        rslt.lp_Tunnel_BrandBlusInstallatie_Bediening_Modus = lp_Tunnel_BrandBlusInstallatie_Bediening_Modus;
        return rslt;
    }
}

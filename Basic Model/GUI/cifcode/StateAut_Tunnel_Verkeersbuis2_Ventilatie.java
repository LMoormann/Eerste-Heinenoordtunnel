...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Ventilatie". */
public final class StateAut_Tunnel_Verkeersbuis2_Ventilatie {
    public int lp_Tunnel_Verkeersbuis2_Ventilatie;
    public int v_stand8;

    public StateAut_Tunnel_Verkeersbuis2_Ventilatie copy() {
        StateAut_Tunnel_Verkeersbuis2_Ventilatie rslt = new StateAut_Tunnel_Verkeersbuis2_Ventilatie();
        rslt.lp_Tunnel_Verkeersbuis2_Ventilatie = lp_Tunnel_Verkeersbuis2_Ventilatie;
        rslt.v_stand8 = v_stand8;
        return rslt;
    }
}

...
/** Automaton "Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer". */
public final class Aut_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_KnopCamera6_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(816).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer_c_klaar(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(817).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer_c_onderbroken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(818).get(1);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"true\" of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            ...
            target.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer = source.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.copy();
            target.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer = 1;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"not true\" of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync1_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_Verkeersbuis2_Kanaal.lp_Tunnel_Verkeersbuis2_Kanaal == 6;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis2_Kanaal.camera6\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            boolean b; // temp var for pred eval rslts
            target.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer = source.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.copy();
            target.s_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer = 0;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync1_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"false\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

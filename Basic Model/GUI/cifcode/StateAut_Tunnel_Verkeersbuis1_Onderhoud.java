...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Onderhoud". */
public final class StateAut_Tunnel_Verkeersbuis1_Onderhoud {
    public int lp_Tunnel_Verkeersbuis1_Onderhoud;

    public StateAut_Tunnel_Verkeersbuis1_Onderhoud copy() {
        StateAut_Tunnel_Verkeersbuis1_Onderhoud rslt = new StateAut_Tunnel_Verkeersbuis1_Onderhoud();
        rslt.lp_Tunnel_Verkeersbuis1_Onderhoud = lp_Tunnel_Verkeersbuis1_Onderhoud;
        return rslt;
    }
}

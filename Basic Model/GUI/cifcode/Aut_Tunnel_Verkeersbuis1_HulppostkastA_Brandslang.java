...
/** Automaton "Tunnel_Verkeersbuis1_HulppostkastA_Brandslang". */
public final class Aut_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_HulppostkastA_Brandslang";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(409).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(263);
        fillSyncData(aut, 409, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(410).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(263);
        fillSyncData(aut, 410, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang = target.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.copy();
        target.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang = value;
    }
}

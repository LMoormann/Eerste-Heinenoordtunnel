...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer;
        return rslt;
    }
}

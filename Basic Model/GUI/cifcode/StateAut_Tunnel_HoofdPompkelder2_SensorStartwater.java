...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_SensorStartwater". */
public final class StateAut_Tunnel_HoofdPompkelder2_SensorStartwater {
    public int lp_Tunnel_HoofdPompkelder2_SensorStartwater;

    public StateAut_Tunnel_HoofdPompkelder2_SensorStartwater copy() {
        StateAut_Tunnel_HoofdPompkelder2_SensorStartwater rslt = new StateAut_Tunnel_HoofdPompkelder2_SensorStartwater();
        rslt.lp_Tunnel_HoofdPompkelder2_SensorStartwater = lp_Tunnel_HoofdPompkelder2_SensorStartwater;
        return rslt;
    }
}

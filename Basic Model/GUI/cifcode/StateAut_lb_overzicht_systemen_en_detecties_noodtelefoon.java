...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_noodtelefoon". */
public final class StateAut_lb_overzicht_systemen_en_detecties_noodtelefoon {
    public int lp_lb_overzicht_systemen_en_detecties_noodtelefoon;

    public StateAut_lb_overzicht_systemen_en_detecties_noodtelefoon copy() {
        StateAut_lb_overzicht_systemen_en_detecties_noodtelefoon rslt = new StateAut_lb_overzicht_systemen_en_detecties_noodtelefoon();
        rslt.lp_lb_overzicht_systemen_en_detecties_noodtelefoon = lp_lb_overzicht_systemen_en_detecties_noodtelefoon;
        return rslt;
    }
}

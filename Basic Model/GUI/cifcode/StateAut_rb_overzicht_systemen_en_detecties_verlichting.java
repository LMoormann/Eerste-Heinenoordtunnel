...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_verlichting". */
public final class StateAut_rb_overzicht_systemen_en_detecties_verlichting {
    public int lp_rb_overzicht_systemen_en_detecties_verlichting;

    public StateAut_rb_overzicht_systemen_en_detecties_verlichting copy() {
        StateAut_rb_overzicht_systemen_en_detecties_verlichting rslt = new StateAut_rb_overzicht_systemen_en_detecties_verlichting();
        rslt.lp_rb_overzicht_systemen_en_detecties_verlichting = lp_rb_overzicht_systemen_en_detecties_verlichting;
        return rslt;
    }
}

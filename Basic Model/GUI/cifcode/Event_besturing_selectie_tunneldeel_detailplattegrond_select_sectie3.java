...
/** Event "besturing_selectie_tunneldeel_detailplattegrond.select_sectie3". */
public final class Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie3 extends RuntimeEvent<State> {
    public Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie3() {
        super("besturing_selectie_tunneldeel_detailplattegrond.select_sectie3", 2, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_besturing_selectie_tunneldeel_detailplattegrond.fillSyncData_evt_besturing_selectie_tunneldeel_detailplattegrond_select_sectie3(state);

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Evacuatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Evacuatie {
    public int lp_Tunnel_Verkeersbuis1_Evacuatie;

    public StateAut_Tunnel_Verkeersbuis1_Evacuatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Evacuatie rslt = new StateAut_Tunnel_Verkeersbuis1_Evacuatie();
        rslt.lp_Tunnel_Verkeersbuis1_Evacuatie = lp_Tunnel_Verkeersbuis1_Evacuatie;
        return rslt;
    }
}

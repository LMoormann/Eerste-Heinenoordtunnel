...
/** Runtime sub-state for automaton "rb_bedienmenu_voor_verkeerslichtenstanden". */
public final class StateAut_rb_bedienmenu_voor_verkeerslichtenstanden {
    public int lp_rb_bedienmenu_voor_verkeerslichtenstanden;

    public StateAut_rb_bedienmenu_voor_verkeerslichtenstanden copy() {
        StateAut_rb_bedienmenu_voor_verkeerslichtenstanden rslt = new StateAut_rb_bedienmenu_voor_verkeerslichtenstanden();
        rslt.lp_rb_bedienmenu_voor_verkeerslichtenstanden = lp_rb_bedienmenu_voor_verkeerslichtenstanden;
        return rslt;
    }
}

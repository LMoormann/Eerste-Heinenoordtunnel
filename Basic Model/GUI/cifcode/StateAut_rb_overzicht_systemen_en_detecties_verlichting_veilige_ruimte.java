...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte". */
public final class StateAut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte {
    public int lp_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte;

    public StateAut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte copy() {
        StateAut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte rslt = new StateAut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte();
        rslt.lp_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte = lp_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop {
    public int lp_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop;

    public StateAut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop = lp_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop;
        return rslt;
    }
}

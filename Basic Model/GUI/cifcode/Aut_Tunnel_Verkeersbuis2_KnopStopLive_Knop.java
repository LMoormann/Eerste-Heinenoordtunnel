...
/** Automaton "Tunnel_Verkeersbuis2_KnopStopLive_Knop". */
public final class Aut_Tunnel_Verkeersbuis2_KnopStopLive_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_KnopStopLive_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_KnopStopLive_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_KnopStopLive_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_KnopStopLive_Knop.lp_Tunnel_Verkeersbuis2_KnopStopLive_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStopLive_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(864).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(499);
        fillSyncData(aut, 864, rslt, state.s_Tunnel_Verkeersbuis2_KnopStopLive_Knop.lp_Tunnel_Verkeersbuis2_KnopStopLive_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_KnopStopLive_Knop = target.s_Tunnel_Verkeersbuis2_KnopStopLive_Knop.copy();
        target.s_Tunnel_Verkeersbuis2_KnopStopLive_Knop.lp_Tunnel_Verkeersbuis2_KnopStopLive_Knop = value;
    }
}

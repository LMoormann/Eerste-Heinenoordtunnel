...
/** Automaton "Tunnel_BrandBlusInstallatie_knop_blussen_Knop". */
public final class Aut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_BrandBlusInstallatie_knop_blussen_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_BrandBlusInstallatie_knop_blussen_Knop.lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_BrandBlusInstallatie_knop_blussen_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(169).get(0);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(124);
        fillSyncData(aut, 169, rslt, state.s_Tunnel_BrandBlusInstallatie_knop_blussen_Knop.lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_BrandBlusInstallatie_knop_blussen_Knop = target.s_Tunnel_BrandBlusInstallatie_knop_blussen_Knop.copy();
        target.s_Tunnel_BrandBlusInstallatie_knop_blussen_Knop.lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop = value;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Recorder". */
public final class StateAut_Tunnel_Verkeersbuis2_Recorder {
    public int lp_Tunnel_Verkeersbuis2_Recorder;

    public StateAut_Tunnel_Verkeersbuis2_Recorder copy() {
        StateAut_Tunnel_Verkeersbuis2_Recorder rslt = new StateAut_Tunnel_Verkeersbuis2_Recorder();
        rslt.lp_Tunnel_Verkeersbuis2_Recorder = lp_Tunnel_Verkeersbuis2_Recorder;
        return rslt;
    }
}

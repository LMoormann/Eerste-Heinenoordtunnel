...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand". */
public final class StateAut_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand {
    public int lp_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand;

    public StateAut_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand copy() {
        StateAut_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand rslt = new StateAut_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand();
        rslt.lp_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand = lp_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Kanaal". */
public final class StateAut_Tunnel_Verkeersbuis1_Kanaal {
    public int lp_Tunnel_Verkeersbuis1_Kanaal;

    public StateAut_Tunnel_Verkeersbuis1_Kanaal copy() {
        StateAut_Tunnel_Verkeersbuis1_Kanaal rslt = new StateAut_Tunnel_Verkeersbuis1_Kanaal();
        rslt.lp_Tunnel_Verkeersbuis1_Kanaal = lp_Tunnel_Verkeersbuis1_Kanaal;
        return rslt;
    }
}

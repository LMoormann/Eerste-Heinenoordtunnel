...
/** Event "tau". */
public final class Event_tau extends RuntimeEvent<State> {
    public Event_tau() {
        super("tau", 1067, null);
    }
    ...
    public boolean fillData(State state) {
        SPEC.tauData.clear();
        Aut_besturing_selectie_tunneldeel_detailplattegrond.fillTauData(state);
        Aut_bevestigde_melding_sos_rechterbuis.fillTauData(state);
        Aut_event_disabler.fillTauData(state);
        Aut_geselecteerde_tab_tab_systemen_en_detecties.fillTauData(state);
        Aut_geselecteerde_tab_verkeer_meldingen.fillTauData(state);
        Aut_lb_bedienmenu_voor_verkeerslichtenstanden.fillTauData(state);
        Aut_lb_drop_down_menu_buis_states.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_blusser.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_blusvoorziening.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_buis.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_detecties.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_deur.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_haspel.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_hulppost.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_noodtelefoon.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte_drop_down_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_overig.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_SOS.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_tunnel.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_ventilatie.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_verkeer.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_verlichting.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_verlichting_dropdown_percentage_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vloeistofafvoer.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vluchtdeuren.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie_dropdown_contourverlichting_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie_dropdown_geluidsbakens_stand.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_vluchtroute.fillTauData(state);
        Aut_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom.fillTauData(state);
        Aut_melding_sos_rechterbuis_geselecteerd.fillTauData(state);
        Aut_openen_en_sluiten_bevestigde_meldingen.fillTauData(state);
        Aut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton.fillTauData(state);
        Aut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton.fillTauData(state);
        Aut_overzicht_systemen_en_detecties_drop_down_midden_pomp_kelder_stand_automaton.fillTauData(state);
        Aut_rb_bedienmenu_voor_verkeerslichtenstanden.fillTauData(state);
        Aut_rb_drop_down_menu_buis_states.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_blusser.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_blusvoorziening.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_bluswatervoorziening_drop_down_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_buis.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_detecties.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_deur.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_drop_down_richting_ventilatie.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_haspel.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_hulppost.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_noodtelefoon.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte_drop_down_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_overig.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_SOS.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_tunnel.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_ventilatie.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_ventilatie_dropdown_percentage_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_verkeer.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_verlichting.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_verlichting_dropdown_percentage_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vloeistofafvoer.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vluchtdeuren.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie_dropdown_contourverlichting_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie_dropdown_geluidsbakens_stand.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_vluchtroute.fillTauData(state);
        Aut_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom.fillTauData(state);
        Aut_sup10.fillTauData(state);
        Aut_sup15.fillTauData(state);
        Aut_sup2.fillTauData(state);
        Aut_sup30.fillTauData(state);
        Aut_sup31.fillTauData(state);
        Aut_sup34.fillTauData(state);
        Aut_sup35.fillTauData(state);
        Aut_sup38.fillTauData(state);
        Aut_sup39.fillTauData(state);
        Aut_sup4.fillTauData(state);
        Aut_sup41.fillTauData(state);
        Aut_sup42.fillTauData(state);
        Aut_sup43.fillTauData(state);
        Aut_sup44.fillTauData(state);
        Aut_sup47.fillTauData(state);
        Aut_sup48.fillTauData(state);
        Aut_sup49.fillTauData(state);
        Aut_sup50.fillTauData(state);
        Aut_sup51.fillTauData(state);
        Aut_sup56.fillTauData(state);
        Aut_sup6.fillTauData(state);
        Aut_sup7.fillTauData(state);
        Aut_sup71.fillTauData(state);
        Aut_sup72.fillTauData(state);
        Aut_sup75.fillTauData(state);
        Aut_sup76.fillTauData(state);
        Aut_sup79.fillTauData(state);
        Aut_sup8.fillTauData(state);
        Aut_sup80.fillTauData(state);
        Aut_sup82.fillTauData(state);
        Aut_sup83.fillTauData(state);
        Aut_sup84.fillTauData(state);
        Aut_sup85.fillTauData(state);
        Aut_sup86.fillTauData(state);
        Aut_sup88.fillTauData(state);
        Aut_sup89.fillTauData(state);
        Aut_sup9.fillTauData(state);
        Aut_sup92.fillTauData(state);
        Aut_sup93.fillTauData(state);
        Aut_sup95.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Bediening_Modus.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_knop_bewaken_Knop.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_knop_bewaken_Waarnemer.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_knop_blussen_Waarnemer.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Pomp.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_Regime.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_SensorHoog.fillTauData(state);
        Aut_Tunnel_BrandBlusInstallatie_SensorLaag.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Bediening_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Bediening_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Bediening_Modus.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopBergen_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopBergen_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopUit_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_KnopUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Pomp1.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Pomp2.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_Regime.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_SensorHooghoogwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_SensorLaaghoogwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_SensorLaagwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_SensorMaxstartwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder1_SensorStartwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Bediening_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Bediening_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Bediening_Modus.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopBergen_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopBergen_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopLeeghouden_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopLeeghouden_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopUit_Knop.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_KnopUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Pomp1.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Pomp2.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_Regime.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_SensorHooghoogwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_SensorLaagwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_SensorMaxstartwater.fillTauData(state);
        Aut_Tunnel_HoofdPompkelder2_SensorStartwater.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Bediening_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Bediening_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Bediening_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Bediening_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Bediening_Modus.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopBergen_Knop.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopLeeghouden_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopUit_Knop.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_KnopUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Pomp1.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Pomp2.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_PompRichting.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_Regime.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_SensorHooghoogwater.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_SensorLaaghoogwater.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_SensorLaagwater.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_SensorMaxstartwater.fillTauData(state);
        Aut_Tunnel_MiddenPompkelder_SensorStartwater.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningDynamischeVluchtrouteIndicatie_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningDynamischeVluchtrouteIndicatie_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningDynamischeVluchtrouteIndicatie_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningDynamischeVluchtrouteIndicatie_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningDynamischeVluchtrouteIndicatie_Modus.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_BedieningVerlichting_Modus.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieAflopend_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieAflopend_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieOplopend_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieOplopend_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopDynamischeVluchtrouteIndicatieUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopStartBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopStartBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_Luidspreker.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_Overdruk.fillTauData(state);
        Aut_Tunnel_MiddenTunnelKanaal_Verlichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_ObstakelDetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_SensorDicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom1_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorOp.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorDicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Afsluitboom2_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerkeerslichten_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Evacuatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastA_Handblusser.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_HulppostkastC_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_J32_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Kanaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCalamiteit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCalamiteit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopCamera6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopEvacuatie_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopHerstel_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopKnipperVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopKnipperVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOnderhoud_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOpenVerkeersbuis_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOperationeel_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopOperationeel_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopRoodVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStartBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStartBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStartLive_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStartLive_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopLive_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopUitVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopUitVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie0_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie0_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie7_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie8_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVentilatie8_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting0_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting0_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting7_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting7_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_KnopVerlichting8_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Lichtsensor.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Luidspreker.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_MatrixbordLos.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Onderhoud.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_Timer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_PopUp_Venster.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Recorder.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Rookdetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_SOS.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Standby.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_StandVerkeersbuis.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Ventilatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_VentilatieIngang.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_VentilatieRichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Verlichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningContourVerlichting_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningGeluidsbaken_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningGeluidsbaken_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_BedieningGeluidsbaken_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingUit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopContourVerlichtingUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenUit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_KnopGeluidsbakenUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_Vluchtdeur_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis1_WisselTimerAudio.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_FysiekeRelatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ObstakelDetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerlichting_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerlichting_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerlichting_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerlichting_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_BedieningVerlichting_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Evacuatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastA_Noodtelefoon.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastA_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastC_Handblusser.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastC_Noodtelefoon.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_HulppostkastC_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_J32_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Kanaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCalamiteit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopEvacuatie_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopEvacuatie_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopHerstel_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOnderhoud_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOnderhoud_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOperationeel_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopOperationeel_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStartBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStartBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStartLive_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopBoodschap_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopBoodschap_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopLive_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopStopLive_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie0_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie0_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie7_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie7_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting0_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting0_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting1_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting1_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting2_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting2_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting3_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting3_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting4_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting4_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting5_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting5_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting6_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting6_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting7_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting7_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting8_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_KnopVerlichting8_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Lichtsensor.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Luidspreker.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_MatrixbordLos.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Onderhoud.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_KnopAfwijzen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_Timer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_PopUp_Venster.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Recorder.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Rookdetectie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_SOS.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Standby.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_StandVerkeersbuis.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Ventilatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_VentilatieIngang.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_VentilatieRichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_Relatie.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Verlichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopAuto_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopAuto_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_ContourVerlichting.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_Geluidsbaken.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingUit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Waarnemer.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_Vluchtdeur_SensorOpen.fillTauData(state);
        Aut_Tunnel_Verkeersbuis2_WisselTimerAudio.fillTauData(state);
        return !SPEC.tauData.isEmpty();
    }

...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset", 998, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht1_TimerVrijgavesignaal_c_reset needs not Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

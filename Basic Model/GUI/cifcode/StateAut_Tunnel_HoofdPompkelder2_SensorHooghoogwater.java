...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_SensorHooghoogwater". */
public final class StateAut_Tunnel_HoofdPompkelder2_SensorHooghoogwater {
    public int lp_Tunnel_HoofdPompkelder2_SensorHooghoogwater;

    public StateAut_Tunnel_HoofdPompkelder2_SensorHooghoogwater copy() {
        StateAut_Tunnel_HoofdPompkelder2_SensorHooghoogwater rslt = new StateAut_Tunnel_HoofdPompkelder2_SensorHooghoogwater();
        rslt.lp_Tunnel_HoofdPompkelder2_SensorHooghoogwater = lp_Tunnel_HoofdPompkelder2_SensorHooghoogwater;
        return rslt;
    }
}

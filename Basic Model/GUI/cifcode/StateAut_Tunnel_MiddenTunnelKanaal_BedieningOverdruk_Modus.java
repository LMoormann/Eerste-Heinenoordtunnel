...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus {
    public int lp_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus;

    public StateAut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus rslt = new StateAut_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus();
        rslt.lp_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus = lp_Tunnel_MiddenTunnelKanaal_BedieningOverdruk_Modus;
        return rslt;
    }
}

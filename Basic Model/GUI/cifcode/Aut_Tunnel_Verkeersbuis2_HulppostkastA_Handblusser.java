...
/** Automaton "Tunnel_Verkeersbuis2_HulppostkastA_Handblusser". */
public final class Aut_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_HulppostkastA_Handblusser";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(769).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(446);
        fillSyncData(aut, 769, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(770).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(446);
        fillSyncData(aut, 770, rslt, state.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser = target.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.copy();
        target.s_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis2_HulppostkastA_Handblusser = value;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop = lp_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Knop;
        return rslt;
    }
}

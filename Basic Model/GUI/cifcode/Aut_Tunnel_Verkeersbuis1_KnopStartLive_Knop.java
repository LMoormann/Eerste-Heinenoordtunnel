...
/** Automaton "Tunnel_Verkeersbuis1_KnopStartLive_Knop". */
public final class Aut_Tunnel_Verkeersbuis1_KnopStartLive_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_KnopStartLive_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_KnopStartLive_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_KnopStartLive_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_KnopStartLive_Knop.lp_Tunnel_Verkeersbuis1_KnopStartLive_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopStartLive_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(497).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(311);
        fillSyncData(aut, 497, rslt, state.s_Tunnel_Verkeersbuis1_KnopStartLive_Knop.lp_Tunnel_Verkeersbuis1_KnopStartLive_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_KnopStartLive_Knop = target.s_Tunnel_Verkeersbuis1_KnopStartLive_Knop.copy();
        target.s_Tunnel_Verkeersbuis1_KnopStartLive_Knop.lp_Tunnel_Verkeersbuis1_KnopStartLive_Knop = value;
    }
}

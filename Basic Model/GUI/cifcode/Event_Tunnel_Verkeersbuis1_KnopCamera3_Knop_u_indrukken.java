...
/** Event "Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken". */
public final class Event_Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken() {
        super("Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken", 449, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_Verkeersbuis1_KnopCamera3_Knop".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopCamera3_Knop.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken(state);
        if (!proceed) return false;

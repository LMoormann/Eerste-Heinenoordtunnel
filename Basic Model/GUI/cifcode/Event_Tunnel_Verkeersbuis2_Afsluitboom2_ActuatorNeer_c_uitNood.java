...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood() {
        super("Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood", 723, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 0) && ((((state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ObstakelDetectie == 1) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal == 0)) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal == 0)) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal == 0))) || ((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 1) && ((state.s_Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer == 1))))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer_c_uitNood needs Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.auto and (Tunnel_Verkeersbuis2_Afsluitboom2_ObstakelDetectie.aan or Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.uit or Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal.uit or Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal.uit) or Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer.ingedrukt)\" of the top level scope of the specification failed.", e, state);
        }

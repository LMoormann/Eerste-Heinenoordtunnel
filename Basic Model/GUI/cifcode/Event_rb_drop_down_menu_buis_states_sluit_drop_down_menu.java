...
/** Event "rb_drop_down_menu_buis_states.sluit_drop_down_menu". */
public final class Event_rb_drop_down_menu_buis_states_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_drop_down_menu_buis_states_sluit_drop_down_menu() {
        super("rb_drop_down_menu_buis_states.sluit_drop_down_menu", 94, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_drop_down_menu_buis_states.fillSyncData_evt_rb_drop_down_menu_buis_states_sluit_drop_down_menu(state);

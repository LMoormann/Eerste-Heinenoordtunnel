...
/** Event "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand". */
public final class Event_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand() {
        super("Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand", 1044, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "sup72".
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "sup82".
        proceed = Aut_sup82.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "sup84".
        proceed = Aut_sup84.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus".
        proceed = Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Waarnemer.lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_Modus_c_hand needs Tunnel_Verkeersbuis2_Vluchtdeur_BedieningGeluidsbaken_KnopHand_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVentilatie1_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop = lp_Tunnel_Verkeersbuis1_KnopVentilatie1_Knop;
        return rslt;
    }
}

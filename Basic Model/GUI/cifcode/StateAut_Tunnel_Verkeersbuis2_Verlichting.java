...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verlichting". */
public final class StateAut_Tunnel_Verkeersbuis2_Verlichting {
    public int lp_Tunnel_Verkeersbuis2_Verlichting;
    public int v_stand10;

    public StateAut_Tunnel_Verkeersbuis2_Verlichting copy() {
        StateAut_Tunnel_Verkeersbuis2_Verlichting rslt = new StateAut_Tunnel_Verkeersbuis2_Verlichting();
        rslt.lp_Tunnel_Verkeersbuis2_Verlichting = lp_Tunnel_Verkeersbuis2_Verlichting;
        rslt.v_stand10 = v_stand10;
        return rslt;
    }
}

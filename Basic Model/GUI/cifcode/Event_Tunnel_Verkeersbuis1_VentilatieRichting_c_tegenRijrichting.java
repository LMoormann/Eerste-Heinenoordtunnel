...
/** Event "Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting". */
public final class Event_Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting() {
        super("Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting", 634, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_VentilatieRichting".
        proceed = Aut_Tunnel_Verkeersbuis1_VentilatieRichting.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_VentilatieRichting_c_tegenRijrichting needs Tunnel_Verkeersbuis1_StandVerkeersbuis.ondersteunend\" of the top level scope of the specification failed.", e, state);
        }

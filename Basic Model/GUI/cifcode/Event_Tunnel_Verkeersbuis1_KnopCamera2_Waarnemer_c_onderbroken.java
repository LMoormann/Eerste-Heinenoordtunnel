...
/** Event "Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken", 448, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup2.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

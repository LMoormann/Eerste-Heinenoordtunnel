...
/** Event "Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken() {
        super("Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken", 160, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup44.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup47".
        proceed = Aut_sup47.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer".
        proceed = Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_SensorLaagwater". */
public final class StateAut_Tunnel_MiddenPompkelder_SensorLaagwater {
    public int lp_Tunnel_MiddenPompkelder_SensorLaagwater;

    public StateAut_Tunnel_MiddenPompkelder_SensorLaagwater copy() {
        StateAut_Tunnel_MiddenPompkelder_SensorLaagwater rslt = new StateAut_Tunnel_MiddenPompkelder_SensorLaagwater();
        rslt.lp_Tunnel_MiddenPompkelder_SensorLaagwater = lp_Tunnel_MiddenPompkelder_SensorLaagwater;
        return rslt;
    }
}

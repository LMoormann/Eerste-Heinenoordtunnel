...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer;
        return rslt;
    }
}

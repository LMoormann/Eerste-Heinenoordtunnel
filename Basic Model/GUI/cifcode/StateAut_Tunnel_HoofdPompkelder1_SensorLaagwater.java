...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_SensorLaagwater". */
public final class StateAut_Tunnel_HoofdPompkelder1_SensorLaagwater {
    public int lp_Tunnel_HoofdPompkelder1_SensorLaagwater;

    public StateAut_Tunnel_HoofdPompkelder1_SensorLaagwater copy() {
        StateAut_Tunnel_HoofdPompkelder1_SensorLaagwater rslt = new StateAut_Tunnel_HoofdPompkelder1_SensorLaagwater();
        rslt.lp_Tunnel_HoofdPompkelder1_SensorLaagwater = lp_Tunnel_HoofdPompkelder1_SensorLaagwater;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_drop_down_menu_buis_states". */
public final class StateAut_lb_drop_down_menu_buis_states {
    public int lp_lb_drop_down_menu_buis_states;

    public StateAut_lb_drop_down_menu_buis_states copy() {
        StateAut_lb_drop_down_menu_buis_states rslt = new StateAut_lb_drop_down_menu_buis_states();
        rslt.lp_lb_drop_down_menu_buis_states = lp_lb_drop_down_menu_buis_states;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_vluchtdeuren". */
public final class StateAut_lb_overzicht_systemen_en_detecties_vluchtdeuren {
    public int lp_lb_overzicht_systemen_en_detecties_vluchtdeuren;

    public StateAut_lb_overzicht_systemen_en_detecties_vluchtdeuren copy() {
        StateAut_lb_overzicht_systemen_en_detecties_vluchtdeuren rslt = new StateAut_lb_overzicht_systemen_en_detecties_vluchtdeuren();
        rslt.lp_lb_overzicht_systemen_en_detecties_vluchtdeuren = lp_lb_overzicht_systemen_en_detecties_vluchtdeuren;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit". */
public final class Event_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit() {
        super("Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit", 582, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht".
        proceed = Aut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopVentilatie3_Waarnemer;
        return rslt;
    }
}

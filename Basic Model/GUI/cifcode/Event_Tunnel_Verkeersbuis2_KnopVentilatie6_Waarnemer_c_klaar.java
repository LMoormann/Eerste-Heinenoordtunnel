...
/** Event "Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar", 889, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVentilatie6_Waarnemer_c_klaar(state);
        if (!proceed) return false;

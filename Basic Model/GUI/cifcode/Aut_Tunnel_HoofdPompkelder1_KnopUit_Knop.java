...
/** Automaton "Tunnel_HoofdPompkelder1_KnopUit_Knop". */
public final class Aut_Tunnel_HoofdPompkelder1_KnopUit_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_HoofdPompkelder1_KnopUit_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_HoofdPompkelder1_KnopUit_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_HoofdPompkelder1_KnopUit_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_HoofdPompkelder1_KnopUit_Knop.lp_Tunnel_HoofdPompkelder1_KnopUit_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_HoofdPompkelder1_KnopUit_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(194).get(0);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(140);
        fillSyncData(aut, 194, rslt, state.s_Tunnel_HoofdPompkelder1_KnopUit_Knop.lp_Tunnel_HoofdPompkelder1_KnopUit_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_HoofdPompkelder1_KnopUit_Knop = target.s_Tunnel_HoofdPompkelder1_KnopUit_Knop.copy();
        target.s_Tunnel_HoofdPompkelder1_KnopUit_Knop.lp_Tunnel_HoofdPompkelder1_KnopUit_Knop = value;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan". */
public final class Event_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan() {
        super("Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan", 409, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_HulppostkastA_Brandslang".
        proceed = Aut_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang_u_aan(state);
        if (!proceed) return false;

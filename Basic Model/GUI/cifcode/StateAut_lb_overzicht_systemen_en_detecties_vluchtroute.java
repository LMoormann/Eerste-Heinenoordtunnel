...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_vluchtroute". */
public final class StateAut_lb_overzicht_systemen_en_detecties_vluchtroute {
    public int lp_lb_overzicht_systemen_en_detecties_vluchtroute;

    public StateAut_lb_overzicht_systemen_en_detecties_vluchtroute copy() {
        StateAut_lb_overzicht_systemen_en_detecties_vluchtroute rslt = new StateAut_lb_overzicht_systemen_en_detecties_vluchtroute();
        rslt.lp_lb_overzicht_systemen_en_detecties_vluchtroute = lp_lb_overzicht_systemen_en_detecties_vluchtroute;
        return rslt;
    }
}

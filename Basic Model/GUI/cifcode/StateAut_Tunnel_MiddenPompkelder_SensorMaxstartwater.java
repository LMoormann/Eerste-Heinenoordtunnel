...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_SensorMaxstartwater". */
public final class StateAut_Tunnel_MiddenPompkelder_SensorMaxstartwater {
    public int lp_Tunnel_MiddenPompkelder_SensorMaxstartwater;

    public StateAut_Tunnel_MiddenPompkelder_SensorMaxstartwater copy() {
        StateAut_Tunnel_MiddenPompkelder_SensorMaxstartwater rslt = new StateAut_Tunnel_MiddenPompkelder_SensorMaxstartwater();
        rslt.lp_Tunnel_MiddenPompkelder_SensorMaxstartwater = lp_Tunnel_MiddenPompkelder_SensorMaxstartwater;
        return rslt;
    }
}

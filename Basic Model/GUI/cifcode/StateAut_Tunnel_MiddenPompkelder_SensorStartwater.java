...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_SensorStartwater". */
public final class StateAut_Tunnel_MiddenPompkelder_SensorStartwater {
    public int lp_Tunnel_MiddenPompkelder_SensorStartwater;

    public StateAut_Tunnel_MiddenPompkelder_SensorStartwater copy() {
        StateAut_Tunnel_MiddenPompkelder_SensorStartwater rslt = new StateAut_Tunnel_MiddenPompkelder_SensorStartwater();
        rslt.lp_Tunnel_MiddenPompkelder_SensorStartwater = lp_Tunnel_MiddenPompkelder_SensorStartwater;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_ventilatie". */
public final class StateAut_rb_overzicht_systemen_en_detecties_ventilatie {
    public int lp_rb_overzicht_systemen_en_detecties_ventilatie;

    public StateAut_rb_overzicht_systemen_en_detecties_ventilatie copy() {
        StateAut_rb_overzicht_systemen_en_detecties_ventilatie rslt = new StateAut_rb_overzicht_systemen_en_detecties_ventilatie();
        rslt.lp_rb_overzicht_systemen_en_detecties_ventilatie = lp_rb_overzicht_systemen_en_detecties_ventilatie;
        return rslt;
    }
}

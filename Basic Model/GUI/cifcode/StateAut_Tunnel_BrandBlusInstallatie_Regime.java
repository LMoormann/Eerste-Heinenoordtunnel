...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_Regime". */
public final class StateAut_Tunnel_BrandBlusInstallatie_Regime {
    public int lp_Tunnel_BrandBlusInstallatie_Regime;

    public StateAut_Tunnel_BrandBlusInstallatie_Regime copy() {
        StateAut_Tunnel_BrandBlusInstallatie_Regime rslt = new StateAut_Tunnel_BrandBlusInstallatie_Regime();
        rslt.lp_Tunnel_BrandBlusInstallatie_Regime = lp_Tunnel_BrandBlusInstallatie_Regime;
        return rslt;
    }
}

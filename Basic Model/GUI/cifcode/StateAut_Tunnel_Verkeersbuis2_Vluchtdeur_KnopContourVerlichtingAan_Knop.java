...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop = lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopContourVerlichtingAan_Knop;
        return rslt;
    }
}

...
/** Event "besturing_selectie_tunneldeel_detailplattegrond.select_sectie2". */
public final class Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie2 extends RuntimeEvent<State> {
    public Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie2() {
        super("besturing_selectie_tunneldeel_detailplattegrond.select_sectie2", 1, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_besturing_selectie_tunneldeel_detailplattegrond.fillSyncData_evt_besturing_selectie_tunneldeel_detailplattegrond_select_sectie2(state);

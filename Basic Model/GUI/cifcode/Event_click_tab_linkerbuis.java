...
public final class Event_click_tab_linkerbuis extends RuntimeEvent<State> {
    public Event_click_tab_linkerbuis() {
        super("click_tab_linkerbuis", 11, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_geselecteerde_tab_tab_systemen_en_detecties.fillSyncData_evt_click_tab_linkerbuis(state);

...
/** Event "Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken() {
        super("Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken", 185, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup89".
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup92".
        proceed = Aut_sup92.fillSyncData_evt_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer".
        proceed = Aut_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer.fillSyncData_evt_Tunnel_HoofdPompkelder1_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

...
/** Event "rb_overzicht_systemen_en_detecties_detecties.sluit_drop_down_menu". */
public final class Event_rb_overzicht_systemen_en_detecties_detecties_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_overzicht_systemen_en_detecties_detecties_sluit_drop_down_menu() {
        super("rb_overzicht_systemen_en_detecties_detecties.sluit_drop_down_menu", 104, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_overzicht_systemen_en_detecties_detecties.fillSyncData_evt_rb_overzicht_systemen_en_detecties_detecties_sluit_drop_down_menu(state);

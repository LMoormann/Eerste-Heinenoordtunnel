...
/** Event "Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto". */
public final class Event_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto() {
        super("Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto", 747, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_BedieningVentilatie_Modus".
        proceed = Aut_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.fillSyncData_evt_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopAuto_Waarnemer.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_KnopAuto_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_BedieningVentilatie_Modus_c_auto needs Tunnel_Verkeersbuis2_BedieningVentilatie_KnopAuto_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

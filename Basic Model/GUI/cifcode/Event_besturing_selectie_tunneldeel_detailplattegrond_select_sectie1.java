...
/** Event "besturing_selectie_tunneldeel_detailplattegrond.select_sectie1". */
public final class Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie1 extends RuntimeEvent<State> {
    public Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie1() {
        super("besturing_selectie_tunneldeel_detailplattegrond.select_sectie1", 0, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "besturing_selectie_tunneldeel_detailplattegrond".
        proceed = Aut_besturing_selectie_tunneldeel_detailplattegrond.fillSyncData_evt_besturing_selectie_tunneldeel_detailplattegrond_select_sectie1(state);

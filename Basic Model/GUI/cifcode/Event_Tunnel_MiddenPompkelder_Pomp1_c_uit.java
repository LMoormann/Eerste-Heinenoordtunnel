...
/** Event "Tunnel_MiddenPompkelder_Pomp1_c_uit". */
public final class Event_Tunnel_MiddenPompkelder_Pomp1_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_MiddenPompkelder_Pomp1_c_uit() {
        super("Tunnel_MiddenPompkelder_Pomp1_c_uit", 266, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup86.fillSyncData_evt_Tunnel_MiddenPompkelder_Pomp1_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenPompkelder_Pomp1".
        proceed = Aut_Tunnel_MiddenPompkelder_Pomp1.fillSyncData_evt_Tunnel_MiddenPompkelder_Pomp1_c_uit(state);
        if (!proceed) return false;

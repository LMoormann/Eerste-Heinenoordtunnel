...
public final class Event_click_tab_rechterbuis extends RuntimeEvent<State> {
    public Event_click_tab_rechterbuis() {
        super("click_tab_rechterbuis", 13, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "geselecteerde_tab_tab_systemen_en_detecties".
        proceed = Aut_geselecteerde_tab_tab_systemen_en_detecties.fillSyncData_evt_click_tab_rechterbuis(state);

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_WisselTimerAudio". */
public final class StateAut_Tunnel_Verkeersbuis2_WisselTimerAudio {
    public int lp_Tunnel_Verkeersbuis2_WisselTimerAudio;

    public StateAut_Tunnel_Verkeersbuis2_WisselTimerAudio copy() {
        StateAut_Tunnel_Verkeersbuis2_WisselTimerAudio rslt = new StateAut_Tunnel_Verkeersbuis2_WisselTimerAudio();
        rslt.lp_Tunnel_Verkeersbuis2_WisselTimerAudio = lp_Tunnel_Verkeersbuis2_WisselTimerAudio;
        return rslt;
    }
}

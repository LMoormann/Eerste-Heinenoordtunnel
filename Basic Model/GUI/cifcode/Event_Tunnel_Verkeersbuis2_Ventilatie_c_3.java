...
/** Event "Tunnel_Verkeersbuis2_Ventilatie_c_3". */
public final class Event_Tunnel_Verkeersbuis2_Ventilatie_c_3 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Ventilatie_c_3() {
        super("Tunnel_Verkeersbuis2_Ventilatie_c_3", 976, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_3(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_3(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Ventilatie".
        proceed = Aut_Tunnel_Verkeersbuis2_Ventilatie.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_3(state);
        if (!proceed) return false;

...
/** Event "lb_overzicht_systemen_en_detecties_blusser.open_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_blusser.open_drop_down_menu", 19, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_blusser.fillSyncData_evt_lb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu(state);

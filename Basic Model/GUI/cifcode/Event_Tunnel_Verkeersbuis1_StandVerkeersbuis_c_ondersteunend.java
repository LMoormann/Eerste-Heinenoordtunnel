...
/** Event "Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend". */
public final class Event_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend() {
        super("Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend", 613, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;

        // Check automaton "sup35".
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;

        // Check automaton "sup39".
        proceed = Aut_sup39.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_StandVerkeersbuis".
        proceed = Aut_Tunnel_Verkeersbuis1_StandVerkeersbuis.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend needs Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_StandVerkeersbuis_c_ondersteunend needs not Tunnel_Verkeersbuis1_StandVerkeersbuis.calamiteit\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop = lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenUit_Knop;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood() {
        super("Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood", 353, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

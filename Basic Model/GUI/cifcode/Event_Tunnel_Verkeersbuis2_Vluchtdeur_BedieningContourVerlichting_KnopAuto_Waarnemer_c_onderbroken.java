...
/** Event "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken", 1031, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup79".
        proceed = Aut_sup79.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_KnopAuto_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

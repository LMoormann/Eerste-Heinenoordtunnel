...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_SensorLaagwater". */
public final class StateAut_Tunnel_HoofdPompkelder2_SensorLaagwater {
    public int lp_Tunnel_HoofdPompkelder2_SensorLaagwater;

    public StateAut_Tunnel_HoofdPompkelder2_SensorLaagwater copy() {
        StateAut_Tunnel_HoofdPompkelder2_SensorLaagwater rslt = new StateAut_Tunnel_HoofdPompkelder2_SensorLaagwater();
        rslt.lp_Tunnel_HoofdPompkelder2_SensorLaagwater = lp_Tunnel_HoofdPompkelder2_SensorLaagwater;
        return rslt;
    }
}

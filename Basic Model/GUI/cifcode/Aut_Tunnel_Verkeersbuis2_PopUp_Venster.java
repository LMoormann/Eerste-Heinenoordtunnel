...
/** Automaton "Tunnel_Verkeersbuis2_PopUp_Venster". */
public final class Aut_Tunnel_Verkeersbuis2_PopUp_Venster extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_PopUp_Venster() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_PopUp_Venster", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_PopUp_Venster";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(952).get(5);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(550);
        fillSyncData(aut, 952, rslt, state.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_PopUp_Venster_c_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(953).get(5);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(550);
        fillSyncData(aut, 953, rslt, state.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_PopUp_Venster = target.s_Tunnel_Verkeersbuis2_PopUp_Venster.copy();
        target.s_Tunnel_Verkeersbuis2_PopUp_Venster.lp_Tunnel_Verkeersbuis2_PopUp_Venster = value;
    }
}

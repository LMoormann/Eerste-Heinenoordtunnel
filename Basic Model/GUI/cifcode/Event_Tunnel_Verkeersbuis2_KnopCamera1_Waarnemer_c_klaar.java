...
/** Event "Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar", 802, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup4.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer_c_klaar(state);
        if (!proceed) return false;

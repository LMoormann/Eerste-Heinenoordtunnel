...
/** Event "Tunnel_Verkeersbuis1_Recorder_c_uit". */
public final class Event_Tunnel_Verkeersbuis1_Recorder_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Recorder_c_uit() {
        super("Tunnel_Verkeersbuis1_Recorder_c_uit", 597, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_Recorder_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Recorder".
        proceed = Aut_Tunnel_Verkeersbuis1_Recorder.fillSyncData_evt_Tunnel_Verkeersbuis1_Recorder_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0) || (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 2))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Recorder_c_uit needs Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_StandVerkeersbuis.herstel\" of the top level scope of the specification failed.", e, state);
        }

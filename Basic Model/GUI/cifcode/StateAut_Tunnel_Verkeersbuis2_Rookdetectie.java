...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Rookdetectie". */
public final class StateAut_Tunnel_Verkeersbuis2_Rookdetectie {
    public int lp_Tunnel_Verkeersbuis2_Rookdetectie;
    public int v_stand3;

    public StateAut_Tunnel_Verkeersbuis2_Rookdetectie copy() {
        StateAut_Tunnel_Verkeersbuis2_Rookdetectie rslt = new StateAut_Tunnel_Verkeersbuis2_Rookdetectie();
        rslt.lp_Tunnel_Verkeersbuis2_Rookdetectie = lp_Tunnel_Verkeersbuis2_Rookdetectie;
        rslt.v_stand3 = v_stand3;
        return rslt;
    }
}

...
/** Automaton "Tunnel_HoofdPompkelder2_SensorLaagwater". */
public final class Aut_Tunnel_HoofdPompkelder2_SensorLaagwater extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_HoofdPompkelder2_SensorLaagwater() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_HoofdPompkelder2_SensorLaagwater", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_HoofdPompkelder2_SensorLaagwater";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_HoofdPompkelder2_SensorLaagwater.lp_Tunnel_HoofdPompkelder2_SensorLaagwater);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaagwater_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(242).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(167);
        fillSyncData(aut, 242, rslt, state.s_Tunnel_HoofdPompkelder2_SensorLaagwater.lp_Tunnel_HoofdPompkelder2_SensorLaagwater);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaagwater_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(243).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(167);
        fillSyncData(aut, 243, rslt, state.s_Tunnel_HoofdPompkelder2_SensorLaagwater.lp_Tunnel_HoofdPompkelder2_SensorLaagwater);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_HoofdPompkelder2_SensorLaagwater = target.s_Tunnel_HoofdPompkelder2_SensorLaagwater.copy();
        target.s_Tunnel_HoofdPompkelder2_SensorLaagwater.lp_Tunnel_HoofdPompkelder2_SensorLaagwater = value;
    }
}

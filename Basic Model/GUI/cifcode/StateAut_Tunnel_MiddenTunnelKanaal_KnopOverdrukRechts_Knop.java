...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukRechts_Knop;
        return rslt;
    }
}

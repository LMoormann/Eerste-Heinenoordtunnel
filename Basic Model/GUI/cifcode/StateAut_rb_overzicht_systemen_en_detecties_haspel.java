...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_haspel". */
public final class StateAut_rb_overzicht_systemen_en_detecties_haspel {
    public int lp_rb_overzicht_systemen_en_detecties_haspel;

    public StateAut_rb_overzicht_systemen_en_detecties_haspel copy() {
        StateAut_rb_overzicht_systemen_en_detecties_haspel rslt = new StateAut_rb_overzicht_systemen_en_detecties_haspel();
        rslt.lp_rb_overzicht_systemen_en_detecties_haspel = lp_rb_overzicht_systemen_en_detecties_haspel;
        return rslt;
    }
}

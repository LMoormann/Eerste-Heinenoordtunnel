...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal". */
public final class StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal {
    public int lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal;

    public StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal copy() {
        StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal rslt = new StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal();
        rslt.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal = lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop = lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Knop;
        return rslt;
    }
}

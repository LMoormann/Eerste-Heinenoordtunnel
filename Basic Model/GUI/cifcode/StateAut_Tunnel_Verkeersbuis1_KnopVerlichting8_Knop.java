...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVerlichting8_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop = lp_Tunnel_Verkeersbuis1_KnopVerlichting8_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopSluitVerkeersbuis_Waarnemer;
        return rslt;
    }
}

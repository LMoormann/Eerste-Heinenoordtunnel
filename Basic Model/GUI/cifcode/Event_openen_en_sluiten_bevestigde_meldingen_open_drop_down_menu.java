...
/** Event "openen_en_sluiten_bevestigde_meldingen.open_drop_down_menu". */
public final class Event_openen_en_sluiten_bevestigde_meldingen_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_openen_en_sluiten_bevestigde_meldingen_open_drop_down_menu() {
        super("openen_en_sluiten_bevestigde_meldingen.open_drop_down_menu", 83, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_openen_en_sluiten_bevestigde_meldingen.fillSyncData_evt_openen_en_sluiten_bevestigde_meldingen_open_drop_down_menu(state);

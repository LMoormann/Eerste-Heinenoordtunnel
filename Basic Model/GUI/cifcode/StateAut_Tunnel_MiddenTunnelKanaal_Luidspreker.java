...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_Luidspreker". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_Luidspreker {
    public int lp_Tunnel_MiddenTunnelKanaal_Luidspreker;

    public StateAut_Tunnel_MiddenTunnelKanaal_Luidspreker copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_Luidspreker rslt = new StateAut_Tunnel_MiddenTunnelKanaal_Luidspreker();
        rslt.lp_Tunnel_MiddenTunnelKanaal_Luidspreker = lp_Tunnel_MiddenTunnelKanaal_Luidspreker;
        return rslt;
    }
}

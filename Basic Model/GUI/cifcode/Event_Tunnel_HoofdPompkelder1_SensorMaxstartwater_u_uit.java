...
/** Event "Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit". */
public final class Event_Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit() {
        super("Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit", 211, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_FysiekeRelatie".
        proceed = Aut_Tunnel_HoofdPompkelder1_FysiekeRelatie.fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_SensorMaxstartwater".
        proceed = Aut_Tunnel_HoofdPompkelder1_SensorMaxstartwater.fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorMaxstartwater_u_uit(state);
        if (!proceed) return false;

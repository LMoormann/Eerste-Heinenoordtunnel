...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit", 661, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit(state);
        if (!proceed) return false;

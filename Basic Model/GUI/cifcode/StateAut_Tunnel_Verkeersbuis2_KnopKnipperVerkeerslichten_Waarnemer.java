...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer;
        return rslt;
    }
}

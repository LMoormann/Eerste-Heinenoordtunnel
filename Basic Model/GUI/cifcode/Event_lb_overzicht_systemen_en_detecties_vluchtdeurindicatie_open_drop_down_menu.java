...
/** Event "lb_overzicht_systemen_en_detecties_vluchtdeurindicatie.open_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_vluchtdeurindicatie.open_drop_down_menu", 71, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie.fillSyncData_evt_lb_overzicht_systemen_en_detecties_vluchtdeurindicatie_open_drop_down_menu(state);

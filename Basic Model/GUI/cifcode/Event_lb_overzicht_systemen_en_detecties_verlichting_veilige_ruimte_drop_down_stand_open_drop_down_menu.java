...
/** Event "lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand.open_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand_open_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand.open_drop_down_menu", 65, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand.fillSyncData_evt_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand_open_drop_down_menu(state);

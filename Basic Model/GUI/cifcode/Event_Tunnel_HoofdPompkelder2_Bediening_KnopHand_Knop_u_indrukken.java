...
/** Event "Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken". */
public final class Event_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken() {
        super("Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken", 217, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop".
        proceed = Aut_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer".
        proceed = Aut_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Knop_u_indrukken(state);
        if (!proceed) return false;

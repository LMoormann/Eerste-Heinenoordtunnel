...
/** Automaton "Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht". */
public final class Aut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(729).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(422);
        fillSyncData(aut, 729, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(730).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(422);
        fillSyncData(aut, 730, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht = target.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.copy();
        target.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht = value;
    }
}

...
/** Event "Tunnel_HoofdPompkelder2_Pomp2_c_uit". */
public final class Event_Tunnel_HoofdPompkelder2_Pomp2_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_Pomp2_c_uit() {
        super("Tunnel_HoofdPompkelder2_Pomp2_c_uit", 234, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup93.fillSyncData_evt_Tunnel_HoofdPompkelder2_Pomp2_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_Pomp2".
        proceed = Aut_Tunnel_HoofdPompkelder2_Pomp2.fillSyncData_evt_Tunnel_HoofdPompkelder2_Pomp2_c_uit(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer;
        return rslt;
    }
}

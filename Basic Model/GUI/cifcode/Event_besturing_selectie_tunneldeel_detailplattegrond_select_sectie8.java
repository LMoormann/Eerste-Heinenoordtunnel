...
/** Event "besturing_selectie_tunneldeel_detailplattegrond.select_sectie8". */
public final class Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie8 extends RuntimeEvent<State> {
    public Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie8() {
        super("besturing_selectie_tunneldeel_detailplattegrond.select_sectie8", 7, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_besturing_selectie_tunneldeel_detailplattegrond.fillSyncData_evt_besturing_selectie_tunneldeel_detailplattegrond_select_sectie8(state);

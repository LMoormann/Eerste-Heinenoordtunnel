...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_hulppost". */
public final class StateAut_lb_overzicht_systemen_en_detecties_hulppost {
    public int lp_lb_overzicht_systemen_en_detecties_hulppost;

    public StateAut_lb_overzicht_systemen_en_detecties_hulppost copy() {
        StateAut_lb_overzicht_systemen_en_detecties_hulppost rslt = new StateAut_lb_overzicht_systemen_en_detecties_hulppost();
        rslt.lp_lb_overzicht_systemen_en_detecties_hulppost = lp_lb_overzicht_systemen_en_detecties_hulppost;
        return rslt;
    }
}

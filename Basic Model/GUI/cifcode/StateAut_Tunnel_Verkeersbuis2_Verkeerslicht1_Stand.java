...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand = lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_blusser". */
public final class StateAut_lb_overzicht_systemen_en_detecties_blusser {
    public int lp_lb_overzicht_systemen_en_detecties_blusser;

    public StateAut_lb_overzicht_systemen_en_detecties_blusser copy() {
        StateAut_lb_overzicht_systemen_en_detecties_blusser rslt = new StateAut_lb_overzicht_systemen_en_detecties_blusser();
        rslt.lp_lb_overzicht_systemen_en_detecties_blusser = lp_lb_overzicht_systemen_en_detecties_blusser;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_PompRichting". */
public final class StateAut_Tunnel_MiddenPompkelder_PompRichting {
    public int lp_Tunnel_MiddenPompkelder_PompRichting;

    public StateAut_Tunnel_MiddenPompkelder_PompRichting copy() {
        StateAut_Tunnel_MiddenPompkelder_PompRichting rslt = new StateAut_Tunnel_MiddenPompkelder_PompRichting();
        rslt.lp_Tunnel_MiddenPompkelder_PompRichting = lp_Tunnel_MiddenPompkelder_PompRichting;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_SOS". */
public final class StateAut_Tunnel_Verkeersbuis1_SOS {
    public int lp_Tunnel_Verkeersbuis1_SOS;

    public StateAut_Tunnel_Verkeersbuis1_SOS copy() {
        StateAut_Tunnel_Verkeersbuis1_SOS rslt = new StateAut_Tunnel_Verkeersbuis1_SOS();
        rslt.lp_Tunnel_Verkeersbuis1_SOS = lp_Tunnel_Verkeersbuis1_SOS;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Lichtsensor". */
public final class StateAut_Tunnel_Verkeersbuis1_Lichtsensor {
    public int lp_Tunnel_Verkeersbuis1_Lichtsensor;
    public int v_stand2;

    public StateAut_Tunnel_Verkeersbuis1_Lichtsensor copy() {
        StateAut_Tunnel_Verkeersbuis1_Lichtsensor rslt = new StateAut_Tunnel_Verkeersbuis1_Lichtsensor();
        rslt.lp_Tunnel_Verkeersbuis1_Lichtsensor = lp_Tunnel_Verkeersbuis1_Lichtsensor;
        rslt.v_stand2 = v_stand2;
        return rslt;
    }
}

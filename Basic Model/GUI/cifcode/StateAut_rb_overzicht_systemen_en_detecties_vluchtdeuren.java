...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_vluchtdeuren". */
public final class StateAut_rb_overzicht_systemen_en_detecties_vluchtdeuren {
    public int lp_rb_overzicht_systemen_en_detecties_vluchtdeuren;

    public StateAut_rb_overzicht_systemen_en_detecties_vluchtdeuren copy() {
        StateAut_rb_overzicht_systemen_en_detecties_vluchtdeuren rslt = new StateAut_rb_overzicht_systemen_en_detecties_vluchtdeuren();
        rslt.lp_rb_overzicht_systemen_en_detecties_vluchtdeuren = lp_rb_overzicht_systemen_en_detecties_vluchtdeuren;
        return rslt;
    }
}

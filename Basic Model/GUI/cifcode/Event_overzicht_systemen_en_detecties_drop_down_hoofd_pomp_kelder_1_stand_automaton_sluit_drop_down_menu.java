...
/** Event "overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton.sluit_drop_down_menu". */
public final class Event_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton_sluit_drop_down_menu() {
        super("overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton.sluit_drop_down_menu", 86, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton.fillSyncData_evt_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_1_stand_automaton_sluit_drop_down_menu(state);

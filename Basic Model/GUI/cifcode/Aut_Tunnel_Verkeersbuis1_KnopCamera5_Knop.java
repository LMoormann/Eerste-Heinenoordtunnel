...
/** Automaton "Tunnel_Verkeersbuis1_KnopCamera5_Knop". */
public final class Aut_Tunnel_Verkeersbuis1_KnopCamera5_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_KnopCamera5_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_KnopCamera5_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_KnopCamera5_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_KnopCamera5_Knop.lp_Tunnel_Verkeersbuis1_KnopCamera5_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera5_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(455).get(0);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(283);
        fillSyncData(aut, 455, rslt, state.s_Tunnel_Verkeersbuis1_KnopCamera5_Knop.lp_Tunnel_Verkeersbuis1_KnopCamera5_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_KnopCamera5_Knop = target.s_Tunnel_Verkeersbuis1_KnopCamera5_Knop.copy();
        target.s_Tunnel_Verkeersbuis1_KnopCamera5_Knop.lp_Tunnel_Verkeersbuis1_KnopCamera5_Knop = value;
    }
}

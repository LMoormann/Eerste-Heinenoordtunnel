...
/** Automaton "Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie". */
public final class Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(642).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(643).get(1);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = (state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand == 3) && (state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal == 2);
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.rood and Tunnel_Verkeersbuis1_Verkeerslicht1_TimerVrijgavesignaal.afgelopen\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = !(state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand == 3);
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"not Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.rood\" of an edge of the location of automaton \"Tunnel_Verkeersbuis1_Verkeerslicht1_Relatie\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

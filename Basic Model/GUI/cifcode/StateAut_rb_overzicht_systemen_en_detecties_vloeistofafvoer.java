...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_vloeistofafvoer". */
public final class StateAut_rb_overzicht_systemen_en_detecties_vloeistofafvoer {
    public int lp_rb_overzicht_systemen_en_detecties_vloeistofafvoer;

    public StateAut_rb_overzicht_systemen_en_detecties_vloeistofafvoer copy() {
        StateAut_rb_overzicht_systemen_en_detecties_vloeistofafvoer rslt = new StateAut_rb_overzicht_systemen_en_detecties_vloeistofafvoer();
        rslt.lp_rb_overzicht_systemen_en_detecties_vloeistofafvoer = lp_rb_overzicht_systemen_en_detecties_vloeistofafvoer;
        return rslt;
    }
}

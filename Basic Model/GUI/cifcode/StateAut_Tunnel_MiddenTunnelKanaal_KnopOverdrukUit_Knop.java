...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Knop;
        return rslt;
    }
}

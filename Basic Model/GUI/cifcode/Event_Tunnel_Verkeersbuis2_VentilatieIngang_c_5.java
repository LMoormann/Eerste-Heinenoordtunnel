...
/** Event "Tunnel_Verkeersbuis2_VentilatieIngang_c_5". */
public final class Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_5 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_VentilatieIngang_c_5() {
        super("Tunnel_Verkeersbuis2_VentilatieIngang_c_5", 987, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_5(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_5(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis2_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieIngang_c_5(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus == 0) && (((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0) && (state.s_Tunnel_Verkeersbuis2_Standby.lp_Tunnel_Verkeersbuis2_Standby == 0)) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 2))) && (equal(state.s_Tunnel_Verkeersbuis2_Rookdetectie.v_stand3, 5))) || ((state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopVentilatie5_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopVentilatie5_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_VentilatieIngang_c_5 needs Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.auto and (Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_Standby.uit or Tunnel_Verkeersbuis2_StandVerkeersbuis.herstel) and Tunnel_Verkeersbuis2_Rookdetectie.stand = 5 or Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.hand and Tunnel_Verkeersbuis2_KnopVentilatie5_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

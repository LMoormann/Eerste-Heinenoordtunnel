...
/** Event "Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken". */
public final class Event_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken() {
        super("Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken", 894, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_Verkeersbuis2_KnopVentilatie8_Knop".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopVentilatie8_Knop_u_indrukken(state);
        if (!proceed) return false;

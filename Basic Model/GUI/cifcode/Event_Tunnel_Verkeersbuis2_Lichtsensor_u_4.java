...
/** Event "Tunnel_Verkeersbuis2_Lichtsensor_u_4". */
public final class Event_Tunnel_Verkeersbuis2_Lichtsensor_u_4 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Lichtsensor_u_4() {
        super("Tunnel_Verkeersbuis2_Lichtsensor_u_4", 928, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_4(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Lichtsensor".
        proceed = Aut_Tunnel_Verkeersbuis2_Lichtsensor.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_4(state);
        if (!proceed) return false;

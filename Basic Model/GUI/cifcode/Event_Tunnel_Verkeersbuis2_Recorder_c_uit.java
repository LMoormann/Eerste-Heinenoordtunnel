...
/** Event "Tunnel_Verkeersbuis2_Recorder_c_uit". */
public final class Event_Tunnel_Verkeersbuis2_Recorder_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Recorder_c_uit() {
        super("Tunnel_Verkeersbuis2_Recorder_c_uit", 955, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_Recorder_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Recorder".
        proceed = Aut_Tunnel_Verkeersbuis2_Recorder.fillSyncData_evt_Tunnel_Verkeersbuis2_Recorder_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 2))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Recorder_c_uit needs Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_StandVerkeersbuis.herstel\" of the top level scope of the specification failed.", e, state);
        }

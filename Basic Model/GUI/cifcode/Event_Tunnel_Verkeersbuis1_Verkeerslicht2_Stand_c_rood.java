...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood", 646, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht2_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Stand_c_rood(state);
        if (!proceed) return false;

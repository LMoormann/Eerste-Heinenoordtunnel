...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingUit_Knop;
        return rslt;
    }
}

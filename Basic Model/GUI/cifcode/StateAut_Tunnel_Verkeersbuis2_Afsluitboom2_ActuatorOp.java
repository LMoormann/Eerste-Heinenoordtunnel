...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp = lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp;
        return rslt;
    }
}

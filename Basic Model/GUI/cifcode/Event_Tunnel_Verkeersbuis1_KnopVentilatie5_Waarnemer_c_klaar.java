...
/** Event "Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar", 528, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVentilatie5_Waarnemer_c_klaar(state);
        if (!proceed) return false;

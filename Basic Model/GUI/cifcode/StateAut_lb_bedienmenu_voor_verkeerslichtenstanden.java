...
/** Runtime sub-state for automaton "lb_bedienmenu_voor_verkeerslichtenstanden". */
public final class StateAut_lb_bedienmenu_voor_verkeerslichtenstanden {
    public int lp_lb_bedienmenu_voor_verkeerslichtenstanden;

    public StateAut_lb_bedienmenu_voor_verkeerslichtenstanden copy() {
        StateAut_lb_bedienmenu_voor_verkeerslichtenstanden rslt = new StateAut_lb_bedienmenu_voor_verkeerslichtenstanden();
        rslt.lp_lb_bedienmenu_voor_verkeerslichtenstanden = lp_lb_bedienmenu_voor_verkeerslichtenstanden;
        return rslt;
    }
}

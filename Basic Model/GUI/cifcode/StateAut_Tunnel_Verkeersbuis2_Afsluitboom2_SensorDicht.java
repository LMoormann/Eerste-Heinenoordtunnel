...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht". */
public final class StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht {
    public int lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht;

    public StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht copy() {
        StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht rslt = new StateAut_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht();
        rslt.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht = lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorDicht;
        return rslt;
    }
}

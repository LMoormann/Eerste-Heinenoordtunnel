...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_SensorLaag". */
public final class StateAut_Tunnel_BrandBlusInstallatie_SensorLaag {
    public int lp_Tunnel_BrandBlusInstallatie_SensorLaag;

    public StateAut_Tunnel_BrandBlusInstallatie_SensorLaag copy() {
        StateAut_Tunnel_BrandBlusInstallatie_SensorLaag rslt = new StateAut_Tunnel_BrandBlusInstallatie_SensorLaag();
        rslt.lp_Tunnel_BrandBlusInstallatie_SensorLaag = lp_Tunnel_BrandBlusInstallatie_SensorLaag;
        return rslt;
    }
}

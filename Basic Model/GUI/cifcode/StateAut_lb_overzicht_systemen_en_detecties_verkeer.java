...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_verkeer". */
public final class StateAut_lb_overzicht_systemen_en_detecties_verkeer {
    public int lp_lb_overzicht_systemen_en_detecties_verkeer;

    public StateAut_lb_overzicht_systemen_en_detecties_verkeer copy() {
        StateAut_lb_overzicht_systemen_en_detecties_verkeer rslt = new StateAut_lb_overzicht_systemen_en_detecties_verkeer();
        rslt.lp_lb_overzicht_systemen_en_detecties_verkeer = lp_lb_overzicht_systemen_en_detecties_verkeer;
        return rslt;
    }
}

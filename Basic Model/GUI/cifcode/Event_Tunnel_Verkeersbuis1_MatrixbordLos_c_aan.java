...
/** Event "Tunnel_Verkeersbuis1_MatrixbordLos_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_MatrixbordLos_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_MatrixbordLos_c_aan() {
        super("Tunnel_Verkeersbuis1_MatrixbordLos_c_aan", 579, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordLos_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_MatrixbordLos".
        proceed = Aut_Tunnel_Verkeersbuis1_MatrixbordLos.fillSyncData_evt_Tunnel_Verkeersbuis1_MatrixbordLos_c_aan(state);
        if (!proceed) return false;

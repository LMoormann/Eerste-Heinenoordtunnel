...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_Overdruk". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_Overdruk {
    public int lp_Tunnel_MiddenTunnelKanaal_Overdruk;

    public StateAut_Tunnel_MiddenTunnelKanaal_Overdruk copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_Overdruk rslt = new StateAut_Tunnel_MiddenTunnelKanaal_Overdruk();
        rslt.lp_Tunnel_MiddenTunnelKanaal_Overdruk = lp_Tunnel_MiddenTunnelKanaal_Overdruk;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Kanaal_c_uit1". */
public final class Event_Tunnel_Verkeersbuis1_Kanaal_c_uit1 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Kanaal_c_uit1() {
        super("Tunnel_Verkeersbuis1_Kanaal_c_uit1", 434, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup2.fillSyncData_evt_Tunnel_Verkeersbuis1_Kanaal_c_uit1(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis1_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis1_Kanaal_c_uit1(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Kanaal_c_uit1 needs Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopCamera2_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopCamera4_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopCamera5_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopCamera6_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Kanaal_c_uit1 needs Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

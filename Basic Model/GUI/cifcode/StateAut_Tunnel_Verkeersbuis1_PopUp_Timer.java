...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_PopUp_Timer". */
public final class StateAut_Tunnel_Verkeersbuis1_PopUp_Timer {
    public int lp_Tunnel_Verkeersbuis1_PopUp_Timer;

    public StateAut_Tunnel_Verkeersbuis1_PopUp_Timer copy() {
        StateAut_Tunnel_Verkeersbuis1_PopUp_Timer rslt = new StateAut_Tunnel_Verkeersbuis1_PopUp_Timer();
        rslt.lp_Tunnel_Verkeersbuis1_PopUp_Timer = lp_Tunnel_Verkeersbuis1_PopUp_Timer;
        return rslt;
    }
}

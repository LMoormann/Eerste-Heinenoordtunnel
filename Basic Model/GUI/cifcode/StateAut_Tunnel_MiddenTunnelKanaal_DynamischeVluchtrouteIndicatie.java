...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie {
    public int lp_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie;

    public StateAut_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie rslt = new StateAut_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie();
        rslt.lp_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie = lp_Tunnel_MiddenTunnelKanaal_DynamischeVluchtrouteIndicatie;
        return rslt;
    }
}

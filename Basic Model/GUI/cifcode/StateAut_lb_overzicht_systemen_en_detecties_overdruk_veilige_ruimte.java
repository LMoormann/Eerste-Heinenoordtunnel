...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte". */
public final class StateAut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte {
    public int lp_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte;

    public StateAut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte copy() {
        StateAut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte rslt = new StateAut_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte();
        rslt.lp_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte = lp_lb_overzicht_systemen_en_detecties_overdruk_veilige_ruimte;
        return rslt;
    }
}

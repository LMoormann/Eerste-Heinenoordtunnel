...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVentilatie6_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop = lp_Tunnel_Verkeersbuis1_KnopVentilatie6_Knop;
        return rslt;
    }
}

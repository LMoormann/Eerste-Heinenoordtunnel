...
/** Event "lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.sluit_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.sluit_drop_down_menu", 36, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.fillSyncData_evt_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu(state);

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand". */
public final class StateAut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand {
    public int lp_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand;

    public StateAut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand copy() {
        StateAut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand rslt = new StateAut_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand();
        rslt.lp_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand = lp_lb_overzicht_systemen_en_detecties_verlichting_veilige_ruimte_drop_down_stand;
        return rslt;
    }
}

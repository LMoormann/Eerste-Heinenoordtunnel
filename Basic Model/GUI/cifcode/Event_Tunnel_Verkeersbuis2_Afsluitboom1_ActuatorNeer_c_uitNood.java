...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood() {
        super("Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood", 711, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

...
/** Automaton "Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon". */
public final class Aut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(413).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(265);
        fillSyncData(aut, 413, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(414).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(265);
        fillSyncData(aut, 414, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon = target.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.copy();
        target.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon = value;
    }
}

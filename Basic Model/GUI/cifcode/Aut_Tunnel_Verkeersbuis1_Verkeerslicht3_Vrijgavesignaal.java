...
/** Automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal". */
public final class Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(660).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(388);
        fillSyncData(aut, 660, rslt, state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(661).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(388);
        fillSyncData(aut, 661, rslt, state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal = target.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.copy();
        target.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal = value;
    }
}

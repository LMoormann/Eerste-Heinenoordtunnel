...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_dynamische_vluchtroute". */
public final class StateAut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute {
    public int lp_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute;

    public StateAut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute copy() {
        StateAut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute rslt = new StateAut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute();
        rslt.lp_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute = lp_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_detecties". */
public final class StateAut_lb_overzicht_systemen_en_detecties_detecties {
    public int lp_lb_overzicht_systemen_en_detecties_detecties;

    public StateAut_lb_overzicht_systemen_en_detecties_detecties copy() {
        StateAut_lb_overzicht_systemen_en_detecties_detecties rslt = new StateAut_lb_overzicht_systemen_en_detecties_detecties();
        rslt.lp_lb_overzicht_systemen_en_detecties_detecties = lp_lb_overzicht_systemen_en_detecties_detecties;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_detecties". */
public final class StateAut_rb_overzicht_systemen_en_detecties_detecties {
    public int lp_rb_overzicht_systemen_en_detecties_detecties;

    public StateAut_rb_overzicht_systemen_en_detecties_detecties copy() {
        StateAut_rb_overzicht_systemen_en_detecties_detecties rslt = new StateAut_rb_overzicht_systemen_en_detecties_detecties();
        rslt.lp_rb_overzicht_systemen_en_detecties_detecties = lp_rb_overzicht_systemen_en_detecties_detecties;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukUit_Waarnemer;
        return rslt;
    }
}

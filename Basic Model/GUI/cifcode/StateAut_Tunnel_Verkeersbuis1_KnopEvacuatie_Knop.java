...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopEvacuatie_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop = lp_Tunnel_Verkeersbuis1_KnopEvacuatie_Knop;
        return rslt;
    }
}

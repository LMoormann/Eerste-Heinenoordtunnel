...
/** Event "Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar". */
public final class Event_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar() {
        super("Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar", 159, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup44.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup47".
        proceed = Aut_sup47.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer".
        proceed = Aut_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer.fillSyncData_evt_Tunnel_BrandBlusInstallatie_Bediening_KnopAuto_Waarnemer_c_klaar(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_blusvoorziening". */
public final class StateAut_lb_overzicht_systemen_en_detecties_blusvoorziening {
    public int lp_lb_overzicht_systemen_en_detecties_blusvoorziening;

    public StateAut_lb_overzicht_systemen_en_detecties_blusvoorziening copy() {
        StateAut_lb_overzicht_systemen_en_detecties_blusvoorziening rslt = new StateAut_lb_overzicht_systemen_en_detecties_blusvoorziening();
        rslt.lp_lb_overzicht_systemen_en_detecties_blusvoorziening = lp_lb_overzicht_systemen_en_detecties_blusvoorziening;
        return rslt;
    }
}

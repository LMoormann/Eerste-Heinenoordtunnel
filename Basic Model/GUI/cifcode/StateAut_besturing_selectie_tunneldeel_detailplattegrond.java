...
/** Runtime sub-state for automaton "besturing_selectie_tunneldeel_detailplattegrond". */
public final class StateAut_besturing_selectie_tunneldeel_detailplattegrond {
    public int lp_besturing_selectie_tunneldeel_detailplattegrond;

    public StateAut_besturing_selectie_tunneldeel_detailplattegrond copy() {
        StateAut_besturing_selectie_tunneldeel_detailplattegrond rslt = new StateAut_besturing_selectie_tunneldeel_detailplattegrond();
        rslt.lp_besturing_selectie_tunneldeel_detailplattegrond = lp_besturing_selectie_tunneldeel_detailplattegrond;
        return rslt;
    }
}

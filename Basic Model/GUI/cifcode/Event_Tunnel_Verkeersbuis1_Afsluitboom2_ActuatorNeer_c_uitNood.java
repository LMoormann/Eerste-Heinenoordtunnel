...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood() {
        super("Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood", 365, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((state.s_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus == 0) && ((((state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie == 1) || (state.s_Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal == 0)) || (state.s_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal == 0)) || (state.s_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal == 0))) || ((state.s_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus == 1) && ((state.s_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer == 1))))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom2_ActuatorNeer_c_uitNood needs Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.auto and (Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.aan or Tunnel_Verkeersbuis1_Verkeerslicht1_Vrijgavesignaal.uit or Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal.uit or Tunnel_Verkeersbuis1_Verkeerslicht3_Vrijgavesignaal.uit) or Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopOpenAfsluitbomen_Waarnemer.ingedrukt)\" of the top level scope of the specification failed.", e, state);
        }

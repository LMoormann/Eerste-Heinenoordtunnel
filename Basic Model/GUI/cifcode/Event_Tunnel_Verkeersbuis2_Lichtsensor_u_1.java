...
/** Event "Tunnel_Verkeersbuis2_Lichtsensor_u_1". */
public final class Event_Tunnel_Verkeersbuis2_Lichtsensor_u_1 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Lichtsensor_u_1() {
        super("Tunnel_Verkeersbuis2_Lichtsensor_u_1", 925, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_1(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Lichtsensor".
        proceed = Aut_Tunnel_Verkeersbuis2_Lichtsensor.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_1(state);
        if (!proceed) return false;

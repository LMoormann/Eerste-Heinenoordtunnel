...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_knop_blussen_Knop". */
public final class StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop {
    public int lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop;

    public StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop copy() {
        StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop rslt = new StateAut_Tunnel_BrandBlusInstallatie_knop_blussen_Knop();
        rslt.lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop = lp_Tunnel_BrandBlusInstallatie_knop_blussen_Knop;
        return rslt;
    }
}

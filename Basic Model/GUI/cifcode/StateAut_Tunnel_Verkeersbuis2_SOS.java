...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_SOS". */
public final class StateAut_Tunnel_Verkeersbuis2_SOS {
    public int lp_Tunnel_Verkeersbuis2_SOS;

    public StateAut_Tunnel_Verkeersbuis2_SOS copy() {
        StateAut_Tunnel_Verkeersbuis2_SOS rslt = new StateAut_Tunnel_Verkeersbuis2_SOS();
        rslt.lp_Tunnel_Verkeersbuis2_SOS = lp_Tunnel_Verkeersbuis2_SOS;
        return rslt;
    }
}

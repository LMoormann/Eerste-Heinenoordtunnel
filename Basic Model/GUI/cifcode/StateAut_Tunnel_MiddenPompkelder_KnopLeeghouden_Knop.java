...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_KnopLeeghouden_Knop". */
public final class StateAut_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop {
    public int lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop;

    public StateAut_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop copy() {
        StateAut_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop rslt = new StateAut_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop();
        rslt.lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop = lp_Tunnel_MiddenPompkelder_KnopLeeghouden_Knop;
        return rslt;
    }
}

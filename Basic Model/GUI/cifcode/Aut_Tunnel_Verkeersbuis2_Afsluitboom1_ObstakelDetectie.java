...
/** Automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie". */
public final class Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(715).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(415);
        fillSyncData(aut, 715, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(716).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(415);
        fillSyncData(aut, 716, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie = target.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.copy();
        target.s_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ObstakelDetectie = value;
    }
}

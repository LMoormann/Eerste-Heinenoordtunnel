...
/** Event "Tunnel_Verkeersbuis2_MatrixbordLos_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_MatrixbordLos_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_MatrixbordLos_c_aan() {
        super("Tunnel_Verkeersbuis2_MatrixbordLos_c_aan", 937, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordLos_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_MatrixbordLos".
        proceed = Aut_Tunnel_Verkeersbuis2_MatrixbordLos.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordLos_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordLos_c_aan needs Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and (Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

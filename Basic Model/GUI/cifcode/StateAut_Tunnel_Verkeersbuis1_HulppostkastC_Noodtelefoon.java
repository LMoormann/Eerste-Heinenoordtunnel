...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon". */
public final class StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon {
    public int lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon;

    public StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon copy() {
        StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon rslt = new StateAut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon();
        rslt.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon = lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon;
        return rslt;
    }
}

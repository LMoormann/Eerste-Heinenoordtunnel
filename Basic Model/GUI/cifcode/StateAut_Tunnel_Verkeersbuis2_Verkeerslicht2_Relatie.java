...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie = lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Relatie;
        return rslt;
    }
}

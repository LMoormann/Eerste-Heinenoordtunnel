...
/** Event "Tunnel_Verkeersbuis2_Lichtsensor_u_0". */
public final class Event_Tunnel_Verkeersbuis2_Lichtsensor_u_0 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Lichtsensor_u_0() {
        super("Tunnel_Verkeersbuis2_Lichtsensor_u_0", 924, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_0(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Lichtsensor".
        proceed = Aut_Tunnel_Verkeersbuis2_Lichtsensor.fillSyncData_evt_Tunnel_Verkeersbuis2_Lichtsensor_u_0(state);
        if (!proceed) return false;

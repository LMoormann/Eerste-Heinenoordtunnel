...
/** Event "Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken() {
        super("Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken", 219, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup93".
        proceed = Aut_sup93.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup95".
        proceed = Aut_sup95.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer".
        proceed = Aut_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer.fillSyncData_evt_Tunnel_HoofdPompkelder2_Bediening_KnopHand_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopVerlichting3_Waarnemer;
        return rslt;
    }
}

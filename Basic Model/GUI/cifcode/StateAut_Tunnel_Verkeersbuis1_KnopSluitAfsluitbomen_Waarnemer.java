...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer;
        return rslt;
    }
}

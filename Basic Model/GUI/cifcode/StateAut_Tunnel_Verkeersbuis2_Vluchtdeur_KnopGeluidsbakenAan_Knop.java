...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop = lp_Tunnel_Verkeersbuis2_Vluchtdeur_KnopGeluidsbakenAan_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_deur". */
public final class StateAut_rb_overzicht_systemen_en_detecties_deur {
    public int lp_rb_overzicht_systemen_en_detecties_deur;

    public StateAut_rb_overzicht_systemen_en_detecties_deur copy() {
        StateAut_rb_overzicht_systemen_en_detecties_deur rslt = new StateAut_rb_overzicht_systemen_en_detecties_deur();
        rslt.lp_rb_overzicht_systemen_en_detecties_deur = lp_rb_overzicht_systemen_en_detecties_deur;
        return rslt;
    }
}

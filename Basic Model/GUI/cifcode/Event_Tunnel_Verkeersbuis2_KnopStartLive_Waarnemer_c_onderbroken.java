...
/** Event "Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken", 857, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup72".
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup82".
        proceed = Aut_sup82.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup84".
        proceed = Aut_sup84.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopStartLive_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verlichting". */
public final class StateAut_Tunnel_Verkeersbuis1_Verlichting {
    public int lp_Tunnel_Verkeersbuis1_Verlichting;
    public int v_stand7;

    public StateAut_Tunnel_Verkeersbuis1_Verlichting copy() {
        StateAut_Tunnel_Verkeersbuis1_Verlichting rslt = new StateAut_Tunnel_Verkeersbuis1_Verlichting();
        rslt.lp_Tunnel_Verkeersbuis1_Verlichting = lp_Tunnel_Verkeersbuis1_Verlichting;
        rslt.v_stand7 = v_stand7;
        return rslt;
    }
}

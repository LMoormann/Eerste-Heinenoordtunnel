...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_BedieningVerlichting_Modus". */
public final class StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus {
    public int lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus;

    public StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus copy() {
        StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus rslt = new StateAut_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus();
        rslt.lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus = lp_Tunnel_Verkeersbuis1_BedieningVerlichting_Modus;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan() {
        super("Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan", 709, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.uit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(!(((state.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht == 1) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs not(Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.aan and Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.uit and Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.uit)\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal == 1) || ((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis2_Verkeerslicht1_Vrijgavesignaal.aan or Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!((state.s_Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal == 1) || ((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis2_Verkeerslicht2_Vrijgavesignaal.aan or Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!((state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal == 1) || ((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis2_Verkeerslicht3_Vrijgavesignaal.aan or Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!((((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 0) && (!(state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0))) || ((state.s_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.lp_Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus == 1) && ((state.s_Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer == 1)))) || (state.s_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer_c_aan needs Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.auto and not Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

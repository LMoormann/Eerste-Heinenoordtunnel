...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel", 1011, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht3_Stand".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht3_Stand_c_geel needs Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

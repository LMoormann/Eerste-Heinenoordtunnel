...
/** Event "Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset". */
public final class Event_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset() {
        super("Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset", 426, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup15.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_J32_TimerVrijgavesignaal_c_reset needs Tunnel_Verkeersbuis1_J32_Stand.uit\" of the top level scope of the specification failed.", e, state);
        }

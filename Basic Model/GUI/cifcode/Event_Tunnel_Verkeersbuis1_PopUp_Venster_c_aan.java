...
/** Event "Tunnel_Verkeersbuis1_PopUp_Venster_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan() {
        super("Tunnel_Verkeersbuis1_PopUp_Venster_c_aan", 594, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "sup31".
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup35".
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup39".
        proceed = Aut_sup39.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_PopUp_Venster".
        proceed = Aut_Tunnel_Verkeersbuis1_PopUp_Venster.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Venster_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(((((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0) && (state.s_Tunnel_Verkeersbuis1_SOS.lp_Tunnel_Verkeersbuis1_SOS == 1)) && ((state.s_Tunnel_Verkeersbuis1_Rookdetectie.v_stand) > (3))) && ((state.s_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen.lp_Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen == 1) || (state.s_Tunnel_Verkeersbuis1_HulppostkastC_SensorOpen.lp_Tunnel_Verkeersbuis1_HulppostkastC_SensorOpen == 1))) && (((((state.s_Tunnel_Verkeersbuis1_HulppostkastA_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastA_Handblusser == 1) || (state.s_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.lp_Tunnel_Verkeersbuis1_HulppostkastA_Brandslang == 1)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon == 1)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser == 1)) || (state.s_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.lp_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis1_SOS.aan and Tunnel_Verkeersbuis1_Rookdetectie.stand > 3 and (Tunnel_Verkeersbuis1_HulppostkastA_SensorOpen.aan or Tunnel_Verkeersbuis1_HulppostkastC_SensorOpen.aan) and (Tunnel_Verkeersbuis1_HulppostkastA_Handblusser.aan or Tunnel_Verkeersbuis1_HulppostkastA_Brandslang.aan or Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon.aan or Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.aan or Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.aan)\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Waarnemer.lp_Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis1_PopUp_KnopBevestigen_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer.lp_Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_PopUp_Venster_c_aan needs Tunnel_Verkeersbuis1_PopUp_KnopAfwijzen_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

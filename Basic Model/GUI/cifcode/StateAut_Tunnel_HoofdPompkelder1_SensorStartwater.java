...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_SensorStartwater". */
public final class StateAut_Tunnel_HoofdPompkelder1_SensorStartwater {
    public int lp_Tunnel_HoofdPompkelder1_SensorStartwater;

    public StateAut_Tunnel_HoofdPompkelder1_SensorStartwater copy() {
        StateAut_Tunnel_HoofdPompkelder1_SensorStartwater rslt = new StateAut_Tunnel_HoofdPompkelder1_SensorStartwater();
        rslt.lp_Tunnel_HoofdPompkelder1_SensorStartwater = lp_Tunnel_HoofdPompkelder1_SensorStartwater;
        return rslt;
    }
}

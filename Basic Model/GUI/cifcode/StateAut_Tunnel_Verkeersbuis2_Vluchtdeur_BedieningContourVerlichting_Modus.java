...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus". */
public final class StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus {
    public int lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus;

    public StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus copy() {
        StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus rslt = new StateAut_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus();
        rslt.lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus = lp_Tunnel_Verkeersbuis2_Vluchtdeur_BedieningContourVerlichting_Modus;
        return rslt;
    }
}

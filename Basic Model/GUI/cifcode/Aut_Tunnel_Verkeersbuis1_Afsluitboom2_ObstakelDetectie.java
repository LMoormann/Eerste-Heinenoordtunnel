...
/** Automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie". */
public final class Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(369).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(239);
        fillSyncData(aut, 369, rslt, state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(370).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(239);
        fillSyncData(aut, 370, rslt, state.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie = target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.copy();
        target.s_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie = value;
    }
}

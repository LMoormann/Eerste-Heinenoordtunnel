...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_dynamische_vluchtroute". */
public final class StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute {
    public int lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute;

    public StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute copy() {
        StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute rslt = new StateAut_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute();
        rslt.lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute = lp_lb_overzicht_systemen_en_detecties_dynamische_vluchtroute;
        return rslt;
    }
}

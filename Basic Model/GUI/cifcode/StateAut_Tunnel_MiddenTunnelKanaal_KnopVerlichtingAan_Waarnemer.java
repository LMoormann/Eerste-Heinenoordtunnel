...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer = lp_Tunnel_MiddenTunnelKanaal_KnopVerlichtingAan_Waarnemer;
        return rslt;
    }
}

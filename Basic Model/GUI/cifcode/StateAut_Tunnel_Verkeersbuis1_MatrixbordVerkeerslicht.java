...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht". */
public final class StateAut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht {
    public int lp_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht;

    public StateAut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht copy() {
        StateAut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht rslt = new StateAut_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht();
        rslt.lp_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht = lp_Tunnel_Verkeersbuis1_MatrixbordVerkeerslicht;
        return rslt;
    }
}

...
/** Event "besturing_selectie_tunneldeel_detailplattegrond.select_sectie7". */
public final class Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie7 extends RuntimeEvent<State> {
    public Event_besturing_selectie_tunneldeel_detailplattegrond_select_sectie7() {
        super("besturing_selectie_tunneldeel_detailplattegrond.select_sectie7", 6, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_besturing_selectie_tunneldeel_detailplattegrond.fillSyncData_evt_besturing_selectie_tunneldeel_detailplattegrond_select_sectie7(state);

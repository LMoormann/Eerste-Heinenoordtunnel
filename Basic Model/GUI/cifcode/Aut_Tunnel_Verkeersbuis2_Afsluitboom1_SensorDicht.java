...
/** Automaton "Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht". */
public final class Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(717).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(416);
        fillSyncData(aut, 717, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(718).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(416);
        fillSyncData(aut, 718, rslt, state.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht = target.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.copy();
        target.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorDicht = value;
    }
}

...
/** Event "Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit". */
public final class Event_Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit() {
        super("Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit", 241, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_FysiekeRelatie".
        proceed = Aut_Tunnel_HoofdPompkelder2_FysiekeRelatie.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder2_SensorLaaghoogwater".
        proceed = Aut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater.fillSyncData_evt_Tunnel_HoofdPompkelder2_SensorLaaghoogwater_u_uit(state);
        if (!proceed) return false;

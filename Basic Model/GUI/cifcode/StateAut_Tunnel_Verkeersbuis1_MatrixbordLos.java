...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_MatrixbordLos". */
public final class StateAut_Tunnel_Verkeersbuis1_MatrixbordLos {
    public int lp_Tunnel_Verkeersbuis1_MatrixbordLos;

    public StateAut_Tunnel_Verkeersbuis1_MatrixbordLos copy() {
        StateAut_Tunnel_Verkeersbuis1_MatrixbordLos rslt = new StateAut_Tunnel_Verkeersbuis1_MatrixbordLos();
        rslt.lp_Tunnel_Verkeersbuis1_MatrixbordLos = lp_Tunnel_Verkeersbuis1_MatrixbordLos;
        return rslt;
    }
}

...
/** Event "Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan". */
public final class Event_Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan() {
        super("Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan", 208, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_SensorLaagwater".
        proceed = Aut_Tunnel_HoofdPompkelder1_SensorLaagwater.fillSyncData_evt_Tunnel_HoofdPompkelder1_SensorLaagwater_u_aan(state);
        if (!proceed) return false;

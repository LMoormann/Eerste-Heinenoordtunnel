...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel", 635, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht1_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht1_Stand_c_geel(state);
        if (!proceed) return false;

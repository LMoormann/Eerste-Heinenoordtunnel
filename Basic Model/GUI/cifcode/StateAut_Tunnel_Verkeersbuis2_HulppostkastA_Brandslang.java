...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_HulppostkastA_Brandslang". */
public final class StateAut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang {
    public int lp_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang;

    public StateAut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang copy() {
        StateAut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang rslt = new StateAut_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang();
        rslt.lp_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang = lp_Tunnel_Verkeersbuis2_HulppostkastA_Brandslang;
        return rslt;
    }
}

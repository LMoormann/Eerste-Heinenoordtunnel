...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Stand". */
public final class StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand {
    public int lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand;

    public StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand copy() {
        StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand rslt = new StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand();
        rslt.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand = lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Stand;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Recorder". */
public final class StateAut_Tunnel_Verkeersbuis1_Recorder {
    public int lp_Tunnel_Verkeersbuis1_Recorder;

    public StateAut_Tunnel_Verkeersbuis1_Recorder copy() {
        StateAut_Tunnel_Verkeersbuis1_Recorder rslt = new StateAut_Tunnel_Verkeersbuis1_Recorder();
        rslt.lp_Tunnel_Verkeersbuis1_Recorder = lp_Tunnel_Verkeersbuis1_Recorder;
        return rslt;
    }
}

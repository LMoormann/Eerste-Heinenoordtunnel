...
/** Event "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken() {
        super("Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken", 334, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup82".
        proceed = Aut_sup82.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "sup85".
        proceed = Aut_sup85.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer".
        proceed = Aut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

...
/** Event "Tunnel_Verkeersbuis1_PopUp_Timer_u_timeout". */
public final class Event_Tunnel_Verkeersbuis1_PopUp_Timer_u_timeout extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_PopUp_Timer_u_timeout() {
        super("Tunnel_Verkeersbuis1_PopUp_Timer_u_timeout", 593, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_Tunnel_Verkeersbuis1_PopUp_Timer.fillSyncData_evt_Tunnel_Verkeersbuis1_PopUp_Timer_u_timeout(state);

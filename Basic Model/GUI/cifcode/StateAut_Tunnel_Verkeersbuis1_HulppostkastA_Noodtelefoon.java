...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon". */
public final class StateAut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon {
    public int lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon;

    public StateAut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon copy() {
        StateAut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon rslt = new StateAut_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon();
        rslt.lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon = lp_Tunnel_Verkeersbuis1_HulppostkastA_Noodtelefoon;
        return rslt;
    }
}

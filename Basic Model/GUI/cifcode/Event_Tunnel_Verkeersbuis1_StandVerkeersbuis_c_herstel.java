...
/** Event "Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel". */
public final class Event_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel() {
        super("Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel", 612, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup31.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup35".
        proceed = Aut_sup35.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup39".
        proceed = Aut_sup39.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_StandVerkeersbuis".
        proceed = Aut_Tunnel_Verkeersbuis1_StandVerkeersbuis.fillSyncData_evt_Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 1) && (state.s_Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 3) && (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 2))) || ((state.s_Tunnel_Verkeersbuis1_Onderhoud.lp_Tunnel_Verkeersbuis1_Onderhoud == 1) && (state.s_Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_StandVerkeersbuis_c_herstel needs Tunnel_Verkeersbuis1_StandVerkeersbuis.calamiteit and Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_StandVerkeersbuis.ondersteunend and Tunnel_Verkeersbuis2_StandVerkeersbuis.herstel or Tunnel_Verkeersbuis1_Onderhoud.aan and Tunnel_Verkeersbuis1_KnopHerstel_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

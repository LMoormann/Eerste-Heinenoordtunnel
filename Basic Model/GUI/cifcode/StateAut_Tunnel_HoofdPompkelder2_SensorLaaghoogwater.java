...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder2_SensorLaaghoogwater". */
public final class StateAut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater {
    public int lp_Tunnel_HoofdPompkelder2_SensorLaaghoogwater;

    public StateAut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater copy() {
        StateAut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater rslt = new StateAut_Tunnel_HoofdPompkelder2_SensorLaaghoogwater();
        rslt.lp_Tunnel_HoofdPompkelder2_SensorLaaghoogwater = lp_Tunnel_HoofdPompkelder2_SensorLaaghoogwater;
        return rslt;
    }
}

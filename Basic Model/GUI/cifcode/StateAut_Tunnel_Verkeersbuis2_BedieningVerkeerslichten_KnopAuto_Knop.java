...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop {
    public int lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop;

    public StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop = lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_KnopAuto_Knop;
        return rslt;
    }
}

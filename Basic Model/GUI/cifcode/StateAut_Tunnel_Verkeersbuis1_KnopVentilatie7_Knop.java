...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVentilatie7_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop = lp_Tunnel_Verkeersbuis1_KnopVentilatie7_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopVentilatie4_Waarnemer;
        return rslt;
    }
}

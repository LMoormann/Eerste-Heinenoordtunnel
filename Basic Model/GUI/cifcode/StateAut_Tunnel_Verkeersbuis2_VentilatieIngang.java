...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_VentilatieIngang". */
public final class StateAut_Tunnel_Verkeersbuis2_VentilatieIngang {
    public int lp_Tunnel_Verkeersbuis2_VentilatieIngang;
    public int v_stand9;

    public StateAut_Tunnel_Verkeersbuis2_VentilatieIngang copy() {
        StateAut_Tunnel_Verkeersbuis2_VentilatieIngang rslt = new StateAut_Tunnel_Verkeersbuis2_VentilatieIngang();
        rslt.lp_Tunnel_Verkeersbuis2_VentilatieIngang = lp_Tunnel_Verkeersbuis2_VentilatieIngang;
        rslt.v_stand9 = v_stand9;
        return rslt;
    }
}

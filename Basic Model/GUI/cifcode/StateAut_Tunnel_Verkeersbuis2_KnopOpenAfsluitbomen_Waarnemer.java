...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopOpenAfsluitbomen_Waarnemer;
        return rslt;
    }
}

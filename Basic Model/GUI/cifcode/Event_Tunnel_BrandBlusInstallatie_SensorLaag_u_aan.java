...
/** Event "Tunnel_BrandBlusInstallatie_SensorLaag_u_aan". */
public final class Event_Tunnel_BrandBlusInstallatie_SensorLaag_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_SensorLaag_u_aan() {
        super("Tunnel_BrandBlusInstallatie_SensorLaag_u_aan", 178, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorLaag_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_SensorLaag".
        proceed = Aut_Tunnel_BrandBlusInstallatie_SensorLaag.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorLaag_u_aan(state);
        if (!proceed) return false;

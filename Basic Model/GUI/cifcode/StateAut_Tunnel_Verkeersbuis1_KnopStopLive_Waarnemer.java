...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopStopLive_Waarnemer;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_tunnel". */
public final class StateAut_lb_overzicht_systemen_en_detecties_tunnel {
    public int lp_lb_overzicht_systemen_en_detecties_tunnel;

    public StateAut_lb_overzicht_systemen_en_detecties_tunnel copy() {
        StateAut_lb_overzicht_systemen_en_detecties_tunnel rslt = new StateAut_lb_overzicht_systemen_en_detecties_tunnel();
        rslt.lp_lb_overzicht_systemen_en_detecties_tunnel = lp_lb_overzicht_systemen_en_detecties_tunnel;
        return rslt;
    }
}

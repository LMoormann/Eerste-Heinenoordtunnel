...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_vluchtdeurindicatie". */
public final class StateAut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie {
    public int lp_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie;

    public StateAut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie copy() {
        StateAut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie rslt = new StateAut_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie();
        rslt.lp_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie = lp_rb_overzicht_systemen_en_detecties_vluchtdeurindicatie;
        return rslt;
    }
}

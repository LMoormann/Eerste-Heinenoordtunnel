...
/** Event "lb_overzicht_systemen_en_detecties_vluchtroute.open_drop_down_menu". */
public final class Event_lb_overzicht_systemen_en_detecties_vluchtroute_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_lb_overzicht_systemen_en_detecties_vluchtroute_open_drop_down_menu() {
        super("lb_overzicht_systemen_en_detecties_vluchtroute.open_drop_down_menu", 77, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_lb_overzicht_systemen_en_detecties_vluchtroute.fillSyncData_evt_lb_overzicht_systemen_en_detecties_vluchtroute_open_drop_down_menu(state);

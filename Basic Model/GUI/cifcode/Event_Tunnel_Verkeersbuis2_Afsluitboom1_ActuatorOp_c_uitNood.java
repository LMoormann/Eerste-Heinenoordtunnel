...
/** Event "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood() {
        super("Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood", 714, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp".
        proceed = Aut_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.fillSyncData_evt_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp_c_uitNood needs Tunnel_Verkeersbuis2_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis2_KnopStopAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopSluitAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt)\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_tunnel". */
public final class StateAut_rb_overzicht_systemen_en_detecties_tunnel {
    public int lp_rb_overzicht_systemen_en_detecties_tunnel;

    public StateAut_rb_overzicht_systemen_en_detecties_tunnel copy() {
        StateAut_rb_overzicht_systemen_en_detecties_tunnel rslt = new StateAut_rb_overzicht_systemen_en_detecties_tunnel();
        rslt.lp_rb_overzicht_systemen_en_detecties_tunnel = lp_rb_overzicht_systemen_en_detecties_tunnel;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie". */
public final class StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie {
    public int lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie;

    public StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie copy() {
        StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie rslt = new StateAut_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie();
        rslt.lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie = lp_Tunnel_Verkeersbuis1_Verkeerslicht3_Relatie;
        return rslt;
    }
}

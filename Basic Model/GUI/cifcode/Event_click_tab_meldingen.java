...
public final class Event_click_tab_meldingen extends RuntimeEvent<State> {
    public Event_click_tab_meldingen() {
        super("click_tab_meldingen", 12, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "geselecteerde_tab_verkeer_meldingen".
        proceed = Aut_geselecteerde_tab_verkeer_meldingen.fillSyncData_evt_click_tab_meldingen(state);

...
public final class Event_click_tab_verkeer extends RuntimeEvent<State> {
    public Event_click_tab_verkeer() {
        super("click_tab_verkeer", 14, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_geselecteerde_tab_verkeer_meldingen.fillSyncData_evt_click_tab_verkeer(state);

...
/** Automaton "Tunnel_Verkeersbuis1_KnopVerlichting4_Knop". */
public final class Aut_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_KnopVerlichting4_Knop";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop.lp_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(551).get(0);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(347);
        fillSyncData(aut, 551, rslt, state.s_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop.lp_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop = target.s_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop.copy();
        target.s_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop.lp_Tunnel_Verkeersbuis1_KnopVerlichting4_Knop = value;
    }
}

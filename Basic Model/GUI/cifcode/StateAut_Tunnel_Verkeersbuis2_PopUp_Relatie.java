...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_PopUp_Relatie". */
public final class StateAut_Tunnel_Verkeersbuis2_PopUp_Relatie {
    public int lp_Tunnel_Verkeersbuis2_PopUp_Relatie;

    public StateAut_Tunnel_Verkeersbuis2_PopUp_Relatie copy() {
        StateAut_Tunnel_Verkeersbuis2_PopUp_Relatie rslt = new StateAut_Tunnel_Verkeersbuis2_PopUp_Relatie();
        rslt.lp_Tunnel_Verkeersbuis2_PopUp_Relatie = lp_Tunnel_Verkeersbuis2_PopUp_Relatie;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_Pomp1". */
public final class StateAut_Tunnel_HoofdPompkelder1_Pomp1 {
    public int lp_Tunnel_HoofdPompkelder1_Pomp1;

    public StateAut_Tunnel_HoofdPompkelder1_Pomp1 copy() {
        StateAut_Tunnel_HoofdPompkelder1_Pomp1 rslt = new StateAut_Tunnel_HoofdPompkelder1_Pomp1();
        rslt.lp_Tunnel_HoofdPompkelder1_Pomp1 = lp_Tunnel_HoofdPompkelder1_Pomp1;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal". */
public final class StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal {
    public int lp_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal;

    public StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal copy() {
        StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal rslt = new StateAut_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal();
        rslt.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal = lp_Tunnel_Verkeersbuis2_Verkeerslicht2_TimerVrijgavesignaal;
        return rslt;
    }
}

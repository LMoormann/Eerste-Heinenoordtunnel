...
/** Event "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper". */
public final class Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper() {
        super("Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper", 994, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Verkeerslicht1_Stand".
        proceed = Aut_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if ((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 3) && (!(((state.s_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen.lp_Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen == 1) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.lp_Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood and not(Tunnel_Verkeersbuis2_Afsluitboom1_SensorOpen.aan and Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorOp.uit and Tunnel_Verkeersbuis2_Afsluitboom1_ActuatorNeer.uit) disables Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if ((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 3) && (!(((state.s_Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen.lp_Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen == 1) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp == 0)) && (state.s_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.lp_Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer == 0)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood and not(Tunnel_Verkeersbuis2_Afsluitboom2_SensorOpen.aan and Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorOp.uit and Tunnel_Verkeersbuis2_Afsluitboom2_ActuatorNeer.uit) disables Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (state.s_Tunnel_Verkeersbuis2_J32_Stand.lp_Tunnel_Verkeersbuis2_J32_Stand == 0) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_J32_Stand.uit disables Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if ((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 0) && (!(state.s_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal == 2))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.uit and not Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal.afgelopen disables Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 3) && (((((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 0) && (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 1) && ((state.s_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer == 1)))) || (state.s_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer == 1))) || ((state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 0) && ((((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 0) && (!(state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0))) || ((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 1) && ((state.s_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer == 1)))) || (state.s_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer == 1))))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Verkeerslicht1_Stand_c_knipper needs Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood and (Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and (Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.uit and (Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and not Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and (Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopRoodVerkeerslichten_Waarnemer.ingedrukt) or Tunnel_Verkeersbuis2_KnopSluitVerkeersbuis_Waarnemer.ingedrukt)\" of the top level scope of the specification failed.", e, state);
        }

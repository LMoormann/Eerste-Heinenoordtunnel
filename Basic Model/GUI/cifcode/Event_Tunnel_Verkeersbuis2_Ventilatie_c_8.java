...
/** Event "Tunnel_Verkeersbuis2_Ventilatie_c_8". */
public final class Event_Tunnel_Verkeersbuis2_Ventilatie_c_8 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Ventilatie_c_8() {
        super("Tunnel_Verkeersbuis2_Ventilatie_c_8", 981, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_8(state);
        if (!proceed) return false;

        // Check automaton "sup71".
        proceed = Aut_sup71.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_8(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Ventilatie".
        proceed = Aut_Tunnel_Verkeersbuis2_Ventilatie.fillSyncData_evt_Tunnel_Verkeersbuis2_Ventilatie_c_8(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus == 0) && ((((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 2)) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 3)) && (equal(state.s_Tunnel_Verkeersbuis2_Rookdetectie.v_stand3, 8)))) || (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 1)) || ((state.s_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis2_BedieningVentilatie_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Ventilatie_c_8 needs Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.auto and ((Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis2_StandVerkeersbuis.herstel or Tunnel_Verkeersbuis2_StandVerkeersbuis.ondersteunend) and Tunnel_Verkeersbuis2_Rookdetectie.stand = 8) or Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit or Tunnel_Verkeersbuis2_BedieningVentilatie_Modus.hand and Tunnel_Verkeersbuis2_KnopVentilatie8_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

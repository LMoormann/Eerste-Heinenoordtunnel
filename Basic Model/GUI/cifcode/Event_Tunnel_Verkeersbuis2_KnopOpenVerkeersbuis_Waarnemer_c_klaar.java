...
/** Event "Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar". */
public final class Event_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar() {
        super("Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar", 835, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup49".
        proceed = Aut_sup49.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup51".
        proceed = Aut_sup51.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer_c_klaar(state);
        if (!proceed) return false;

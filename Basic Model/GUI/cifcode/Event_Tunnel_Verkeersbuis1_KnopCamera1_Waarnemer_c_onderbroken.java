...
/** Event "Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken". */
public final class Event_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken() {
        super("Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken", 445, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup2.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer".
        proceed = Aut_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer.fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera1_Waarnemer_c_onderbroken(state);
        if (!proceed) return false;

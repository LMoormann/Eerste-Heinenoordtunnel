...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken". */
public final class StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken {
    public int lp_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken;

    public StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken copy() {
        StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken rslt = new StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken();
        rslt.lp_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken = lp_Tunnel_Verkeersbuis1_Vluchtdeur_Geluidsbaken;
        return rslt;
    }
}

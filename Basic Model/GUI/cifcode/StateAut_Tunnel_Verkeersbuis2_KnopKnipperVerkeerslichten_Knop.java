...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop = lp_Tunnel_Verkeersbuis2_KnopKnipperVerkeerslichten_Knop;
        return rslt;
    }
}

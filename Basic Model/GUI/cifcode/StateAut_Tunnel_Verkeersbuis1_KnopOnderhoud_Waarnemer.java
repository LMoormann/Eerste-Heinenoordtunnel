...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer {
    public int lp_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer = lp_Tunnel_Verkeersbuis1_KnopOnderhoud_Waarnemer;
        return rslt;
    }
}

...
/** Event "rb_bedienmenu_voor_verkeerslichtenstanden.sluit_drop_down_menu". */
public final class Event_rb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu() {
        super("rb_bedienmenu_voor_verkeerslichtenstanden.sluit_drop_down_menu", 92, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_bedienmenu_voor_verkeerslichtenstanden.fillSyncData_evt_rb_bedienmenu_voor_verkeerslichtenstanden_sluit_drop_down_menu(state);

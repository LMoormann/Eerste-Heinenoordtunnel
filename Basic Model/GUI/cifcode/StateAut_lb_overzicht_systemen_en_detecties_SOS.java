...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_SOS". */
public final class StateAut_lb_overzicht_systemen_en_detecties_SOS {
    public int lp_lb_overzicht_systemen_en_detecties_SOS;

    public StateAut_lb_overzicht_systemen_en_detecties_SOS copy() {
        StateAut_lb_overzicht_systemen_en_detecties_SOS rslt = new StateAut_lb_overzicht_systemen_en_detecties_SOS();
        rslt.lp_lb_overzicht_systemen_en_detecties_SOS = lp_lb_overzicht_systemen_en_detecties_SOS;
        return rslt;
    }
}

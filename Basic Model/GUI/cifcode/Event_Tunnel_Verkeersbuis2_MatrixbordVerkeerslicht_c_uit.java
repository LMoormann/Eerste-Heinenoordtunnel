...
/** Event "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit". */
public final class Event_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit() {
        super("Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit", 940, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;

        // Check automaton "sup50".
        proceed = Aut_sup50.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht".
        proceed = Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((((((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 0) && (state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.lp_Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus == 1) && (state.s_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer == 1))) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht1_Stand == 3)) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht2_Stand == 3)) || (state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_Stand == 3)) || (state.s_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer == 1))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit needs Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.auto and Tunnel_Verkeersbuis2_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_BedieningVerkeerslichten_Modus.hand and Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_Verkeerslicht1_Stand.rood or Tunnel_Verkeersbuis2_Verkeerslicht2_Stand.rood or Tunnel_Verkeersbuis2_Verkeerslicht3_Stand.rood or Tunnel_Verkeersbuis2_KnopOpenVerkeersbuis_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

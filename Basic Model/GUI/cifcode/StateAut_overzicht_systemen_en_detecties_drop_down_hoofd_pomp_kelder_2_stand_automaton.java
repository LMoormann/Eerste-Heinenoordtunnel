...
/** Runtime sub-state for automaton "overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton". */
public final class StateAut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton {
    public int lp_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton;

    public StateAut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton copy() {
        StateAut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton rslt = new StateAut_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton();
        rslt.lp_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton = lp_overzicht_systemen_en_detecties_drop_down_hoofd_pomp_kelder_2_stand_automaton;
        return rslt;
    }
}

...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan", 651, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht2_Relatie".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Relatie.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_Vrijgavesignaal_u_aan(state);
        if (!proceed) return false;

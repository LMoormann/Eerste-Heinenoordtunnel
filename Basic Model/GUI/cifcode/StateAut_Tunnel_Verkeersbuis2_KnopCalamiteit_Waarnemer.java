...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer {
    public int lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer;

    public StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer rslt = new StateAut_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer();
        rslt.lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer = lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer;
        return rslt;
    }
}

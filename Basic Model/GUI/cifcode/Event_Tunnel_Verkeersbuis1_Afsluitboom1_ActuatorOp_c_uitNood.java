...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood() {
        super("Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood", 356, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Afsluitboom1_ActuatorOp_c_uitNood needs Tunnel_Verkeersbuis1_BedieningAfsluitbomen_Modus.hand and (Tunnel_Verkeersbuis1_KnopStopAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopSluitAfsluitbomen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis1_KnopSluitOnvoorwaardelijkAfsluitbomen_Waarnemer.ingedrukt)\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "Tunnel_HoofdPompkelder1_SensorLaaghoogwater". */
public final class StateAut_Tunnel_HoofdPompkelder1_SensorLaaghoogwater {
    public int lp_Tunnel_HoofdPompkelder1_SensorLaaghoogwater;

    public StateAut_Tunnel_HoofdPompkelder1_SensorLaaghoogwater copy() {
        StateAut_Tunnel_HoofdPompkelder1_SensorLaaghoogwater rslt = new StateAut_Tunnel_HoofdPompkelder1_SensorLaaghoogwater();
        rslt.lp_Tunnel_HoofdPompkelder1_SensorLaaghoogwater = lp_Tunnel_HoofdPompkelder1_SensorLaaghoogwater;
        return rslt;
    }
}

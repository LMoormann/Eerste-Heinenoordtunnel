...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom". */
public final class StateAut_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom {
    public int lp_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom;

    public StateAut_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom copy() {
        StateAut_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom rslt = new StateAut_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom();
        rslt.lp_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom = lp_lb_overzicht_systemen_en_detecties_VRI_en_afsluitboom;
        return rslt;
    }
}

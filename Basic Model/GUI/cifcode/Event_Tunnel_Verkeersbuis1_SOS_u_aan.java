...
/** Event "Tunnel_Verkeersbuis1_SOS_u_aan". */
public final class Event_Tunnel_Verkeersbuis1_SOS_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_SOS_u_aan() {
        super("Tunnel_Verkeersbuis1_SOS_u_aan", 607, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        // Check automaton "Tunnel_Verkeersbuis1_SOS".
        proceed = Aut_Tunnel_Verkeersbuis1_SOS.fillSyncData_evt_Tunnel_Verkeersbuis1_SOS_u_aan(state);

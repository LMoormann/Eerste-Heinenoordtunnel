...
/** Automaton "Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal". */
public final class Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(1015).get(4);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(569);
        fillSyncData(aut, 1015, rslt, state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal_c_reset(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(1016).get(4);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(569);
        fillSyncData(aut, 1016, rslt, state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal_u_timeout(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(1017).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(569);
        fillSyncData(aut, 1017, rslt, state.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal = target.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.copy();
        target.s_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal.lp_Tunnel_Verkeersbuis2_Verkeerslicht3_TimerVrijgavesignaal = value;
    }
}

...
/** Runtime sub-state for automaton "sup80". */
public final class StateAut_sup80 {
    public int lp_sup80;

    public StateAut_sup80 copy() {
        StateAut_sup80 rslt = new StateAut_sup80();
        rslt.lp_sup80 = lp_sup80;
        return rslt;
    }
}

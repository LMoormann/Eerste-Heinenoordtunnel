...
/** Event "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken". */
public final class Event_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken extends RuntimeEvent<State> {
    public Event_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken() {
        super("Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken", 332, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop".
        proceed = Aut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer".
        proceed = Aut_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Waarnemer.fillSyncData_evt_Tunnel_MiddenTunnelKanaal_KnopStopBoodschap_Knop_u_indrukken(state);
        if (!proceed) return false;

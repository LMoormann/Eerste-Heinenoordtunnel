...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_Verlichting". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_Verlichting {
    public int lp_Tunnel_MiddenTunnelKanaal_Verlichting;

    public StateAut_Tunnel_MiddenTunnelKanaal_Verlichting copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_Verlichting rslt = new StateAut_Tunnel_MiddenTunnelKanaal_Verlichting();
        rslt.lp_Tunnel_MiddenTunnelKanaal_Verlichting = lp_Tunnel_MiddenTunnelKanaal_Verlichting;
        return rslt;
    }
}

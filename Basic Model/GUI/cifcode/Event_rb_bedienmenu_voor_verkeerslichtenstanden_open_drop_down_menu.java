...
/** Event "rb_bedienmenu_voor_verkeerslichtenstanden.open_drop_down_menu". */
public final class Event_rb_bedienmenu_voor_verkeerslichtenstanden_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_bedienmenu_voor_verkeerslichtenstanden_open_drop_down_menu() {
        super("rb_bedienmenu_voor_verkeerslichtenstanden.open_drop_down_menu", 91, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_bedienmenu_voor_verkeerslichtenstanden.fillSyncData_evt_rb_bedienmenu_voor_verkeerslichtenstanden_open_drop_down_menu(state);

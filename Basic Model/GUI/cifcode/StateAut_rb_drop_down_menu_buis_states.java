...
/** Runtime sub-state for automaton "rb_drop_down_menu_buis_states". */
public final class StateAut_rb_drop_down_menu_buis_states {
    public int lp_rb_drop_down_menu_buis_states;

    public StateAut_rb_drop_down_menu_buis_states copy() {
        StateAut_rb_drop_down_menu_buis_states rslt = new StateAut_rb_drop_down_menu_buis_states();
        rslt.lp_rb_drop_down_menu_buis_states = lp_rb_drop_down_menu_buis_states;
        return rslt;
    }
}

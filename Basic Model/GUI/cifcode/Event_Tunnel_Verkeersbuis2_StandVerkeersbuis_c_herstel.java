...
/** Event "Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel". */
public final class Event_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel() {
        super("Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel", 970, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup72".
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup76".
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "sup80".
        proceed = Aut_sup80.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_StandVerkeersbuis".
        proceed = Aut_Tunnel_Verkeersbuis2_StandVerkeersbuis.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 1) && (state.s_Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer == 1)) || ((state.s_Tunnel_Verkeersbuis2_StandVerkeersbuis.lp_Tunnel_Verkeersbuis2_StandVerkeersbuis == 3) && (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 2))) || ((state.s_Tunnel_Verkeersbuis2_Onderhoud.lp_Tunnel_Verkeersbuis2_Onderhoud == 1) && (state.s_Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_StandVerkeersbuis_c_herstel needs Tunnel_Verkeersbuis2_StandVerkeersbuis.calamiteit and Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_StandVerkeersbuis.ondersteunend and Tunnel_Verkeersbuis1_StandVerkeersbuis.herstel or Tunnel_Verkeersbuis2_Onderhoud.aan and Tunnel_Verkeersbuis2_KnopHerstel_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

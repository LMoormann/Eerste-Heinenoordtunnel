...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom". */
public final class StateAut_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom {
    public int lp_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom;

    public StateAut_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom copy() {
        StateAut_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom rslt = new StateAut_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom();
        rslt.lp_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom = lp_rb_overzicht_systemen_en_detecties_VRI_en_afsluitboom;
        return rslt;
    }
}

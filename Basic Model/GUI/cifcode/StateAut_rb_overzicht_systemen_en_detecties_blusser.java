...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_blusser". */
public final class StateAut_rb_overzicht_systemen_en_detecties_blusser {
    public int lp_rb_overzicht_systemen_en_detecties_blusser;

    public StateAut_rb_overzicht_systemen_en_detecties_blusser copy() {
        StateAut_rb_overzicht_systemen_en_detecties_blusser rslt = new StateAut_rb_overzicht_systemen_en_detecties_blusser();
        rslt.lp_rb_overzicht_systemen_en_detecties_blusser = lp_rb_overzicht_systemen_en_detecties_blusser;
        return rslt;
    }
}

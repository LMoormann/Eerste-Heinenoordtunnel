...
/** Event "rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.sluit_drop_down_menu". */
public final class Event_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu() {
        super("rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.sluit_drop_down_menu", 112, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand.fillSyncData_evt_rb_overzicht_systemen_en_detecties_dynamische_vluchtroute_dropdown_stand_sluit_drop_down_menu(state);

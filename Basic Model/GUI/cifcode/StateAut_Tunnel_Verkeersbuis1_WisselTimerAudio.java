...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_WisselTimerAudio". */
public final class StateAut_Tunnel_Verkeersbuis1_WisselTimerAudio {
    public int lp_Tunnel_Verkeersbuis1_WisselTimerAudio;

    public StateAut_Tunnel_Verkeersbuis1_WisselTimerAudio copy() {
        StateAut_Tunnel_Verkeersbuis1_WisselTimerAudio rslt = new StateAut_Tunnel_Verkeersbuis1_WisselTimerAudio();
        rslt.lp_Tunnel_Verkeersbuis1_WisselTimerAudio = lp_Tunnel_Verkeersbuis1_WisselTimerAudio;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Evacuatie". */
public final class StateAut_Tunnel_Verkeersbuis2_Evacuatie {
    public int lp_Tunnel_Verkeersbuis2_Evacuatie;

    public StateAut_Tunnel_Verkeersbuis2_Evacuatie copy() {
        StateAut_Tunnel_Verkeersbuis2_Evacuatie rslt = new StateAut_Tunnel_Verkeersbuis2_Evacuatie();
        rslt.lp_Tunnel_Verkeersbuis2_Evacuatie = lp_Tunnel_Verkeersbuis2_Evacuatie;
        return rslt;
    }
}

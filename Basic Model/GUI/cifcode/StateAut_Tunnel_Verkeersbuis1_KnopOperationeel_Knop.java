...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_KnopOperationeel_Knop". */
public final class StateAut_Tunnel_Verkeersbuis1_KnopOperationeel_Knop {
    public int lp_Tunnel_Verkeersbuis1_KnopOperationeel_Knop;

    public StateAut_Tunnel_Verkeersbuis1_KnopOperationeel_Knop copy() {
        StateAut_Tunnel_Verkeersbuis1_KnopOperationeel_Knop rslt = new StateAut_Tunnel_Verkeersbuis1_KnopOperationeel_Knop();
        rslt.lp_Tunnel_Verkeersbuis1_KnopOperationeel_Knop = lp_Tunnel_Verkeersbuis1_KnopOperationeel_Knop;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_BrandBlusInstallatie_FysiekeRelatie". */
public final class StateAut_Tunnel_BrandBlusInstallatie_FysiekeRelatie {
    public int lp_Tunnel_BrandBlusInstallatie_FysiekeRelatie;

    public StateAut_Tunnel_BrandBlusInstallatie_FysiekeRelatie copy() {
        StateAut_Tunnel_BrandBlusInstallatie_FysiekeRelatie rslt = new StateAut_Tunnel_BrandBlusInstallatie_FysiekeRelatie();
        rslt.lp_Tunnel_BrandBlusInstallatie_FysiekeRelatie = lp_Tunnel_BrandBlusInstallatie_FysiekeRelatie;
        return rslt;
    }
}

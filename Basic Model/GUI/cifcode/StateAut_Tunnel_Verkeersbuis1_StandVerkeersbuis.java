...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_StandVerkeersbuis". */
public final class StateAut_Tunnel_Verkeersbuis1_StandVerkeersbuis {
    public int lp_Tunnel_Verkeersbuis1_StandVerkeersbuis;

    public StateAut_Tunnel_Verkeersbuis1_StandVerkeersbuis copy() {
        StateAut_Tunnel_Verkeersbuis1_StandVerkeersbuis rslt = new StateAut_Tunnel_Verkeersbuis1_StandVerkeersbuis();
        rslt.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis = lp_Tunnel_Verkeersbuis1_StandVerkeersbuis;
        return rslt;
    }
}

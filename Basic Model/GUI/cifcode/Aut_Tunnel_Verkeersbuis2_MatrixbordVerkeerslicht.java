...
/** Automaton "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht". */
public final class Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(939).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(542);
        fillSyncData(aut, 939, rslt, state.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht_c_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(940).get(2);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(542);
        fillSyncData(aut, 940, rslt, state.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht = target.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.copy();
        target.s_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht.lp_Tunnel_Verkeersbuis2_MatrixbordVerkeerslicht = value;
    }
}

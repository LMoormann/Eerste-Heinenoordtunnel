...
/** Event "rb_overzicht_systemen_en_detecties_blusser.open_drop_down_menu". */
public final class Event_rb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu extends RuntimeEvent<State> {
    public Event_rb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu() {
        super("rb_overzicht_systemen_en_detecties_blusser.open_drop_down_menu", 95, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_rb_overzicht_systemen_en_detecties_blusser.fillSyncData_evt_rb_overzicht_systemen_en_detecties_blusser_open_drop_down_menu(state);

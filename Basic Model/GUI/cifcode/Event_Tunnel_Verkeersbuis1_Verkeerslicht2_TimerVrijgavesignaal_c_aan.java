...
/** Event "Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan() {
        super("Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan", 648, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup10.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup9".
        proceed = Aut_sup9.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_Verkeerslicht2_TimerVrijgavesignaal_c_aan needs Tunnel_Verkeersbuis1_Verkeerslicht2_Stand.rood\" of the top level scope of the specification failed.", e, state);
        }

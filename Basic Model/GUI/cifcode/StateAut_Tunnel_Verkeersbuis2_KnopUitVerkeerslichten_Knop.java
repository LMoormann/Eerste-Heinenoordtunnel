...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop". */
public final class StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop {
    public int lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop;

    public StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop copy() {
        StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop rslt = new StateAut_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop();
        rslt.lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop = lp_Tunnel_Verkeersbuis2_KnopUitVerkeerslichten_Knop;
        return rslt;
    }
}

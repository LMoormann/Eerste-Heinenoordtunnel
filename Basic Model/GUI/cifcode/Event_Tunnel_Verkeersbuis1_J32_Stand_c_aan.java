...
/** Event "Tunnel_Verkeersbuis1_J32_Stand_c_aan". */
public final class Event_Tunnel_Verkeersbuis1_J32_Stand_c_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_J32_Stand_c_aan() {
        super("Tunnel_Verkeersbuis1_J32_Stand_c_aan", 423, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup15.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_aan(state);
        if (!proceed) return false;

        // Check automaton "sup8".
        proceed = Aut_sup8.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_J32_Stand".
        proceed = Aut_Tunnel_Verkeersbuis1_J32_Stand.fillSyncData_evt_Tunnel_Verkeersbuis1_J32_Stand_c_aan(state);
        if (!proceed) return false;

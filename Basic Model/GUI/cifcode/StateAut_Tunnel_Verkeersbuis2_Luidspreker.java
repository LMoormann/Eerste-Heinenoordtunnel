...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Luidspreker". */
public final class StateAut_Tunnel_Verkeersbuis2_Luidspreker {
    public int lp_Tunnel_Verkeersbuis2_Luidspreker;

    public StateAut_Tunnel_Verkeersbuis2_Luidspreker copy() {
        StateAut_Tunnel_Verkeersbuis2_Luidspreker rslt = new StateAut_Tunnel_Verkeersbuis2_Luidspreker();
        rslt.lp_Tunnel_Verkeersbuis2_Luidspreker = lp_Tunnel_Verkeersbuis2_Luidspreker;
        return rslt;
    }
}

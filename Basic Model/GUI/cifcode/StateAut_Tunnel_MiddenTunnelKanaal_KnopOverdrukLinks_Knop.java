...
/** Runtime sub-state for automaton "Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop". */
public final class StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop {
    public int lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop;

    public StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop copy() {
        StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop rslt = new StateAut_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop();
        rslt.lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop = lp_Tunnel_MiddenTunnelKanaal_KnopOverdrukLinks_Knop;
        return rslt;
    }
}

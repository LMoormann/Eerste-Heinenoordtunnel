...
/** Event "Tunnel_Verkeersbuis2_Kanaal_c_uit5". */
public final class Event_Tunnel_Verkeersbuis2_Kanaal_c_uit5 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Kanaal_c_uit5() {
        super("Tunnel_Verkeersbuis2_Kanaal_c_uit5", 796, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup4.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_uit5(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_uit5(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Kanaal_c_uit5 needs Tunnel_Verkeersbuis2_KnopCamera1_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopCamera2_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopCamera3_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopCamera4_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_KnopCamera6_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(state.s_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer == 0)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Kanaal_c_uit5 needs Tunnel_Verkeersbuis2_KnopCamera5_Waarnemer.los\" of the top level scope of the specification failed.", e, state);
        }

...
/** Runtime sub-state for automaton "lb_overzicht_systemen_en_detecties_overig". */
public final class StateAut_lb_overzicht_systemen_en_detecties_overig {
    public int lp_lb_overzicht_systemen_en_detecties_overig;

    public StateAut_lb_overzicht_systemen_en_detecties_overig copy() {
        StateAut_lb_overzicht_systemen_en_detecties_overig rslt = new StateAut_lb_overzicht_systemen_en_detecties_overig();
        rslt.lp_lb_overzicht_systemen_en_detecties_overig = lp_lb_overzicht_systemen_en_detecties_overig;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_SensorLaaghoogwater". */
public final class StateAut_Tunnel_MiddenPompkelder_SensorLaaghoogwater {
    public int lp_Tunnel_MiddenPompkelder_SensorLaaghoogwater;

    public StateAut_Tunnel_MiddenPompkelder_SensorLaaghoogwater copy() {
        StateAut_Tunnel_MiddenPompkelder_SensorLaaghoogwater rslt = new StateAut_Tunnel_MiddenPompkelder_SensorLaaghoogwater();
        rslt.lp_Tunnel_MiddenPompkelder_SensorLaaghoogwater = lp_Tunnel_MiddenPompkelder_SensorLaaghoogwater;
        return rslt;
    }
}

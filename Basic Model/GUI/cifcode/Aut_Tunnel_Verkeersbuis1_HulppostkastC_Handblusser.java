...
/** Automaton "Tunnel_Verkeersbuis1_HulppostkastC_Handblusser". */
public final class Aut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser extends RuntimeSimpleAutomaton<State> {
    public Aut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser() {
        super(getMonitorData(), Spec.MONITOR_EDGE, "cifcode.Aut_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser", SPEC.resourceClassLoader);
    }

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_HulppostkastC_Handblusser";
    }

    @Override
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser_u_aan(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(417).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(267);
        fillSyncData(aut, 417, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser);
        return !rslt.isEmpty();
    }

    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser_u_uit(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(418).get(1);
        rslt.clear();
        RuntimeSimpleAutomaton<State> aut = (RuntimeSimpleAutomaton<State>)SPEC.automata.get(267);
        fillSyncData(aut, 418, rslt, state.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser);
        return !rslt.isEmpty();
    }
    ...
    protected void updateLocPointerValue(State target, int value) {
        target.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser = target.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.copy();
        target.s_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser.lp_Tunnel_Verkeersbuis1_HulppostkastC_Handblusser = value;
    }
}

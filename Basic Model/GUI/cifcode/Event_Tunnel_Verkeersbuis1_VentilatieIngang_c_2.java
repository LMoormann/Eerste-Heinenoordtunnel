...
/** Event "Tunnel_Verkeersbuis1_VentilatieIngang_c_2". */
public final class Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_2 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_2() {
        super("Tunnel_Verkeersbuis1_VentilatieIngang_c_2", 626, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_2(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis1_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_2(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((((state.s_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus == 0) && (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0)) && (state.s_Tunnel_Verkeersbuis1_Onderhoud.lp_Tunnel_Verkeersbuis1_Onderhoud == 0)) && (state.s_Tunnel_Verkeersbuis1_Standby.lp_Tunnel_Verkeersbuis1_Standby == 0)) && (equal(state.s_Tunnel_Verkeersbuis1_Rookdetectie.v_stand, 2))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopVentilatie2_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopVentilatie2_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_VentilatieIngang_c_2 needs Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.auto and Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel and Tunnel_Verkeersbuis1_Onderhoud.uit and Tunnel_Verkeersbuis1_Standby.uit and Tunnel_Verkeersbuis1_Rookdetectie.stand = 2 or Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.hand and Tunnel_Verkeersbuis1_KnopVentilatie2_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

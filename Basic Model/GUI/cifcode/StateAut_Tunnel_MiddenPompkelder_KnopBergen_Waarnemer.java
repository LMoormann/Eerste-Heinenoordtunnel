...
/** Runtime sub-state for automaton "Tunnel_MiddenPompkelder_KnopBergen_Waarnemer". */
public final class StateAut_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer {
    public int lp_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer;

    public StateAut_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer copy() {
        StateAut_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer rslt = new StateAut_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer();
        rslt.lp_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer = lp_Tunnel_MiddenPompkelder_KnopBergen_Waarnemer;
        return rslt;
    }
}

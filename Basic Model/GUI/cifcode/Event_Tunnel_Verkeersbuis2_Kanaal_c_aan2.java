...
/** Event "Tunnel_Verkeersbuis2_Kanaal_c_aan2". */
public final class Event_Tunnel_Verkeersbuis2_Kanaal_c_aan2 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_Kanaal_c_aan2() {
        super("Tunnel_Verkeersbuis2_Kanaal_c_aan2", 787, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup4.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan2(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_Kanaal".
        proceed = Aut_Tunnel_Verkeersbuis2_Kanaal.fillSyncData_evt_Tunnel_Verkeersbuis2_Kanaal_c_aan2(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!(state.s_Tunnel_Verkeersbuis2_KnopCamera2_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCamera2_Waarnemer == 1)) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_Kanaal_c_aan2 needs Tunnel_Verkeersbuis2_KnopCamera2_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

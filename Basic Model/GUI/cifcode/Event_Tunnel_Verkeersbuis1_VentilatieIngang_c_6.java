...
/** Event "Tunnel_Verkeersbuis1_VentilatieIngang_c_6". */
public final class Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_6 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_6() {
        super("Tunnel_Verkeersbuis1_VentilatieIngang_c_6", 630, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_6(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_6(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis1_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_6(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        // Invariants for "".
        try {
            if (!((((state.s_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus == 0) && (((state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 0) || (state.s_Tunnel_Verkeersbuis1_StandVerkeersbuis.lp_Tunnel_Verkeersbuis1_StandVerkeersbuis == 2)) && (equal(state.s_Tunnel_Verkeersbuis1_Rookdetectie.v_stand, 6)))) || ((state.s_Tunnel_Verkeersbuis1_Standby.lp_Tunnel_Verkeersbuis1_Standby == 1) && ((state.s_Tunnel_Verkeersbuis1_Rookdetectie.v_stand) < (7)))) || ((state.s_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.lp_Tunnel_Verkeersbuis1_BedieningVentilatie_Modus == 1) && (state.s_Tunnel_Verkeersbuis1_KnopVentilatie6_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopVentilatie6_Waarnemer == 1)))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_VentilatieIngang_c_6 needs Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.auto and ((Tunnel_Verkeersbuis1_StandVerkeersbuis.operationeel or Tunnel_Verkeersbuis1_StandVerkeersbuis.herstel) and Tunnel_Verkeersbuis1_Rookdetectie.stand = 6) or Tunnel_Verkeersbuis1_Standby.aan and Tunnel_Verkeersbuis1_Rookdetectie.stand < 7 or Tunnel_Verkeersbuis1_BedieningVentilatie_Modus.hand and Tunnel_Verkeersbuis1_KnopVentilatie6_Waarnemer.ingedrukt\" of the top level scope of the specification failed.", e, state);
        }

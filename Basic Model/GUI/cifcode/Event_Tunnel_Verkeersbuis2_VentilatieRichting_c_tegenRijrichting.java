...
/** Event "Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting". */
public final class Event_Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting() {
        super("Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting", 992, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_VentilatieRichting".
        proceed = Aut_Tunnel_Verkeersbuis2_VentilatieRichting.fillSyncData_evt_Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_VentilatieRichting_c_tegenRijrichting needs Tunnel_Verkeersbuis2_StandVerkeersbuis.ondersteunend\" of the top level scope of the specification failed.", e, state);
        }

...
/** Event "Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar". */
public final class Event_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar extends RuntimeEvent<State> {
    public Event_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar() {
        super("Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar", 192, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup89".
        proceed = Aut_sup89.fillSyncData_evt_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "sup92".
        proceed = Aut_sup92.fillSyncData_evt_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer".
        proceed = Aut_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer.fillSyncData_evt_Tunnel_HoofdPompkelder1_KnopLeeghouden_Waarnemer_c_klaar(state);
        if (!proceed) return false;

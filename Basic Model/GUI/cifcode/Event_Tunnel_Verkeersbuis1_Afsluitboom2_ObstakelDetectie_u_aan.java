...
/** Event "Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan". */
public final class Event_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan() {
        super("Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan", 369, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie".
        proceed = Aut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie.fillSyncData_evt_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie_u_aan(state);
        if (!proceed) return false;

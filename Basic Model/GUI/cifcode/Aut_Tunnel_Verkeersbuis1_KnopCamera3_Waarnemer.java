...
/** Automaton "Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer". */
public final class Aut_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer extends RuntimeAutomaton<State> {

    @Override
    public String getName() {
        return "Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer";
    }
    ...
    public String getCurLocName(State state) {
        return getLocName(state.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer);
    }
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera3_Knop_u_indrukken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(449).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer_c_klaar(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(450).get(1);
        rslt.clear();
    ...
    public static boolean fillSyncData_evt_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer_c_onderbroken(State state) {
        List<RuntimeEdge<State>> rslt = SPEC.syncData.get(451).get(1);
        rslt.clear();
    ...
    private static final class Sync0_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"true\" of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            ...
            target.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer = source.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.copy();
            target.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer = 1;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync0_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"not true\" of an edge of location \"los\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
    ...
    private static final class Sync1_0_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            boolean b;
            try {
                b = state.s_Tunnel_Verkeersbuis1_Kanaal.lp_Tunnel_Verkeersbuis1_Kanaal == 3;
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Evaluation of guard \"Tunnel_Verkeersbuis1_Kanaal.camera3\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }
        ...
        public void update(State source, State target) {
            boolean b; // temp var for pred eval rslts
            target.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer = source.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.copy();
            target.s_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer.lp_Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer = 0;
            try {
            } catch (CifSimulatorException e) {
                throw new CifSimulatorException("Execution of the updates of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, source);
            }
        }
    }
    ...
    private static final class Sync1_1_0 extends RuntimeSyncEdge<State> {
        ...
        public boolean evalGuards(State state) {
            ...
            try {
                ...
                throw new CifSimulatorException("Evaluation of guard \"false\" of an edge of location \"ingedrukt\" of automaton \"Tunnel_Verkeersbuis1_KnopCamera3_Waarnemer\" failed.", e, state);
            }
            if (!b) return false;
            return true;
        }

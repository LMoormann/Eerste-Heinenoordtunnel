...
/** Event "Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit". */
public final class Event_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit() {
        super("Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit", 969, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup48.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;

        // Check automaton "sup6".
        proceed = Aut_sup6.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;

        // Check automaton "sup72".
        proceed = Aut_sup72.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;

        // Check automaton "sup76".
        proceed = Aut_sup76.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;

        // Check automaton "sup80".
        proceed = Aut_sup80.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_StandVerkeersbuis".
        proceed = Aut_Tunnel_Verkeersbuis2_StandVerkeersbuis.fillSyncData_evt_Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit(state);
        if (!proceed) return false;
    ...
    public boolean allowedByInvs(State state) {
        ...
        try {
            ...
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis1_StandVerkeersbuis.calamiteit disables Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit\" of the top level scope of the specification failed.", e, state);
        }

        try {
            if (!(((state.s_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer.lp_Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer == 1) || (state.s_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer.lp_Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer == 1)) || (state.s_Tunnel_Verkeersbuis2_PopUp_Timer.lp_Tunnel_Verkeersbuis2_PopUp_Timer == 2))) return false;
        } catch (CifSimulatorException e) {
            throw new CifSimulatorException("Evaluation of invariant \"Tunnel_Verkeersbuis2_StandVerkeersbuis_c_calamiteit needs Tunnel_Verkeersbuis2_KnopCalamiteit_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_PopUp_KnopBevestigen_Waarnemer.ingedrukt or Tunnel_Verkeersbuis2_PopUp_Timer.afgelopen\" of the top level scope of the specification failed.", e, state);
        }

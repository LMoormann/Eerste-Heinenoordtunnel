...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis2_Kanaal". */
public final class StateAut_Tunnel_Verkeersbuis2_Kanaal {
    public int lp_Tunnel_Verkeersbuis2_Kanaal;

    public StateAut_Tunnel_Verkeersbuis2_Kanaal copy() {
        StateAut_Tunnel_Verkeersbuis2_Kanaal rslt = new StateAut_Tunnel_Verkeersbuis2_Kanaal();
        rslt.lp_Tunnel_Verkeersbuis2_Kanaal = lp_Tunnel_Verkeersbuis2_Kanaal;
        return rslt;
    }
}

...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting". */
public final class StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting {
    public int lp_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting;

    public StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting copy() {
        StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting rslt = new StateAut_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting();
        rslt.lp_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting = lp_Tunnel_Verkeersbuis1_Vluchtdeur_ContourVerlichting;
        return rslt;
    }
}

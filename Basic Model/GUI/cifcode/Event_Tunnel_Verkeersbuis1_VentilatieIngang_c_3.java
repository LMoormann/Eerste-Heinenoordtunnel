...
/** Event "Tunnel_Verkeersbuis1_VentilatieIngang_c_3". */
public final class Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_3 extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_VentilatieIngang_c_3() {
        super("Tunnel_Verkeersbuis1_VentilatieIngang_c_3", 627, true);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_sup30.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_3(state);
        if (!proceed) return false;

        // Check automaton "sup7".
        proceed = Aut_sup7.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_3(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_VentilatieIngang".
        proceed = Aut_Tunnel_Verkeersbuis1_VentilatieIngang.fillSyncData_evt_Tunnel_Verkeersbuis1_VentilatieIngang_c_3(state);
        if (!proceed) return false;

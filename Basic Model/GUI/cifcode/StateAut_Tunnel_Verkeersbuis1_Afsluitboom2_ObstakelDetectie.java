...
/** Runtime sub-state for automaton "Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie". */
public final class StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie {
    public int lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie;

    public StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie copy() {
        StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie rslt = new StateAut_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie();
        rslt.lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie = lp_Tunnel_Verkeersbuis1_Afsluitboom2_ObstakelDetectie;
        return rslt;
    }
}

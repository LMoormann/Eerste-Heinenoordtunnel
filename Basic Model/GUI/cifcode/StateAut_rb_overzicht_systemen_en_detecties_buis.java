...
/** Runtime sub-state for automaton "rb_overzicht_systemen_en_detecties_buis". */
public final class StateAut_rb_overzicht_systemen_en_detecties_buis {
    public int lp_rb_overzicht_systemen_en_detecties_buis;

    public StateAut_rb_overzicht_systemen_en_detecties_buis copy() {
        StateAut_rb_overzicht_systemen_en_detecties_buis rslt = new StateAut_rb_overzicht_systemen_en_detecties_buis();
        rslt.lp_rb_overzicht_systemen_en_detecties_buis = lp_rb_overzicht_systemen_en_detecties_buis;
        return rslt;
    }
}

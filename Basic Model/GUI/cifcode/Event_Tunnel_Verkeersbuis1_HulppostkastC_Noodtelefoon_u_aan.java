...
/** Event "Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan". */
public final class Event_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan() {
        super("Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan", 419, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon".
        proceed = Aut_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon.fillSyncData_evt_Tunnel_Verkeersbuis1_HulppostkastC_Noodtelefoon_u_aan(state);
        if (!proceed) return false;

...
/** Event "Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout". */
public final class Event_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout extends RuntimeEvent<State> {
    public Event_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout() {
        super("Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout", 785, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal".
        proceed = Aut_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal.fillSyncData_evt_Tunnel_Verkeersbuis2_J32_TimerVrijgavesignaal_u_timeout(state);
        if (!proceed) return false;

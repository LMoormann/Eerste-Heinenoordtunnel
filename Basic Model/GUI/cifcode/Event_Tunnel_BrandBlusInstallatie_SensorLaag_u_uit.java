...
/** Event "Tunnel_BrandBlusInstallatie_SensorLaag_u_uit". */
public final class Event_Tunnel_BrandBlusInstallatie_SensorLaag_u_uit extends RuntimeEvent<State> {
    public Event_Tunnel_BrandBlusInstallatie_SensorLaag_u_uit() {
        super("Tunnel_BrandBlusInstallatie_SensorLaag_u_uit", 179, false);
    }
    ...
    public boolean fillData(State state) {
        ...
        proceed = Aut_event_disabler.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorLaag_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_FysiekeRelatie".
        proceed = Aut_Tunnel_BrandBlusInstallatie_FysiekeRelatie.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorLaag_u_uit(state);
        if (!proceed) return false;

        // Check automaton "Tunnel_BrandBlusInstallatie_SensorLaag".
        proceed = Aut_Tunnel_BrandBlusInstallatie_SensorLaag.fillSyncData_evt_Tunnel_BrandBlusInstallatie_SensorLaag_u_uit(state);
        if (!proceed) return false;
